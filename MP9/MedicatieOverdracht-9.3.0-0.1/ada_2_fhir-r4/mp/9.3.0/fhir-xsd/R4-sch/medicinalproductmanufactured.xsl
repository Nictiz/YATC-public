...
<!-- == Provenance: HL7-mappings/ada_2_fhir-r4/mp/9.3.0/fhir-xsd/R4-sch/medicinalproductmanufactured.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured"
                  priority="1015"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:text/h:div"
                  priority="1014"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:quantity"
                  priority="1013"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:quantity"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:manufacturer"
                  priority="1012"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:manufacturer"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:manufacturer/f:identifier/f:period"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:manufacturer/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:manufacturer/f:identifier//f:assigner"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:manufacturer/f:identifier//f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:ingredient"
                  priority="1009"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:ingredient"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:ingredient/f:identifier/f:period"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:ingredient/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:ingredient/f:identifier/f:assigner"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:ingredient/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:height"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:height"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:width"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:width"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:depth"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:depth"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:weight"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:weight"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:nominalVolume"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:nominalVolume"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:externalDiameter"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:externalDiameter"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductManufactured/f:physicalCharacteristics/f:image"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductManufactured/f:physicalCharacteristics/f:image"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
