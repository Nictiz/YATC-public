...
<!-- == Provenance: HL7-mappings/ada_2_fhir-r4/mp/9.3.0/fhir-xsd/R4-sch/medicinalproductpharmaceutical.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical"
                  priority="1017"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:text/h:div"
                  priority="1016"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:identifier/f:period"
                  priority="1015"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:identifier/f:assigner"
                  priority="1014"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:ingredient"
                  priority="1013"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:ingredient"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:ingredient/f:identifier/f:period"
                  priority="1012"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:ingredient/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:ingredient/f:identifier/f:assigner"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:ingredient/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:device"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:device"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:device/f:identifier/f:period"
                  priority="1009"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:device/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:device/f:identifier/f:assigner"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:device/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:firstDose"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:firstDose"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxSingleDose"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxSingleDose"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxDosePerDay"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxDosePerDay"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxDosePerTreatmentPeriod"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxDosePerTreatmentPeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxDosePerTreatmentPeriod/f:numerator"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxDosePerTreatmentPeriod/f:numerator"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxDosePerTreatmentPeriod/f:denominator"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxDosePerTreatmentPeriod/f:denominator"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxTreatmentPeriod"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:maxTreatmentPeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:targetSpecies/f:withdrawalPeriod/f:value"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:MedicinalProductPharmaceutical/f:routeOfAdministration/f:targetSpecies/f:withdrawalPeriod/f:value"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
