...
<!-- == Provenance: HL7-mappings/ada_2_fhir-r4/mp/9.3.0/fhir-xsd/R4-sch/namingsystem.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert test="not(f:kind/@value='root' and f:uniqueId/f:type/@value='uuid')"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="."
                                        mode="schematron-select-full-path"/>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert test="not(exists(for $type in distinct-values(f:uniqueId/f:type/@value) return if (count(f:uniqueId[f:type/@value=$type and f:preferred/@value=true()])&gt;1) then $type else ()))"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="."
                                        mode="schematron-select-full-path"/>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem/f:text/h:div"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem/f:contact/f:telecom"
                  priority="1009"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem/f:contact/f:telecom"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem/f:contact/f:telecom/f:period"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem/f:contact/f:telecom/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem/f:useContext/f:valueQuantity"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem/f:useContext/f:valueQuantity"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem/f:useContext/f:valueRange"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem/f:useContext/f:valueRange"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem/f:useContext/f:valueRange/f:low"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem/f:useContext/f:valueRange/f:low"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem/f:useContext/f:valueRange/f:high"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem/f:useContext/f:valueRange/f:high"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem/f:useContext/f:valueReference"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem/f:useContext/f:valueReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem/f:useContext/f:valueReference/f:identifier/f:period"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem/f:useContext/f:valueReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem/f:useContext/f:valueReference/f:identifier/f:assigner"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem/f:useContext/f:valueReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:NamingSystem/f:uniqueId/f:period"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:NamingSystem/f:uniqueId/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
