...
<!-- == Provenance: HL7-mappings/ada_2_fhir-r4/mp/9.3.0/fhir-xsd/R4-sch/substancesourcematerial.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceSourceMaterial"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceSourceMaterial"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceSourceMaterial/f:text/h:div"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceSourceMaterial/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceSourceMaterial/f:organismId/f:period"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceSourceMaterial/f:organismId/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceSourceMaterial/f:organismId/f:assigner"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceSourceMaterial/f:organismId/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceSourceMaterial/f:parentSubstanceId/f:period"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceSourceMaterial/f:parentSubstanceId/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceSourceMaterial/f:parentSubstanceId/f:assigner"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceSourceMaterial/f:parentSubstanceId/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
