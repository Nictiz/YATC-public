...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="../../../../../common/includes/all_zibs-d794e309.xsl"/>
   ...
   <xsl:import href="../../../../../common/includes/mp-functions-d794e240.xsl"/>
   <xsl:import href="mp-AdministrationAgreement.xsl"/>
   <xsl:import href="../../../../../common/includes/mp-DispenseRequest.xsl"/>
   <xsl:import href="../../../../../common/includes/mp-InstructionsForUse.xsl"/>
   ...
   <xsl:import href="../../../../../common/includes/ext-MedicationAgreementPeriodOfUseCondition-d794e390.xsl"/>
