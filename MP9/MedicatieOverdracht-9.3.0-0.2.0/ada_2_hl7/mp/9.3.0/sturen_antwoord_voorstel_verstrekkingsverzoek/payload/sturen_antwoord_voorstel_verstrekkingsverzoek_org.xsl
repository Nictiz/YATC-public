...
<!-- == Provenance: YATC-internal/ada-2-hl7/env/mp/9.3.0/sturen_antwoord_voorstel_verstrekkingsverzoek/payload/sturen_antwoord_voorstel_verstrekkingsverzoek_org.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024011810474758233140100"
   ...
   <xsl:template match="/">
      <xsl:call-template name="SturenAntwoordVoorstelVV-930">
         <xsl:with-param name="in"
                         select="adaxml/data/sturen_antwoord_voorstel_verstrekkingsverzoek"/>
      </xsl:call-template>
   </xsl:template>
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
...
<xsl:value-of select="$mbh/../@id"/>".</xsl:comment>
      <organizer classCode="CLUSTER"
         ...
         <code code="158"
               displayName="Sturen antwoord voorstel verstrekkingsverzoek"
