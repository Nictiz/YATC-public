         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:call-template name="util:logMessage">
                  <xsl:with-param name="msg">Er mist een extensie met URL 'http://hl7.org/fhir/StructureDefinition/iso21090-EN-qualifier'. Onbekend welk type (officiële voornamen, initialen of roepnaam) 'given' name dit is: "
