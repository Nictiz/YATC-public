...
<!-- == Provenance: HL7-mappings/ada_2_fhir-r4/mp/9.3.0/fhir-xsd/R4-sch/specimendefinition.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition"
                  priority="1013"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:text/h:div"
                  priority="1012"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:identifier/f:period"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:identifier/f:assigner"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:typeTested/f:container/f:capacity"
                  priority="1009"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:typeTested/f:container/f:capacity"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:typeTested/f:container/f:minimumVolumeQuantity"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:typeTested/f:container/f:minimumVolumeQuantity"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:typeTested/f:container/f:additive/f:additiveReference"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:typeTested/f:container/f:additive/f:additiveReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:typeTested/f:container/f:additive/f:additiveReference/f:identifier/f:period"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:typeTested/f:container/f:additive/f:additiveReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:typeTested/f:container/f:additive/f:additiveReference/f:identifier/f:assigner"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:typeTested/f:container/f:additive/f:additiveReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:typeTested/f:retentionTime"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:typeTested/f:retentionTime"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:typeTested/f:handling/f:temperatureRange"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:typeTested/f:handling/f:temperatureRange"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:typeTested/f:handling/f:temperatureRange/f:low"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:typeTested/f:handling/f:temperatureRange/f:low"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:typeTested/f:handling/f:temperatureRange/f:high"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:typeTested/f:handling/f:temperatureRange/f:high"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:SpecimenDefinition/f:typeTested/f:handling/f:maxDuration"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:SpecimenDefinition/f:typeTested/f:handling/f:maxDuration"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='http://unitsofmeasure.org')"/>
