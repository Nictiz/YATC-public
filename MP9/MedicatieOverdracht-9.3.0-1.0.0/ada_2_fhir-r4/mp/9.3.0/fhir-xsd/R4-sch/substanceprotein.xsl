...
<!-- == Provenance: HL7-mappings/ada_2_fhir-r4/mp/9.3.0/fhir-xsd/R4-sch/substanceprotein.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceProtein"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceProtein"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceProtein/f:text/h:div"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceProtein/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceProtein/f:subunit/f:sequenceAttachment"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceProtein/f:subunit/f:sequenceAttachment"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceProtein/f:subunit/f:nTerminalModificationId/f:period"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceProtein/f:subunit/f:nTerminalModificationId/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceProtein/f:subunit/f:nTerminalModificationId/f:assigner"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceProtein/f:subunit/f:nTerminalModificationId/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceProtein/f:subunit/f:cTerminalModificationId/f:period"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceProtein/f:subunit/f:cTerminalModificationId/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:SubstanceProtein/f:subunit/f:cTerminalModificationId/f:assigner"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:SubstanceProtein/f:subunit/f:cTerminalModificationId/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
