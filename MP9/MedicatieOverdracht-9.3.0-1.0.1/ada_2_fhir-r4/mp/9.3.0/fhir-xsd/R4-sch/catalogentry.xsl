...
<!-- == Provenance: HL7-mappings/ada_2_fhir-r4/mp/9.3.0/fhir-xsd/R4-sch/catalogentry.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry"
                  priority="1012"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:text/h:div"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:identifier/f:period"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:identifier/f:assigner"
                  priority="1009"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:referencedItem"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:referencedItem"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:referencedItem/f:identifier/f:period"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:referencedItem/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:referencedItem/f:identifier/f:assigner"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:referencedItem/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:additionalIdentifier/f:period"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:additionalIdentifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:additionalIdentifier/f:assigner"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:additionalIdentifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:validityPeriod"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:validityPeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:relatedEntry/f:item"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:relatedEntry/f:item"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:relatedEntry/f:item/f:identifier/f:period"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:relatedEntry/f:item/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CatalogEntry/f:relatedEntry/f:item/f:identifier/f:assigner"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:CatalogEntry/f:relatedEntry/f:item/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
