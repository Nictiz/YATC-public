...
<!-- == Provenance: HL7-mappings/ada_2_fhir-r4/mp/9.3.0/sturen_antwoord_voorstel_verstrekkingsverzoek/payload/sturen_antwoord_voorstel_verstrekkingsverzoek_2_fhir.xsl == -->
