...
<!-- == Provenance: YATC-internal/ada-2-fhir/env/mp/9.0.7/fhir-xsd/STU3-sch/claim_svrl.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:organization"
                  priority="1076"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:organization"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:organization/f:identifier/f:period"
                  priority="1075"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:organization/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:organization/f:identifier//f:assigner"
                  priority="1074"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:organization/f:identifier//f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:information/f:timingPeriod"
                  priority="1050"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:information/f:timingPeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:information/f:valueQuantity"
                  priority="1049"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:information/f:valueQuantity"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:information/f:valueAttachment"
                  priority="1048"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:information/f:valueAttachment"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:information/f:valueReference"
                  priority="1047"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:information/f:valueReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:information/f:valueReference/f:identifier/f:period"
                  priority="1046"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:information/f:valueReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:information/f:valueReference/f:identifier/f:assigner"
                  priority="1045"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:information/f:valueReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:employmentImpacted"
                  priority="1028"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:employmentImpacted"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:hospitalization"
                  priority="1027"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:hospitalization"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:item/f:unitPrice"
                  priority="1020"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:item/f:unitPrice"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:item/f:net"
                  priority="1019"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:item/f:net"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='urn:iso:std:iso:4217')"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:item/f:detail/f:unitPrice"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:item/f:detail/f:unitPrice"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='urn:iso:std:iso:4217')"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:item/f:detail/f:net"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:item/f:detail/f:net"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='urn:iso:std:iso:4217')"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:item/f:detail/f:subDetail/f:unitPrice"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:item/f:detail/f:subDetail/f:unitPrice"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='urn:iso:std:iso:4217')"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:item/f:detail/f:subDetail/f:net"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:item/f:detail/f:subDetail/f:net"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='urn:iso:std:iso:4217')"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Claim/f:total"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:Claim/f:total"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='urn:iso:std:iso:4217')"/>
