...
<!-- == Provenance: YATC-internal/ada-2-fhir/env/mp/9.0.7/fhir-xsd/STU3-sch/dataelement_svrl.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement"
                  priority="1020"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:text/h:div"
                  priority="1019"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:identifier/f:period"
                  priority="1018"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:identifier/f:assigner"
                  priority="1017"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:contact/f:telecom"
                  priority="1016"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:contact/f:telecom"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:contact/f:telecom/f:period"
                  priority="1015"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:contact/f:telecom/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:useContext/f:valueQuantity"
                  priority="1014"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:useContext/f:valueQuantity"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:useContext/f:valueRange"
                  priority="1013"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:useContext/f:valueRange"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:useContext/f:valueRange/f:low"
                  priority="1012"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:useContext/f:valueRange/f:low"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:useContext/f:valueRange/f:high"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:useContext/f:valueRange/f:high"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:mapping"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:mapping"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:element"
                  priority="1009"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:element"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:base))"/>
         <axsl:otherwise>
            <svrl:failed-assert test="not(exists(f:base))"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="."
                                        mode="schematron-select-full-path"/>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert test="not(exists(f:slicing))"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="."
                                        mode="schematron-select-full-path"/>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:element/f:slicing"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:element/f:slicing"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:element/f:max"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:element/f:max"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:element/f:type"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:element/f:type"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:element/f:minValueQuantity"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:element/f:minValueQuantity"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:element/f:maxValueQuantity"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:element/f:maxValueQuantity"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:element/f:binding"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:element/f:binding"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:element/f:binding/f:valueSetReference"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:element/f:binding/f:valueSetReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:element/f:binding/f:valueSetReference/f:identifier/f:period"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:element/f:binding/f:valueSetReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:DataElement/f:element/f:binding/f:valueSetReference/f:identifier/f:assigner"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:DataElement/f:element/f:binding/f:valueSetReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
