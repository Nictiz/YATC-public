...
<!-- == Provenance: YATC-internal/ada-2-fhir/env/mp/9.0.7/fhir-xsd/STU3-sch/expansionprofile_svrl.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile/f:text/h:div"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile/f:identifier/f:period"
                  priority="1009"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile/f:identifier/f:assigner"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile/f:contact/f:telecom"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile/f:contact/f:telecom"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile/f:contact/f:telecom/f:period"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile/f:contact/f:telecom/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile/f:useContext/f:valueQuantity"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile/f:useContext/f:valueQuantity"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile/f:useContext/f:valueRange"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile/f:useContext/f:valueRange"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile/f:useContext/f:valueRange/f:low"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile/f:useContext/f:valueRange/f:low"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile/f:useContext/f:valueRange/f:high"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile/f:useContext/f:valueRange/f:high"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile/f:designation/f:include/f:designation"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile/f:designation/f:include/f:designation"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="exists(f:language) or exists(f:use)"/>
         <axsl:otherwise>
            <svrl:failed-assert test="exists(f:language) or exists(f:use)"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="."
                                        mode="schematron-select-full-path"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ExpansionProfile/f:designation/f:exclude/f:designation"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:ExpansionProfile/f:designation/f:exclude/f:designation"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="exists(f:language) or exists(f:use)"/>
