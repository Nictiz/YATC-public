...
<!-- == Provenance: YATC-internal/ada-2-fhir/env/mp/9.0.7/fhir-xsd/STU3-sch/familymemberhistory_svrl.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory"
                  priority="1032"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert test="exists(*[starts-with(local-name(.), 'age')]) or not(exists(f:estimatedAge))"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="."
                                        mode="schematron-select-full-path"/>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert test="f:notDone/@value=true() or not(exists(f:notDoneReason))"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="."
                                        mode="schematron-select-full-path"/>
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert test="not (*[starts-with(local-name(.), 'age')] and *[starts-with(local-name(.), 'birth')])"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="."
                                        mode="schematron-select-full-path"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:text/h:div"
                  priority="1031"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:identifier/f:period"
                  priority="1030"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:identifier/f:assigner"
                  priority="1029"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:definition"
                  priority="1028"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:definition"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:definition/f:identifier/f:period"
                  priority="1027"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:definition/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:definition/f:identifier/f:assigner"
                  priority="1026"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:definition/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:patient"
                  priority="1025"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:patient"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:patient/f:identifier/f:period"
                  priority="1024"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:patient/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:patient/f:identifier/f:assigner"
                  priority="1023"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:patient/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:bornPeriod"
                  priority="1022"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:bornPeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:ageAge"
                  priority="1021"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:ageAge"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:ageRange"
                  priority="1020"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:ageRange"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:ageRange/f:low"
                  priority="1019"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:ageRange/f:low"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:ageRange/f:high"
                  priority="1018"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:ageRange/f:high"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:deceasedAge"
                  priority="1017"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:deceasedAge"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='http://unitsofmeasure.org') and (not(f:value/@value) or f:value/@value &gt;=0)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:deceasedRange"
                  priority="1016"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:deceasedRange"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:low/f:value/@value)) or not(exists(f:high/f:value/@value)) or (number(f:low/f:value/@value) &lt;= number(f:high/f:value/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:deceasedRange/f:low"
                  priority="1015"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:deceasedRange/f:low"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:deceasedRange/f:high"
                  priority="1014"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:deceasedRange/f:high"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:reasonReference"
                  priority="1013"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:reasonReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:reasonReference/f:identifier/f:period"
                  priority="1012"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:reasonReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:reasonReference/f:identifier/f:assigner"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:reasonReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:note/f:authorReference"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:note/f:authorReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:note/f:authorReference/f:identifier/f:period"
                  priority="1009"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:note/f:authorReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:note/f:authorReference/f:identifier/f:assigner"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:note/f:authorReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:condition/f:onsetAge"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:condition/f:onsetAge"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='http://unitsofmeasure.org') and (not(f:value/@value) or f:value/@value &gt;=0)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:condition/f:onsetRange"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:condition/f:onsetRange"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:low/f:value/@value)) or not(exists(f:high/f:value/@value)) or (number(f:low/f:value/@value) &lt;= number(f:high/f:value/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:condition/f:onsetRange/f:low"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:condition/f:onsetRange/f:low"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:condition/f:onsetRange/f:high"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:condition/f:onsetRange/f:high"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:condition/f:onsetPeriod"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:condition/f:onsetPeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:condition/f:note/f:authorReference"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:condition/f:note/f:authorReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:condition/f:note/f:authorReference/f:identifier/f:period"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:condition/f:note/f:authorReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:FamilyMemberHistory/f:condition/f:note/f:authorReference/f:identifier/f:assigner"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:FamilyMemberHistory/f:condition/f:note/f:authorReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
