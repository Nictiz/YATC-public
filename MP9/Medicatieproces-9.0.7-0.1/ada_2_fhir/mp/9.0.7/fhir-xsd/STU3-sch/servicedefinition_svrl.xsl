...
<!-- == Provenance: YATC-internal/ada-2-fhir/env/mp/9.0.7/fhir-xsd/STU3-sch/servicedefinition_svrl.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition"
                  priority="1038"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:text/h:div"
                  priority="1037"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:identifier/f:period"
                  priority="1036"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:identifier/f:assigner"
                  priority="1035"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:effectivePeriod"
                  priority="1034"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:effectivePeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:useContext/f:valueQuantity"
                  priority="1033"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:useContext/f:valueQuantity"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:useContext/f:valueRange"
                  priority="1032"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:useContext/f:valueRange"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:useContext/f:valueRange/f:low"
                  priority="1031"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:useContext/f:valueRange/f:low"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:useContext/f:valueRange/f:high"
                  priority="1030"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:useContext/f:valueRange/f:high"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:contributor/f:contact/f:telecom"
                  priority="1029"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:contributor/f:contact/f:telecom"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:contributor/f:contact/f:telecom/f:period"
                  priority="1028"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:contributor/f:contact/f:telecom/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:contact/f:telecom"
                  priority="1027"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:contact/f:telecom"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:value)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:contact/f:telecom/f:period"
                  priority="1026"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:contact/f:telecom/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:relatedArtifact/f:document"
                  priority="1025"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:relatedArtifact/f:document"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:relatedArtifact/f:resource"
                  priority="1024"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:relatedArtifact/f:resource"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:relatedArtifact/f:resource/f:identifier/f:period"
                  priority="1023"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:relatedArtifact/f:resource/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:relatedArtifact/f:resource/f:identifier/f:assigner"
                  priority="1022"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:relatedArtifact/f:resource/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat"
                  priority="1021"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat/f:boundsDuration"
                  priority="1020"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat/f:boundsDuration"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat/f:boundsRange"
                  priority="1019"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat/f:boundsRange"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:low/f:value/@value)) or not(exists(f:high/f:value/@value)) or (number(f:low/f:value/@value) &lt;= number(f:high/f:value/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat/f:boundsRange/f:low"
                  priority="1018"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat/f:boundsRange/f:low"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat/f:boundsRange/f:high"
                  priority="1017"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat/f:boundsRange/f:high"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat/f:boundsPeriod"
                  priority="1016"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventTimingTiming/f:repeat/f:boundsPeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventTimingReference"
                  priority="1015"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventTimingReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventTimingReference/f:identifier/f:period"
                  priority="1014"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventTimingReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventTimingReference/f:identifier/f:assigner"
                  priority="1013"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventTimingReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventData/f:codeFilter/f:valueSetReference"
                  priority="1012"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventData/f:codeFilter/f:valueSetReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventData/f:codeFilter/f:valueSetReference/f:identifier/f:period"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventData/f:codeFilter/f:valueSetReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventData/f:codeFilter/f:valueSetReference/f:identifier/f:assigner"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventData/f:codeFilter/f:valueSetReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventData/f:dateFilter/f:valuePeriod"
                  priority="1009"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventData/f:dateFilter/f:valuePeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:trigger/f:eventData/f:dateFilter/f:valueDuration"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:trigger/f:eventData/f:dateFilter/f:valueDuration"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='http://unitsofmeasure.org')"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:dataRequirement/f:codeFilter/f:valueSetReference"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:dataRequirement/f:codeFilter/f:valueSetReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:dataRequirement/f:codeFilter/f:valueSetReference/f:identifier/f:period"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:dataRequirement/f:codeFilter/f:valueSetReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:dataRequirement/f:codeFilter/f:valueSetReference/f:identifier/f:assigner"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:dataRequirement/f:codeFilter/f:valueSetReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:dataRequirement/f:dateFilter/f:valuePeriod"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:dataRequirement/f:dateFilter/f:valuePeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:dataRequirement/f:dateFilter/f:valueDuration"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:dataRequirement/f:dateFilter/f:valueDuration"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='http://unitsofmeasure.org')"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:operationDefinition"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:operationDefinition"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:operationDefinition/f:identifier/f:period"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:operationDefinition/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:ServiceDefinition/f:operationDefinition/f:identifier/f:assigner"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:ServiceDefinition/f:operationDefinition/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
