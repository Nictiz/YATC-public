...
<!-- == Provenance: YATC-internal/ada-2-fhir/env/mp/9.0.7/fhir-xsd/STU3-sch/subscription_svrl.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:Subscription"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:Subscription"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:Subscription/f:text/h:div"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:Subscription/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:Subscription/f:contact"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:Subscription/f:contact"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:Subscription/f:contact/f:period"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:Subscription/f:contact/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
