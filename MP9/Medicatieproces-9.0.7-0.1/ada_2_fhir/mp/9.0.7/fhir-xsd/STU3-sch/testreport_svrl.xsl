...
<!-- == Provenance: YATC-internal/ada-2-fhir/env/mp/9.0.7/fhir-xsd/STU3-sch/testreport_svrl.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:TestReport"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:TestReport"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:TestReport/f:text/h:div"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:TestReport/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:TestReport/f:identifier/f:period"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:TestReport/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:TestReport/f:identifier/f:assigner"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:TestReport/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:TestReport/f:testScript"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:TestReport/f:testScript"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:TestReport/f:testScript/f:identifier/f:period"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:TestReport/f:testScript/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start)) or not(exists(f:end)) or (f:start/@value &lt;= f:end/@value)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:TestReport/f:testScript/f:identifier/f:assigner"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:TestReport/f:testScript/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:TestReport/f:setup/f:action"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:TestReport/f:setup/f:action"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:TestReport/f:test/f:action"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:TestReport/f:test/f:action"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:operation or f:assert) and not(f:operation and f:assert)"/>
