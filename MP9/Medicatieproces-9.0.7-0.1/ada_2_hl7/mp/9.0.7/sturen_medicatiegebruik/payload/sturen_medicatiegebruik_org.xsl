...
<!-- == Provenance: YATC-internal/ada-2-hl7/env/mp/9.0.7/sturen_medicatiegebruik/payload/sturen_medicatiegebruik_org.xsl == -->
...
<xsl:stylesheet version="2.0"
                ...
                xmlns:local="#local.2024011509165753258350100"
   ...
   <xsl:template match="/">
      <xsl:call-template name="Medicatiegebruik_90">
         <xsl:with-param name="patient"
                         select="//sturen_medicatiegebruik/patient"/>
         <xsl:with-param name="mbh"
                         select="//sturen_medicatiegebruik/medicamenteuze_behandeling"/>
      </xsl:call-template>
   </xsl:template>
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
