...
<!-- == Provenance: YATC-internal/ada-2-hl7/env/mp/2_hl7_mp_include_90.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024011509165736083650100"
   ...
   <xsl:import href="ada2hl7_all-zibs-d570e258.xsl"/>
      ...
      <substanceAdministration classCode="SBADM"
         ...
         <xsl:for-each select="./auteur[.//(@value | @code)]">
            <xsl:call-template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9187_20170818144258">
               <xsl:with-param name="ada-auteur"
                               select="."/>
               <xsl:with-param name="authorTime"
      ...
      <xsl:for-each select="$ta">
         ...
         <xsl:for-each select="verstrekker/zorgaanbieder[not(zorgaanbieder)]">
            <xsl:variable name="TheAfspraakdatum"
                          select="ancestor::*/afspraakdatum/@value"/>
            <author>
               <time>
                  <xsl:choose>
   ...
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9270_20181218111500"
                 match="reden_afspraak"
                 mode="HandleRedenAfspraak907">
