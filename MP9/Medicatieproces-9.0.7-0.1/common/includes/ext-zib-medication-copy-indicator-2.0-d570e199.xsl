...
<!-- == Provenance: YATC-internal/fhir-2-ada/env/zibs2017/payload/ext-zib-medication-copy-indicator-2.0.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <!-- ================================================================== -->
   <xsl:template match="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/ext-CopyIndicator']"
