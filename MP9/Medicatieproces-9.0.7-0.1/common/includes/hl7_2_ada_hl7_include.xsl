...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="constants-d570e162.xsl"/>
   <xsl:import href="datetime-d570e163.xsl"/>
   <xsl:import href="units-d570e164.xsl"/>
   <xsl:import href="utilities-d570e165.xsl"/>
   <xsl:import href="uuid-d570e166.xsl"/>
   <!-- ada output language -->
