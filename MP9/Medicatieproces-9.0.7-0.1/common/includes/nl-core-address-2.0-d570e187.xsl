...
<!-- == Provenance: YATC-internal/fhir-2-ada/env/zibs2017/payload/nl-core-address-2.0.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:template name="address-use-type">
      ...
      <xsl:variable name="ad-use"
                    select="'http://hl7.org/fhir/StructureDefinition/iso21090-AD-use'"/>
      <!-- Accounts for both possible cases of AD_use extension -->
      <xsl:variable name="ad-use-valueCode"
                    select="(f:extension[@url=$ad-use]/f:valueCode/@value,f:use/f:extension[@url=$ad-use]/f:valueCode/@value)[1]"/>
