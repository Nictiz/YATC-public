...
<!-- == Provenance: YATC-internal/fhir-2-ada/env/mp/9.0.7/beschikbaarstellen_verstrekkingenvertaling/payload/beschikbaarstellen_verstrekkingenvertaling_2_ada.xsl == -->
   ...
   <xsl:template match="/">
      ...
      <adaxml>
         <xsl:attribute name="xsi:noNamespaceSchemaLocation"
                        select="'../ada_schemas/ada_beschikbaarstellen_verstrekkingenvertaling.xsd'"/>
         <meta status="new"
