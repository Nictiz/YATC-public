...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/mp/9.3.0/payload/2.0.0-beta.2/mp-MedicationAgreement.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024102208231503412030200"
   ...
   <xsl:template name="mp-MedicationAgreement"
      ...
      <!-- Create an mp-MedicationAgreement instance as a MedicationRequest FHIR instance from ADA medicatieafspraak. -->
      <xsl:param name="in"
                 as="element()?"
                 select=".">
