...
<!-- == Provenance: YATC-internal/ada-2-hl7/env/mp/9.3.0/test_instances/payload/beschikbaarstellen_medicatieoverzicht_org.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <!--
    ...
    -->
   <!-- ================================================================== -->
   <xsl:import href="../../beschikbaarstellen_medicatieoverzicht/payload/beschikbaarstellen_medicatieoverzicht_org.xsl"/>
