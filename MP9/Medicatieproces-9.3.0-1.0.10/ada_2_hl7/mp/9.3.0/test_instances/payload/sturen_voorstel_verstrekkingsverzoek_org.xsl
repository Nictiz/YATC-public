...
<!-- == Provenance: YATC-internal/ada-2-hl7/env/mp/9.3.0/test_instances/payload/sturen_voorstel_verstrekkingsverzoek_org.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <!--
    ...
    -->
   <!-- ================================================================== -->
   <xsl:import href="../../sturen_voorstel_verstrekkingsverzoek/payload/sturen_voorstel_verstrekkingsverzoek_org.xsl"/>
