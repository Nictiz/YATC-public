...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/zibs/2020/payload/0.5-beta1/nl-core-BodyWeight.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024111408213009612970100">
   <!-- ================================================================== -->
   <!--
        Converts ADA lichaamsgewicht to FHIR Observation resource conforming to profile nl-core-BodyWeight.
    -->
   <!-- ================================================================== -->
   <!--
        Copyright © Nictiz
   ...
   <xsl:variable name="profileNameBodyWeight"
                 select="'nl-core-BodyWeight'"/>
   <!-- ================================================================== -->
   <xsl:template match="lichaamsgewicht"
                 name="nl-core-BodyWeight"
                 mode="nl-core-BodyWeight"
                 as="element(f:Observation)?">
      <!-- Creates an nl-core-BodyWeight instance as an Observation FHIR instance from ADA lichaamsgewicht element. -->
      <xsl:param name="in"
                 select="."
                 as="element()?">
