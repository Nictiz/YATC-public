...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/zibs/2020/payload/0.5-beta1/nl-core-PharmaceuticalProduct.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024111408213038628310100"
                xmlns:nm="http://www.nictiz.nl/mappings">
   <!-- ================================================================== -->
   <!--
        Converts ADA farmaceutisch_product to FHIR Medication resource conforming to profile nl-core-PharmaceuticalProduct.
    -->
   <!-- ================================================================== -->
   <!--
        Copyright © Nictiz
   ...
   <xsl:variable name="profileNamePharmaceuticalProduct"
                 select="'nl-core-PharmaceuticalProduct'"/>
   <!-- ================================================================== -->
   <xsl:template match="farmaceutisch_product"
                 name="nl-core-PharmaceuticalProduct"
                 mode="nl-core-PharmaceuticalProduct"
                 as="element(f:Medication)">
      <!-- Creates an nl-core-PharmaceuticalProduct instance as a Medication FHIR instance from ADA farmaceutisch_product element. -->
      <xsl:param name="in"
                 as="element()?"
                 select=".">
         ...
         <Medication>
            <xsl:call-template name="insertLogicalId">
               <xsl:with-param name="profile"
                               select="$profileNamePharmaceuticalProduct"/>
            </xsl:call-template>
            <meta>
