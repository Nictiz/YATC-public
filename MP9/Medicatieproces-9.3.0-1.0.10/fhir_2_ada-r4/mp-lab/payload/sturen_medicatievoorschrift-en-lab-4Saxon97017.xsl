...
<!-- == Provenance: YATC-internal/fhir-2-ada-r4/env/mp-lab/payload/sturen_medicatievoorschrift-en-lab-4Saxon97017.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024112611123980926640100">
   <!-- ================================================================== -->
   <!--
        TBD
    -->
