...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/mp/9.3.0/payload/2.0.0-rc.1/all_profiles.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="../../../../../common/includes/all_zibs-d570e160.xsl"/>
   ...
   <xsl:import href="../2.0.0-beta.6/mp-MedicationAdministration2.xsl"/>
   ...
   <xsl:import href="ext-PeriodOfUseCondition.xsl"/>
   <xsl:import href="ext-mp-TimeIntervalPeriod.xsl"/>
