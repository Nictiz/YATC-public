   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9212_20180420174745"
      ...
      <xsl:for-each select="$in">
         <act classCode="ACT"
            ...
            <!-- NICTIZ-38019. Voorstelgegevens antwoord. Fix XSLT to allow for new dataset structure. However: the added toelichting is not yet supported in the templates so also not implemented in the XSLT. -->
            <xsl:for-each select="(antwoord_verstrekkingsverzoek | antwoord_verstrekkingsverzoek/antwoord_verstrekkingsverzoek_besluit)[@code]">
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9396_20220315000000"
      ...
      <xsl:for-each select="$in">
         <act classCode="ACT"
            ...
            <!-- NICTIZ-38019. Voorstelgegevens antwoord. Fix XSLT to allow for new dataset structure. However: the added toelichting is not yet supported in the templates so also not implemented in the XSLT. -->
            <xsl:for-each select="(antwoord_medicatieafspraak | antwoord_medicatieafspraak/antwoord_medicatieafspraak_besluit)[@code]">
               <entryRelationship typeCode="COMP">
