...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.3.10.1.101_20180611000000"
      ...
      <xsl:for-each select="$in">
         ...
         <!--
                https://decor.nictiz.nl/ad/#/zib2017bbr-/rules/templates/2.16.840.1.113883.2.4.3.11.60.3.10.1.101/2018-06-11T00:00:00
                https://decor.nictiz.nl/ad/#/zib2020bbr-/rules/templates/2.16.840.1.113883.2.4.3.11.60.3.10.1.101/2018-06-11T00:00:00
         ...
         <xsl:if test="(huisnummerletter | huisnummertoevoeging)[@value]">
            <buildingNumberSuffix>
               <!-- verwijder eindspaties om verwarring met huisnummertoevoeging te voorkomen -->
               <xsl:value-of select="replace(huisnummerletter/@value, '\s+$', '')"/>
               <!-- voeg scheidende spatie toe als huisnummertoevoeging aanwezig -->
               <xsl:if test="huisnummertoevoeging/@value">
                  <xsl:text>
                  </xsl:text>
