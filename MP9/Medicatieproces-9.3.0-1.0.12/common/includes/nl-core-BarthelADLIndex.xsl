...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/zibs/2020/payload/0.10.0-beta.1/nl-core-BarthelADLIndex.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024111408212871771020100">
   <!-- ================================================================== -->
   <!--
        Converts ADA barthel_index to FHIR Observation resource conforming to profile nl-core-BarthelADLIndex.
    -->
   <!-- ================================================================== -->
   <!--
        Copyright © Nictiz
   ...
   <xsl:variable name="profileNameBarthelADLIndex"
                 select="'nl-core-BarthelADLIndex'"/>
   <!-- ================================================================== -->
   <xsl:template match="barthel_index"
                 name="nl-core-BarthelADLIndex"
                 mode="nl-core-BarthelADLIndex"
                 as="element(f:Observation)">
      <!-- Creates an nl-core-BarthelADLIndex instance as an Observation FHIR instance from ADA barthel_index element. -->
      <xsl:param name="in"
                 as="element()?"
                 select=".">
         ...
         <Observation>
            <xsl:call-template name="insertLogicalId">
               <xsl:with-param name="profile"
                               select="$profileNameBarthelADLIndex"/>
            </xsl:call-template>
            <meta>
