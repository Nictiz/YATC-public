...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:variable name="code-specification"
                 as="xs:string+">
      <!-- the R4 url -->
      <xsl:value-of select="'http://nictiz.nl/fhir/StructureDefinition/ext-CodeSpecification'"/>
      <!-- for backwards compatibility reasons also convert stu3 extension url-->
      <xsl:value-of select="'http://nictiz.nl/fhir/StructureDefinition/code-specification'"/>
   </xsl:variable>
