...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/zibs/2020/payload/0.11.0-beta.1/nl-core-SNAQ65plusScore.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.202411140821296976620100">
   <!-- ================================================================== -->
   <!--
        Converts ada snaq65score to FHIR Observation conforming to profile nl-core-SNAQ65plusScore
    -->
   <!-- ================================================================== -->
   <!--
        Copyright © Nictiz
   ...
   <!-- ================================================================== -->
   <xsl:template match="snaq65score"
                 name="nl-core-SNAQ65plusScore"
                 mode="nl-core-SNAQ65plusScore"
                 as="element(f:Observation)?">
      <!-- Create an nl-core-SNAQ65plusScore instance as an Observation FHIR instance from ada snaq65score element. -->
      <xsl:param name="in"
                 select="."
                 as="element()?">
         ...
         <Observation>
            <xsl:call-template name="insertLogicalId">
               <xsl:with-param name="profile"
                               select="'nl-core-SNAQ65plusScore'"/>
            </xsl:call-template>
            <meta>
