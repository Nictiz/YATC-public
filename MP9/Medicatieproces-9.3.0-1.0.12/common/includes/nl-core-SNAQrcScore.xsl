...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/zibs/2020/payload/0.11.0-beta.1/nl-core-SNAQrcScore.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024111408212971583290100">
   <!-- ================================================================== -->
   <!--
        Converts ada snaqrc_score to FHIR Observation conforming to profile nl-core-SNAQrcScore
    -->
   <!-- ================================================================== -->
   <!--
        Copyright © Nictiz
   ...
   <!-- ================================================================== -->
   <xsl:template match="snaqrc_score"
                 name="nl-core-SNAQrcScore"
                 mode="nl-core-SNAQrcScore"
                 as="element(f:Observation)?">
      <!-- Create an nl-core-SNAQrcScore instance as an Observation FHIR instance from ada snaqrc_score element. -->
      <xsl:param name="in"
                 select="."
                 as="element()?">
