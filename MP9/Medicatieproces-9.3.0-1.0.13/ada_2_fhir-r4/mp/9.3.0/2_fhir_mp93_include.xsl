   ...
   <xsl:param name="fhirMetadata"
      ...
      <xsl:call-template name="buildFhirMetadata">
         <xsl:with-param name="in"
                         select=".//(patient[not(parent::toediener)] | medicamenteuze_behandeling/*[not(self::identificatie)] | reden_van_voorschrijven/probleem | */afleverlocatie | bouwstenen/* | documentgegevens/auteur/auteur_is_zorgaanbieder/zorgaanbieder)"/>
      </xsl:call-template>
   </xsl:param>
