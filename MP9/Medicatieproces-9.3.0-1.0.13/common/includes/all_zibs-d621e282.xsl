...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="fhir_2_ada_fhir_include-d621e280.xsl"/>
   <xsl:import href="mp-functions.xsl"/>
   <xsl:import href="contextContactEpisodeOfCare.xsl"/>
   <xsl:import href="ext-CopyIndicator-d621e285.xsl"/>
   <xsl:import href="ext-StopType.xsl"/>
   <xsl:import href="ext-TimeInterval-Duration.xsl"/>
   <xsl:import href="ext-TimeInterval-Period.xsl"/>
   <xsl:import href="nl-core-AddressInformation-d621e289.xsl"/>
   <xsl:import href="nl-core-BodyHeight-d621e290.xsl"/>
   <xsl:import href="nl-core-BodyWeight-d621e291.xsl"/>
   <xsl:import href="nl-core-ContactInformation-d621e292.xsl"/>
   <xsl:import href="nl-core-ContactPerson-d621e293.xsl"/>
   ...
   <xsl:import href="nl-core-LaboratoryTestResult-d621e298.xsl"/>
   <xsl:import href="nl-core-NameInformation-d621e299.xsl"/>
   <xsl:import href="nl-core-Note.xsl"/>
   <xsl:import href="nl-core-Patient-d621e301.xsl"/>
   <xsl:import href="nl-core-PharmaceuticalProduct-d621e302.xsl"/>
   <xsl:import href="nl-core-Problem-d621e303.xsl"/>
