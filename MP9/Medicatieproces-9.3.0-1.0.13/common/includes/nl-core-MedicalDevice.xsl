...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/zibs/2020/payload/0.11.0-beta.1/nl-core-MedicalDevice.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:variable name="profileNameMedicalDevice"
                 select="'nl-core-MedicalDevice'"/>
   <xsl:variable name="profileNameMedicalDeviceProduct"
                 select="'nl-core-MedicalDevice.Product'"/>
   <!-- ================================================================== -->
   <xsl:template match="medisch_hulpmiddel"
      ...
      <xsl:param name="status"
                 ...
                 as="xs:string"
                 select="''">
         <!-- Optionally set the status. If not explicitly set (or empty), it is inferred from start and end date. -->
      </xsl:param>
      ...
      <xsl:param name="pertainsToGoal"
                 as="element()?">
         <!-- Optional ADA instance used to populate the resource-pertainsToGoal extension. -->
      </xsl:param>
   ...
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
   <xsl:template match="medisch_hulpmiddel[product or product_omschrijving]"
