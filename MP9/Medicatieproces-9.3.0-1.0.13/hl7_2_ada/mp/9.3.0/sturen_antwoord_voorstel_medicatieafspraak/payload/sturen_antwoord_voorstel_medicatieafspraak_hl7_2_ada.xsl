...
<!-- == Provenance: YATC-internal/hl7-2-ada/env/mp/9.3.0/sturen_antwoord_voorstel_medicatieafspraak/payload/sturen_antwoord_voorstel_medicatieafspraak_hl7_2_ada.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024120415184403153420100"
   ...
   <xsl:param name="schemaFileString"
              as="xs:string?">../../hl7_2_ada/mp/9.3.0/sturen_antwoord_voorstel_medicatieafspraak/ada_schemas/sturen_antwoord_voorstel_medicatieafspraak.xsd</xsl:param>
   ...
   <xsl:variable name="gegevensLijst"
                 select="//hl7:organizer[hl7:code[@code = '373'][@codeSystem = '2.16.840.1.113883.2.4.3.11.60.20.77.4']] | //hl7:ClinicalDocument"/>
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="AntwoordVoorstel-90-ADA">
         <xsl:with-param name="patient"
                         select="$patient-recordTarget"/>
      </xsl:call-template>
   </xsl:template>
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
   <xsl:template name="AntwoordVoorstel-90-ADA">
      <!-- Create adaxml for transaction sturen_antwoord_voorstel_medicatieafspraak -->
         ...
         <adaxml>
            <xsl:if test="$outputSchemaRef">
               <xsl:attribute name="xsi:noNamespaceSchemaLocation"
                              select="'../../../../../../art_decor/projects/mp-mp93/schemas/ada_sturen_antwoord_voorstel_medicatieafspraak.xsd'"/>
            </xsl:if>
            <meta status="new"
