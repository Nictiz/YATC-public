...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/mp/9.3.0/payload/2.0.0-rc.4/all_profiles.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="all_zibs-d622e179.xsl"/>
   ...
   <xsl:import href="../../ada_2_fhir-r4/mp/9.3.0/payload/2.0.0-rc.4/mp-MedicationAgreement.xsl"/>
