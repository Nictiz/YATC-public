...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="fhir_2_ada_fhir_include-d622e144.xsl"/>
...
<xsl:value-of select="$vaste_frequentie_one_decimal"/>
   ...
   <xsl:template match="node() | @*"
                 mode="addBouwstenen deduplicateBouwstenenStep1 deduplicateBouwstenenStep2 handleBouwstenen handleMP92AdaNameChanges">
      <xsl:copy>
         <xsl:apply-templates select="node() | @*"
                              mode="#current"/>
      </xsl:copy>
