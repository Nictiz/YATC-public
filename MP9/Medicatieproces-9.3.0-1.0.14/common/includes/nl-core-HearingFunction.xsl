...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/zibs/2020/payload/0.11.0-beta.1/nl-core-HearingFunction.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024111408212946125730100">
   <!-- ================================================================== -->
   <!--
   ...
   <xsl:variable name="profileNameHearingFunction"
                 select="'nl-core-HearingFunction'"/>
   <xsl:variable name="profileNameHearingFunctionHearingAid"
                 select="'nl-core-HearingFunction.HearingAid'"/>
   <xsl:variable name="profileNameHearingFunctionHearingAidProduct"
   ...
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
   <xsl:template match="horen_hulpmiddel/medisch_hulpmiddel[product or product_omschrijving]"
