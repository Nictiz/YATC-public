...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/zibs/2020/payload/0.11.0-beta.1/nl-core-O2Saturation.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024111408212963055240100"
   ...
   <xsl:variable name="profileNameO2Saturation"
                 select="'nl-core-O2Saturation'"/>
   <!-- ================================================================== -->
