...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/zibs/2020/payload/0.10.0-beta.1/nl-core-PainScore.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <!-- ================================================================== -->
   <!--
        Converts ADA pijn_score to FHIR Observation resource conforming to profile nl-core-PainScore.
    -->
   <!-- ================================================================== -->
   <!--
        Copyright © Nictiz
   ...
   <xsl:variable name="profileNamePainScore"
                 select="'nl-core-PainScore'"/>
   <!-- ================================================================== -->
   <xsl:template match="pijn_score"
                 name="nl-core-PainScore"
                 mode="nl-core-PainScore"
                 as="element(f:Observation)?">
      <!-- Creates an nl-core-PainScore instance as an Observation FHIR instance from ADA pijn_score element. -->
      <xsl:param name="in"
                 select="."
                 as="element()?">
