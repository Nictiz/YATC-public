...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="fhir_2_ada_fhir_include-d622e281.xsl"/>
   <xsl:import href="mp-functions.xsl"/>
   <xsl:import href="contextContactEpisodeOfCare.xsl"/>
   <xsl:import href="ext-CopyIndicator-d622e286.xsl"/>
   <xsl:import href="ext-StopType.xsl"/>
   <xsl:import href="ext-TimeInterval-Duration.xsl"/>
   <xsl:import href="ext-TimeInterval-Period.xsl"/>
   <xsl:import href="nl-core-AddressInformation-d622e290.xsl"/>
   <xsl:import href="nl-core-BodyHeight-d622e291.xsl"/>
   <xsl:import href="nl-core-BodyWeight-d622e292.xsl"/>
   <xsl:import href="nl-core-ContactInformation-d622e293.xsl"/>
   <xsl:import href="nl-core-ContactPerson-d622e294.xsl"/>
   ...
   <xsl:import href="nl-core-LaboratoryTestResult-d622e299.xsl"/>
   <xsl:import href="nl-core-NameInformation-d622e300.xsl"/>
   <xsl:import href="nl-core-Note.xsl"/>
   <xsl:import href="nl-core-Patient-d622e302.xsl"/>
   <xsl:import href="nl-core-PharmaceuticalProduct-d622e303.xsl"/>
   <xsl:import href="nl-core-Problem-d622e304.xsl"/>
