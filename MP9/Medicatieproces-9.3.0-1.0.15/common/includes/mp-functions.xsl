         ...
         <adaxml>
            <data>
               <beschikbaarstellen_medicatiegegevens>
                  <xsl:for-each select="ancestor::data/*/bouwstenen/farmaceutisch_product[@id = $currentMbh/(toedieningsafspraak | medicatieverstrekking)/*/farmaceutisch_product/@value]">
                     <!-- start with mbh -->
