...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/zibs/2020/payload/0.10.0-beta.1/nl-core-Patient.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024111408212906970990100"
   ...
   <xsl:template match="patient"
      ...
      <xsl:for-each select="$in">
         <Patient>
            ...
            <xsl:for-each select="geslacht | gender">
               <gender>
            ...
            <xsl:for-each select="geboortedatum | date_of_birth">
               <birthDate>
            ...
            <xsl:choose>
               ...
               <xsl:otherwise>
                  <xsl:for-each select="overlijdens_indicator[@value | @nullFlavor]">
                     <deceasedBoolean>
