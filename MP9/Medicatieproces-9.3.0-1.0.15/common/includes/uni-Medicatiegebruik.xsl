...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:template name="uni-relatieMedicatiegebruik">
      <!-- Helper template for the relatie toedieningsafspraak -->
      <xsl:param name="in"
                 select=".">
