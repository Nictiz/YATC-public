...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9449_20230106093041"
                 match="hl7:supply"
                 mode="HandleVV93">
      <!-- Verstrekkingsverzoek MP 9 3.0 -->
      <xsl:param name="in"
                 as="element(hl7:supply)*"
                 select=".">
         <!-- input hl7 verstrekkingsverzoek -->
      </xsl:param>
   ...
   <xsl:template name="uni-relatieVerstrekkingsverzoek">
      <!-- Helper template for the relatie verstrekkingsverzoek -->
      <xsl:param name="in"
                 select=".">
   ...
   <xsl:template match="hl7:author"
                 mode="uni-Verstrekkingsverzoek">
      <!-- Convert hl7:author into ada auteur -->
      <auteur>
   ...
   <xsl:template match="hl7:author/hl7:time"
                 mode="uni-Verstrekkingsverzoek">
      <!-- Convert hl7:author/hl7:time into ada verstrekkingsverzoek_datum -->
