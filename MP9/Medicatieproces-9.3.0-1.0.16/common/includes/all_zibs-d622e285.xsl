...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="ext-CopyIndicator-d622e287.xsl"/>
   <xsl:import href="ext-StopType.xsl"/>
   <xsl:import href="ext-TimeInterval-Duration.xsl"/>
   <xsl:import href="ext-TimeInterval-Period.xsl"/>
   <xsl:import href="nl-core-AddressInformation-d622e291.xsl"/>
   <xsl:import href="nl-core-BodyHeight-d622e292.xsl"/>
   <xsl:import href="nl-core-BodyWeight-d622e293.xsl"/>
   <xsl:import href="nl-core-ContactInformation-d622e294.xsl"/>
   <xsl:import href="nl-core-ContactPerson-d622e295.xsl"/>
   ...
   <xsl:import href="nl-core-LaboratoryTestResult-d622e300.xsl"/>
   <xsl:import href="nl-core-NameInformation-d622e301.xsl"/>
   <xsl:import href="nl-core-Note.xsl"/>
   <xsl:import href="nl-core-Patient-d622e303.xsl"/>
   <xsl:import href="nl-core-PharmaceuticalProduct-d622e304.xsl"/>
   <xsl:import href="nl-core-Problem-d622e305.xsl"/>
