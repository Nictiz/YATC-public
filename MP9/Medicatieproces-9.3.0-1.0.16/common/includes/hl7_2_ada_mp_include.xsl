...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:variable name="templateId-wisselend_doseerschema"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9380'"/>
   <xsl:variable name="templateId-verstrekkingsverzoek"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9356', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9301', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9257'"/>
   <xsl:variable name="templateId-toedieningsafspraak"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9332', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9299', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9259', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9256'"/>
   <xsl:variable name="templateId-medicatietoediening"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9373'"/>
   <xsl:variable name="templateId-stoptype"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9372', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9067'"/>
   <xsl:variable name="templateId-redenVanVoorschrijven"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9316', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9160'"/>
   <xsl:variable name="templateId-redenWijzigenOfStaken"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9370', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9270'"/>
   <xsl:variable name="templateId-verstrekking"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9364', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9294', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9255'"/>
   <xsl:variable name="templateId-medicatiegebruik"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9322', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9279', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9250', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9246', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9208'"/>
   ...
   <xsl:variable name="templateId-labuitslag"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.7.10.31'"/>
   ...
   <xsl:variable name="template-id-rel-afspr-gebr"
                 select="($template-id-rel-ma, $template-id-rel-ta, $template-id-rel-gb)"/>
   <xd:doc>
   ...
   <xsl:template name="_verstrekkerContents907">
      <xsl:for-each select="hl7:id">
         <xsl:variable name="elemName"
                       select="'zorgaanbieder_identificatie_nummer'"/>
   ...
   <xsl:template name="mp9-doseerinstructie-from-mp612-cyclisch">
      ...
      <xsl:variable name="hl7-herhaal-periode"
                    select="$hl7-pivl[hl7:phase[hl7:width]]/hl7:period"/>
      ...
      <xsl:variable name="aantal_distinct_cyclisch"
                    select="count(distinct-values($hl7-herhaal-periode-string/item))"/>
      <xsl:variable name="aantal-delen-cyclisch"
                    select="count($hl7-herhaal-periode)"/>
      <xsl:choose>
         ...
         <xsl:when test="$aantal_distinct_cyclisch = 1 and ($aantal-delen-cyclisch = count($hl7-pivl) - 1 or $aantal-delen-cyclisch = count($hl7-pivl))">
            <xsl:for-each select="$hl7-herhaal-periode[1]">
               <herhaalperiode_cyclisch_schema value="{@value}"
                                               unit="{@unit}"/>
            </xsl:for-each>
            <!-- doseerinstructie -->
               ...
               <doseerinstructie>
                  ...
                  <dosering>
                     ...
                     <xsl:call-template name="mp9-keerdosis">
                        <xsl:with-param name="hl7-doseQuantity"
                                        select="$current-hl7-mar/hl7:doseQuantity"/>
                     </xsl:call-template>
                     <!-- toedieningsschema -->
                     <toedieningsschema>
                        <xsl:call-template name="mp9-vaste-frequentie-from-mp-612">
                           <xsl:with-param name="current-hl7-pivl"
                                           select="$hl7-pivl[not(hl7:phase)]"/>
                        </xsl:call-template>
                     </toedieningsschema>
                     <!-- zo nodig -->
                     <xsl:if test="./ancestor::hl7:medicationAdministrationRequest/hl7:precondition/hl7:observationEventCriterion/hl7:code | ./ancestor::hl7:medicationAdministrationRequest/hl7:maxDoseQuantity">
                        <xsl:call-template name="mp9-zonodig">
                           <xsl:with-param name="max-dose"
                                           select="ancestor::hl7:medicationAdministrationRequest/hl7:maxDoseQuantity"/>
                           <xsl:with-param name="zonodig-code"
                                           select="ancestor::hl7:medicationAdministrationRequest/hl7:precondition/hl7:observationEventCriterion/hl7:code"/>
                        </xsl:call-template>
                     </xsl:if>
      ...
      <xsl:for-each select="$current-hl7-mar">
         <doseerinstructie>
            ...
            <dosering>
               ...
               <!-- zo nodig -->
               <xsl:apply-templates select=".[hl7:precondition/hl7:observationEventCriterion/hl7:code | hl7:maxDoseQuantity]"
                                    mode="#current">
                  <xsl:with-param name="max-dose"
                                  select="hl7:maxDoseQuantity"/>
                  <xsl:with-param name="zonodig-code"
                                  select="hl7:precondition/hl7:observationEventCriterion/hl7:code"/>
               </xsl:apply-templates>
            </dosering>
         </doseerinstructie>
      </xsl:for-each>
         ...
         <doseerinstructie>
            ...
            <dosering>
               ...
               <toedieningsschema>
                  ...
                  <xsl:choose>
                     <xsl:when test="$hl7-pivl[1]/hl7:period[@value = '1'][@unit = 'd']">
                        <!-- Do nothing, no need to output frequency of once a day -->
                     </xsl:when>
                     ...
                     <xsl:when test="$hl7-pivl[1]/hl7:period[@value castable as xs:integer and @value &gt; 1]">
                        ...
                        <frequentie>
                           ...
                           <tijdseenheid value="{$hl7-pivl[1]/hl7:period/@value}"
                                         unit="{nf:convertTime_UCUM2ADA_unit($hl7-pivl[1]/hl7:period/@unit)}"/>
                        </frequentie>
                     </xsl:when>
                     <xsl:otherwise>
                        <xsl:call-template name="util:logMessage">
   ...
   <xsl:template name="mp9-doseerinstructie-from-mp612-var-freq">
      <xsl:param name="hl7-mar"
                 as="element(hl7:medicationAdministrationRequest)*"/>
      <xsl:if test="$logLevel = $logDEBUG">
         ...
         <xsl:when test="count($hl7-mar) = 2">
            <doseerinstructie>
               ...
               <dosering>
                  ...
                  <xsl:call-template name="mp9-keerdosis">
                     <xsl:with-param name="hl7-doseQuantity"
                                     select="$hl7-mar[1]/hl7:doseQuantity"/>
                  </xsl:call-template>
                  <toedieningsschema>
                     <xsl:variable name="min_frequentie_one_decimal"
                                   select="nf:one_decimal($hl7-mar[not(hl7:precondition)]//hl7:period/@value)"/>
                     <xsl:variable name="min_frequentie_decimal"
                                   select="$min_frequentie_one_decimal - floor($min_frequentie_one_decimal)"/>
                     <xsl:variable name="max_frequentie_one_decimal"
                                   select="nf:one_decimal($hl7-mar[hl7:precondition]//hl7:period/@value)"/>
                     <xsl:variable name="max_frequentie_decimal"
                                   select="$max_frequentie_one_decimal - floor($max_frequentie_one_decimal)"/>
                     ...
                     <xsl:choose>
                        <xsl:when test="$min_frequentie_decimal = 0 and $max_frequentie_decimal = 0">
                           <frequentie>
                              ...
                              <tijdseenheid value="{nf:tijdseenheid-aantal($hl7-mar[1]//hl7:period/@value)}"
                                            unit="{nf:convertTime_UCUM2ADA_unit($hl7-mar[1]//hl7:period/@unit)}"/>
                           </frequentie>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:call-template name="util:logMessage">
                              ...
                              <xsl:with-param name="terminate"
                                              select="false()"/>
                              <xsl:with-param name="msg">At least one of the periods from the input hl7 cannot be properly converted to a frequency integer. Fixed period = 
<xsl:value-of select="$hl7-mar[not(hl7:precondition)]//hl7:period/@value"/>
                                 <xsl:value-of select="$hl7-mar[not(hl7:precondition)]//hl7:period/@unit"/> resulting in frequency/aantal/min rounded to one decimal of: 
<xsl:value-of select="$min_frequentie_one_decimal"/> As Needed (zo nodig) period = 
<xsl:value-of select="$hl7-mar[hl7:precondition]//hl7:period/@value"/>
                                 <xsl:value-of select="$hl7-mar[hl7:precondition]//hl7:period/@unit"/> resulting in frequency/aantal/max rounded to one decimal of: 
<xsl:value-of select="$max_frequentie_one_decimal"/>
                              </xsl:with-param>
                           </xsl:call-template>
                        </xsl:otherwise>
                     </xsl:choose>
                  ...
                  <xsl:choose>
                     <xsl:when test="count($hl7-mar/hl7:maxDoseQuantity) = 1 or deep-equal($hl7-mar[1]/hl7:maxDoseQuantity, $hl7-mar[2]/hl7:maxDoseQuantity)">
                        <xsl:call-template name="mp9-zonodig">
                           <xsl:with-param name="max-dose"
                                           select="($hl7-mar/hl7:maxDoseQuantity)[1]"/>
                        </xsl:call-template>
                     </xsl:when>
                     <xsl:otherwise>
                        <xsl:call-template name="util:logMessage">
                           ...
                           <xsl:with-param name="terminate"
                                           select="false()"/>
                           <xsl:with-param name="msg">Found conflicting maxDoseQuantity, both "
<xsl:value-of select="string-join($hl7-mar[hl7:precondition]/hl7:maxDoseQuantity//@*, ' ')"/>" and "
<xsl:value-of select="string-join($hl7-mar[not(hl7:precondition)]/hl7:maxDoseQuantity//@*, ' ')"/>". Cannot output the maxDose in structured format, refer to text.</xsl:with-param>
                        </xsl:call-template>
                     </xsl:otherwise>
                  </xsl:choose>
                  <!-- toedieningssnelheid en toedieningsduur niet ondersteund in 6.12-->
         ...
         <xsl:otherwise>
            <xsl:call-template name="util:logMessage">
               ...
               <xsl:with-param name="terminate"
                               select="false()"/>
               <xsl:with-param name="msg">Unexpected amount of medicationAdministrationRequests, expected 2 but received: 
<xsl:value-of select="count($hl7-mar)"/>
               </xsl:with-param>
            </xsl:call-template>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template name="mp9-gebruiksinstructie-from-mp612"
                 match="hl7:medicationDispenseEvent/hl7:product"
                 mode="#all">
      <xsl:param name="effectiveTimes-eenmalig"/>
      <xsl:param name="hl7-current-comp"
                 select="."
                 as="element()?"/>
      ...
      <gebruiksinstructie>
               ...
               <xsl:when test="$mar-sorted/hl7:routeCode">
                  <xsl:call-template name="mp9-code-attribs">
                     ...
                     <xsl:with-param name="current-hl7-code"
                                     select="($mar-sorted/hl7:routeCode)[1]"/>
                  </xsl:call-template>
               </xsl:when>
               <xsl:otherwise>
                  ...
                  <xsl:attribute name="codeSystem"
                                 select="$oidHL7NullFlavor"/>
                  <xsl:attribute name="displayName"
                                 select="'geen informatie'"/>
               </xsl:otherwise>
            </xsl:choose>
         </toedieningsweg>
         <!-- aanvullende_instructie -->
         <!-- ontdubbelen met for-each-group, staat in 6.12 bij iedere MAR en in 9 op een hoger niveau -->
         <xsl:for-each-group select="$mar-sorted/hl7:support2/hl7:medicationAdministrationInstruction/hl7:code[@code]"
                             group-by="@code">
         ...
         <xsl:for-each-group select="$mar-sorted/hl7:support2/hl7:medicationAdministrationInstruction/hl7:code[@nullFlavor]"
                             group-by="@nullFlavor">
            <xsl:for-each-group select="current-group()"
                                group-by="hl7:originalText">
               <xsl:for-each select="current-group()[1]">
                  <aanvullende_instructie>
                     <xsl:call-template name="mp9-code-attribs">
                        <xsl:with-param name="current-hl7-code"
         ...
         <xsl:variable name="hl7-pivl"
                       select="$mar-sorted//*[replace(xs:string(@xsi:type), '(.*:)?(.+)', '$2') = 'PIVL_TS']"/>
         <xsl:variable name="hl7-ivl"
                       select="$mar-sorted//*[replace(xs:string(@xsi:type), '(.*:)?(.+)', '$2') = 'IVL_TS']"/>
         ...
         <xsl:choose>
            ...
            <xsl:when test="count($effectiveTimes-eenmalig[@value]) = 1 and count($mar-sorted) = 1">
               ...
               <xsl:call-template name="mp9-doseerinstructie-from-mp612-eenmalig">
                  <xsl:with-param name="current-hl7-mar"
                                  select="$mar-sorted"/>
               </xsl:call-template>
            </xsl:when>
               ...
               <xsl:choose>
                  ...
                  <xsl:otherwise>
                     ...
                     <xsl:for-each select="$mar-sorted">
                        <xsl:variable name="hl7-pivl"
                                      select=".//*[replace(xs:string(@xsi:type), '(.*:)?(.+)', '$2') = 'PIVL_TS']"/>
                        <xsl:call-template name="mp9-doseerinstructie-from-mp612-freq">
                           <xsl:with-param name="current-hl7-mar"
                                           select="."/>
                           <xsl:with-param name="hl7-pivl"
            ...
            <!-- MP-2139 we can only handle this with max 1 pivl per mar and no cyclisch schema -->
            <xsl:when test="count($mar-sorted) gt 1 and $parallel and not($hl7-pivl[hl7:phase/hl7:width][hl7:period]) and not($mar-sorted[count(.//*[replace(xs:string(@xsi:type), '(.*:)?(.+)', '$2') = 'PIVL_TS']) gt 1])">
               <xsl:if test="$logLevel = $logDEBUG">
                  <xsl:comment>parallelle dosering, meer dan 1 mar, parallel, max 1 pivl per mar en geen cyclisch schema</xsl:comment>
               </xsl:if>
               <xsl:for-each select="$mar-sorted">
                  <xsl:variable name="hl7-pivl"
                                select=".//*[replace(xs:string(@xsi:type), '(.*:)?(.+)', '$2') = 'PIVL_TS']"/>
                  ...
                  <doseerinstructie>
                     <dosering>
                        <xsl:call-template name="mp9-zonodig">
                           ...
                           <xsl:with-param name="max-dose"
                                           select="$mar-sorted/hl7:maxDoseQuantity"/>
                        </xsl:call-template>
                     </dosering>
                  </doseerinstructie>
               </xsl:if>
                  ...
                  <xsl:for-each select="hl7:substanceAdministration">
                     ...
                     <xsl:element name="{$elemName}">
                        ...
                        <xsl:if test=".//*[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-nl:v3', 'PIVL_TS')]">
                           ...
                           <xsl:element name="{$elemName}">
                              ...
                              <xsl:for-each select="hl7:effectiveTime[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-nl:v3', 'PIVL_TS')][(xs:string(@isFlexible) = 'false' or not(@isFlexible))][not(@alignment)][hl7nl:frequency[hl7nl:numerator/@value]]">
                                 ...
                                 <xsl:variable name="elemName"
                                               select="'interval'"/>
                                 <xsl:variable name="interval-value"
                                               select="format-number(number(hl7nl:frequency/hl7nl:denominator/@value) div number(./hl7nl:frequency/hl7nl:numerator/@value), '0.####')"/>
                                 <xsl:element name="{$elemName}">
                                    ...
                                    <xsl:for-each select="hl7nl:frequency/hl7nl:denominator/@unit">
                                       <xsl:attribute name="unit"
                                                      select="nf:convertTime_UCUM2ADA_unit(.)"/>
                                    </xsl:for-each>
                              ...
                              <xsl:variable name="doseSchema"
                                            select="hl7:effectiveTime[hl7:comp[not(@alignment)][hl7nl:period][hl7nl:phase[not(hl7nl:width)]]][not(hl7:comp/@alignment)][not(hl7:comp[not(hl7nl:period)])][not(hl7:comp[not(hl7nl:phase[not(hl7nl:width)])])]/hl7:comp"/>
                              ...
                              <xsl:for-each select="hl7:effectiveTime[@alignment = 'DW']">
                                 ...
                                 <xsl:call-template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9155_20160727135123_only_phase_low">
                                    <xsl:with-param name="current_PIVL"
                                                    select="."/>
                                 </xsl:call-template>
                              </xsl:for-each>
                              ...
                              <xsl:for-each select="hl7:effectiveTime[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-org:v3', 'SXPR_TS')][hl7:comp/@alignment = 'DW']">
                                 ...
                                 <xsl:variable name="days-with-times"
                                               as="element(days)*">
                                    <xsl:for-each select="hl7:comp[@alignment = 'DW']">
                                       <xsl:variable name="hl7-weekdag"
                                                     select="substring(./hl7nl:phase/hl7nl:low/@value, 1, 8)"/>
                                       <xsl:variable name="hl7-tijd"
                                                     select="substring(./hl7nl:phase/hl7nl:low/@value, 9, 6)"/>
                                       <xsl:variable name="hl7-period"
                                                     select="hl7nl:period"/>
                                       <xsl:variable name="weekdag-xml-date"
                                                     select="nf:formatHL72XMLDate($hl7-weekdag, 'DAY')"/>
                                       <days value="{nf:day-of-week($weekdag-xml-date)}"
                                             period-value="{$hl7-period/@value}"
                                             period-unit="{$hl7-period/@unit}">
                                 ...
                                 <xsl:variable name="day-with-times"
                                               as="element(day)*">
                                    <xsl:for-each-group select="$days-with-times"
                                                        group-by="./@value">
                                       <day value="{@value}">
                                          <xsl:for-each select="current-group()">
                                             <xsl:sort select="./@time"/>
                                             <times period-value="{@period-value}"
                                 ...
                                 <xsl:variable name="frequency-with-daytimes"
                                               as="element(frequency)*">
                                    <xsl:for-each-group select="$days-with-times"
                                                        group-by="./concat(@period-value, @period-unit)">
                                 ...
                                 <xsl:variable name="times-days-mp9-datamodel">
                                    <xsl:if test="count($frequency-with-daytimes) = 1 and $frequency-with-daytimes[concat(@value, @unit) ne '1wk']">
                                       <frequentie value="{$frequency-with-daytimes/@value}"
                                                   unit="{$frequency-with-daytimes/@unit}"/>
                                    </xsl:if>
                                    <xsl:for-each-group select="$day-with-times"
                                                        group-by="string-join(./times/@value, '')">
                                       <xsl:variable name="last-group"
                                                     select="last()"/>
                                       <times group-key="{current-grouping-key()}"
                                       ...
                                       <xsl:for-each select="$times-days-mp9-datamodel/times/weekdag">
                                          <weekdag>
                                             <xsl:call-template name="mp9-weekdag-attribs">
                                                <xsl:with-param name="day-of-week"
                                                                select="./@value"/>
                                             </xsl:call-template>
                                          </weekdag>
                                       </xsl:for-each>
                              ...
                              <xsl:for-each select="hl7:effectiveTime[@alignment = 'HD']">
                                 <xsl:call-template name="mp9-dagdeel">
                                    <xsl:with-param name="PIVL_TS-HD"
                                                    select="."/>
                                 </xsl:call-template>
                              </xsl:for-each>
                              <!-- Complexer doseerschema met meer dan één dagdeel. -->
                              <xsl:variable name="doseSchema"
                                            select="hl7:effectiveTime[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-org:v3', 'SXPR_TS')][hl7:comp/@alignment = 'HD']/hl7:comp"/>
                              <xsl:if test="$doseSchema">
                                 <xsl:for-each select="$doseSchema">
                                    <xsl:call-template name="mp9-dagdeel">
                                       <xsl:with-param name="PIVL_TS-HD"
                        ...
                        <xsl:for-each select="hl7:rateQuantity">
                           <xsl:variable name="ucum-rate-eenheden"
                                         select="./*/@unit"/>
                           <xsl:variable name="ucum-rate-eenheid">
                              <xsl:if test="                                                 every $i in $ucum-rate-eenheden                                                     satisfies $i = $ucum-rate-eenheden[1]">
                           ...
                           <xsl:choose>
                              <xsl:when test="string-length($ucum-rate-eenheid) gt 0">
                                 <toedieningssnelheid>
                                    ...
                                    <xsl:variable name="ucum-eenheid"
                                                  select="substring-before($ucum-rate-eenheid, '/')"/>
                                    <eenheid>
                                    ...
                                    <xsl:variable name="ucum-tijdseenheid"
                                                  select="substring-after($ucum-rate-eenheid, '/')"/>
                                    ...
                                    <xsl:variable name="firstChar"
                                                  select="substring(translate($ucum-tijdseenheid, '0123456789.', ''), 1, 1)"/>
                                    <xsl:variable name="beforeFirstChar"
                                                  select="substring-before($ucum-tijdseenheid, $firstChar)"/>
                                    ...
                                    <xsl:variable name="ucum-tijdseenheid-unit"
                                                  select="concat($firstChar, substring-after($ucum-tijdseenheid, $firstChar))"/>
                                    <tijdseenheid value="{$ucum-tijdseenheid-value}"
                                                  unit="{nf:convertTime_UCUM2ADA_unit($ucum-tijdseenheid-unit)}"/>
                                 </toedieningssnelheid>
                              </xsl:when>
                              <xsl:otherwise>
                                 <xsl:call-template name="util:logMessage">
                                    ...
                                    <xsl:with-param name="terminate"
                                                    select="false()"/>
                                    <xsl:with-param name="msg">Cannot output "toedieningssnelheid" because the ratequantity/*/@unit are not all equal, found: "
<xsl:value-of select="string-join($ucum-rate-eenheden, ' and ')"/>".</xsl:with-param>
                                 </xsl:call-template>
                              </xsl:otherwise>
                           </xsl:choose>
                        </xsl:for-each>
   ...
   <xd:doc>
      ...
      <xd:param name="in">input hl7 component, the 'thing', for example medicationagreement, administrationagreement, medicationuse, that contains the entryRelationship with Instructions for use</xd:param>
   </xd:doc>
   <xsl:template name="mp9-gebruiksinstructie-from-mp910"
                 match="hl7:*"
                 mode="HandleInstructionsforuse910">
      <xsl:param name="in"
                 select="."/>
      <xsl:for-each select="$in">
         <!-- gebruiksinstructie -->
         <gebruiksinstructie>
            ...
            <xsl:variable name="hl7Doseerinstructie"
                          select="hl7:entryRelationship[hl7:substanceAdministration/hl7:templateId/@root = $templateId-toedienschema]"/>
            <!-- herhaalperiode_cyclisch_schema -->
            <xsl:variable name="hl7HerhaalPeriod"
                          select="$hl7Doseerinstructie/hl7:substanceAdministration/hl7:effectiveTime/hl7:comp[not(@alignment)][hl7nl:phase[hl7nl:width]]/hl7nl:period"/>
            <!-- er mag er maar eentje zijn -->
            <xsl:for-each-group select="$hl7HerhaalPeriod"
                                group-by="concat(@value, @unit)">
               <xsl:choose>
                  <xsl:when test="last() gt 1">
                     <!-- we found more than one herhaalperiode_cyclisch_schema, that should not have happened, ouch! -->
                     <xsl:variable name="message">
                        <xsl:text>Found more than one herhaalperiode_cyclisch_schema (</xsl:text>
                        <xsl:value-of select="string-join($hl7HerhaalPeriod/(@value | @unit), ' ')"/>
                        <xsl:text>) in one usage instruction, that should not have happened. We can't output it. Please check your HL7.</xsl:text>
                     </xsl:variable>
            ...
            <xsl:for-each-group select="$hl7Doseerinstructie"
                                group-by="concat(hl7:sequenceNumber/@value, hl7:substanceAdministration/hl7:effectiveTime/hl7:width/concat(@value, @unit))">
               <doseerinstructie>
                  <!-- volgnummer -->
                  ...
                  <xsl:variable name="elemName"
                                select="'doseerduur'"/>
                  <xsl:variable name="hl7Doseerduur"
                                select="$hl7Doseerinstructie/hl7:substanceAdministration/hl7:effectiveTime/hl7:width"/>
                  <xsl:variable name="hl7DoseerduurCyclisch"
                                select="hl7:substanceAdministration/hl7:effectiveTime[hl7:comp[not(@alignment)][hl7nl:period][hl7nl:phase[hl7nl:width]]]/hl7:comp/hl7nl:phase/hl7nl:width"/>
                  <xsl:choose>
                     <!-- doseerduur in Cyclisch doseerschema. -->
                     ...
                     <dosering>
                        ...
                        <xsl:if test=".//*[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-nl:v3', 'PIVL_TS')]">
                           <toedieningsschema>
                              ...
                              <xsl:variable name="PivlEffectiveTime"
                                            select="hl7:effectiveTime[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-nl:v3', 'PIVL_TS')]"/>
                              <xsl:if test="$PivlEffectiveTime">
                                 ...
                                 <xsl:for-each select="$PivlEffectiveTime[not(@alignment)][hl7nl:phase[hl7nl:low][not(hl7nl:width)]][hl7nl:period]">
                                    <xsl:if test="not(hl7nl:period[@value = 1][@unit = 'd'])">
                                       ...
                                       <xsl:variable name="message">
                                          <xsl:text>Unexpected period which is not compliant with templates. Expected period to be 1 day but found: </xsl:text>
                                          <xsl:value-of select="string-join(hl7nl:period/(@value | @unit), ' ')"/>
                                          <xsl:text>. Please check your HL7. However, since there is only one period, we can output this information in ada frequentie to prevent information loss.</xsl:text>
                                       </xsl:variable>
                                       <xsl:call-template name="util:logMessage">
                                          <xsl:with-param name="msg"
                                                          select="$message"/>
                                       ...
                                       <frequentie>
                                          ...
                                          <tijdseenheid value="{hl7nl:period/@value}"
                                                        unit="{nf:convertTime_UCUM2ADA_unit(hl7nl:period/@unit)}"/>
                                       </frequentie>
                                    </xsl:if>
                                    <!-- output the toedieningstijd -->
                                    <xsl:call-template name="handleTS">
                                 ...
                                 <xsl:for-each select="$PivlEffectiveTime[not(@alignment)][not(hl7nl:period)][hl7nl:phase[hl7nl:width]]">
                                    ...
                                    <!-- frequentie -->
                                    <xsl:variable name="hl7Toedientijd"
                                                  as="element(hl7nl:low)*"
                                                  select="hl7nl:phase/hl7nl:low[string-length(@value) gt 9]"/>
                                    ...
                                    <xsl:variable name="hl7IntervalBln"
                                                  as="xs:boolean"
                                                  select="not(xs:string(@isFlexible) = 'true') and not($hl7Toedientijd) and hl7nl:frequency[.//(@value | @unit)]"/>
                              ...
                              <!--  <!-\- Doseerschema met toedieningsduur gecombineerd met meerdere toedientijden -\->
                                        ...
                                        <xsl:if test="$doseSchema">
                                            ...
                                            <xsl:for-each select="$hl7Toedientijd">
                                                <xsl:variable name="elemName" select="'toedientijd'"/>
                                                <xsl:call-template name="handleTS">
...
-->
                              ...
                              <xsl:variable name="doseSchema"
                                            select="hl7:effectiveTime[not(hl7:comp/@alignment = 'DW')][hl7:comp/@alignment = 'HD']/hl7:comp"/>
                              <xsl:if test="$doseSchema">
                              ...
                              <xsl:variable name="doseSchema"
                                            select="hl7:effectiveTime[not(hl7:comp/@alignment = ('DW', 'HD'))]/hl7:comp"/>
                              <xsl:if test="$doseSchema">
                                    ...
                                    <xsl:choose>
                                       <xsl:when test="not(hl7nl:period[@value = 1][@unit = 'd'])">
                                          ...
                                          <xsl:variable name="message">
                                             <xsl:text>Unexpected period which is not compliant with templates. Expected period to be 1 day but found: </xsl:text>
                                             <xsl:value-of select="string-join(hl7nl:period/(@value | @unit), ' ')"/>
                                             <xsl:text>. Please check your HL7. Cannot output this toedientijd (</xsl:text>
                                             <xsl:value-of select="hl7nl:phase/hl7nl:low/@value"/>
                                             <xsl:text>).</xsl:text>
                                          </xsl:variable>
                                          <xsl:call-template name="util:logMessage">
                                             <xsl:with-param name="msg"
...
<xsl:value-of select="string-join($ucum-rate-eenheden, ' and ')"/>".</xsl:with-param>
   ...
   <xsl:template name="mp9-geslacht">
      <xsl:param name="current-administrativeGenderCode"
                 select="."/>
      <xsl:variable name="concept-id-ada-geslacht"
                    select="'2.16.840.1.113883.2.4.3.11.60.20.77.2.3.19831'"/>
      <xsl:call-template name="handleCV">
         <xsl:with-param name="in"
                         select="."/>
         ...
         <xsl:with-param name="codeMap"
                         as="element()*">
            <map inCode="F"
                 inCodeSystem="{$oidHL7AdministrativeGender}"
...
<xsl:value-of select="$hl7-doseQuantity/../hl7:id/@extension"/>
   ...
   <xsl:template name="mp9-naamgegevens">
      <!-- naam binnen patiënt -->
      <xsl:param name="current-hl7-name"
                 select="."/>
      ...
      <naamgegevens>
         ...
         <xsl:call-template name="mp9-naamgebruik">
            <xsl:with-param name="hl7-name"
                            select="$current-hl7-name"/>
         </xsl:call-template>
   ...
   <xsl:template name="mp9-toedieningsafspraak-from-mp612"
      ...
      <xsl:param name="transaction"
                 as="xs:string?">beschikbaarstellen_medicatiegegevens</xsl:param>
      <xsl:variable name="xsd-toedieningsafspraak-complexType"
                    select="$xsd-mbh//xs:element[@name = 'toedieningsafspraak']/@type"/>
      <xsl:variable name="xsd-toedieningsafspraak"
                    select="$xsd-ada//xs:complexType[@name = $xsd-toedieningsafspraak-complexType]"/>
      ...
      <xsl:variable name="mar-sorted"
         ...
         <xsl:for-each select="$current-dispense-event/hl7:product/hl7:dispensedMedication/hl7:therapeuticAgentOf/hl7:medicationAdministrationRequest">
            <xsl:sort data-type="number"
                      select="nf:appendDate2DateTime((.//hl7:effectiveTime | .//hl7:comp)[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-org:v3', 'IVL_TS')]/hl7:low/@value)"/>
      ...
      <xsl:variable name="IVL_TS"
                    as="element()*"
                    select="$current-dispense-event/hl7:product/hl7:dispensedMedication/hl7:therapeuticAgentOf/hl7:medicationAdministrationRequest//(hl7:effectiveTime | hl7:comp)[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-org:v3', 'IVL_TS')]"/>
      <!-- toedieningsafspraak -->
         ...
         <toedieningsafspraak>
            ...
            <xsl:if test="not($mar-sorted[not((.//hl7:effectiveTime | .//hl7:comp)[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-org:v3', 'IVL_TS')]/hl7:low/@value)])">
               ...
               <xsl:call-template name="mp9-gebruiksperiode-start">
                  <xsl:with-param name="inputValue"
                                  select="$IVL_TS[1]/hl7:low/@value"/>
               </xsl:call-template>
            </xsl:if>
            <!-- gebruiksperiode-start bij eenmalig gebruik-->
            <xsl:variable name="effectiveTimes-eenmalig"
                          select="$mar-sorted/hl7:effectiveTime[not(@xsi:type) or (resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-org:v3', 'TS'))]"/>
            <xsl:choose>
               <xsl:when test="count($effectiveTimes-eenmalig[not(@nullFlavor)]) = 1">
                  ...
                  <xsl:call-template name="mp9-gebruiksperiode-start">
                     <xsl:with-param name="inputValue"
                                     select="$effectiveTimes-eenmalig/@value"/>
                  </xsl:call-template>
               </xsl:when>
               <xsl:when test="count($effectiveTimes-eenmalig[@nullFlavor]) = 1">
                  ...
                  <xsl:call-template name="mp9-gebruiksperiode-start">
                     <xsl:with-param name="nullFlavor"
                                     select="$effectiveTimes-eenmalig/@nullFlavor"/>
                  </xsl:call-template>
               </xsl:when>
            ...
            <xsl:choose>
               ...
               <xsl:when test="not($mar-sorted[not((.//hl7:effectiveTime | .//hl7:comp)[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-org:v3', 'IVL_TS')]/hl7:high/@value)])">
                  ...
                  <xsl:variable name="eind-datums"
                                as="element()*">
                     <xsl:for-each select="$IVL_TS/hl7:high[@value]">
                        <xsl:sort data-type="number"
                                  select="nf:appendDate2DateTime(./@value)"/>
                        <xsl:sequence select="."/>
                     </xsl:for-each>
                  </xsl:variable>
                  <xsl:call-template name="mp9-gebruiksperiode-eind">
                     <xsl:with-param name="inputValue"
                                     select="$eind-datums[last()]/@value"/>
                  </xsl:call-template>
               </xsl:when>
               ...
               <xsl:when test="$current-dispense-event[count(.//hl7:medicationAdministrationRequest) gt 1] and not($mar-sorted[not((.//hl7:effectiveTime | .//hl7:comp)[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-org:v3', 'IVL_TS')]/(hl7:low/@value and hl7:width[@unit = 'd']/@value))])">
                  ...
                  <xsl:variable name="einddatums"
                                as="element()*">
                     <xsl:for-each select="$IVL_TS">
                        <xsl:variable name="hl7-start-datum"
                                      select="hl7:low/@value"/>
                        <!-- width is altijd in dagen in 6.12 -->
                        <xsl:variable name="hl7-width-in-days"
                                      select="hl7:width/@value"/>
                        <!-- TODO: als van $hl7-start-datum geen dateTime kan worden gemaakt, valt dit hier om: -->
                        <xsl:variable name="xml-start-datum"
                                      as="xs:dateTime"
                                      select="xs:dateTime(nf:formatHL72XMLDate(nf:appendDate2DateTime($hl7-start-datum), 'SECOND'))"/>
                        <xsl:variable name="xml-eind-datum"
                                      select="xs:dateTime($xml-start-datum + xs:dayTimeDuration(concat('P', $hl7-width-in-days, 'D')))"/>
                        <xml-eind-datum value="{$xml-eind-datum}"/>
                     </xsl:for-each>
                  </xsl:variable>
                  <xsl:variable name="einddatums-sorted"
                                as="xs:dateTime*">
                  ...
                  <xsl:call-template name="mp9-gebruiksperiode-eind">
                     <xsl:with-param name="inputValue"
                                     select="nf:format2HL7Date(xs:string($einddatums-sorted[last()]), 'seconds')"/>
                  </xsl:call-template>
               </xsl:when>
            </xsl:choose>
            <!-- identificatie -->
            <xsl:if test="$transaction = 'beschikbaarstellen_medicatiegegevens'">
               ...
               <xsl:for-each select="hl7:id[@extension]">
                  <identificatie root="{@root}"
                                 value="{concat('TAConverted_', ./@extension)}"/>
               </xsl:for-each>
            </xsl:if>
            ...
            <xsl:apply-templates select="$current-dispense-event"
                                 mode="gebruiksinstructie-MP9">
               <xsl:with-param name="effectiveTimes-eenmalig"
                               select="$effectiveTimes-eenmalig"/>
               <xsl:with-param name="hl7-current-comp"
                               select="."/>
               <xsl:with-param name="mar-sorted"
                               select="$mar-sorted"/>
            </xsl:apply-templates>
         ...
         <toelichting value="toelichting bij TA"/>-->
            ...
            <xsl:if test="$transaction = 'beschikbaarstellen_medicatiegegevens'">
               <relatie_naar_medicatieafspraak>
                  <identificatie value="NI"
                                 root="{$oidHL7NullFlavor}"/>
               </relatie_naar_medicatieafspraak>
            </xsl:if>
         </toedieningsafspraak>
      </xsl:for-each>
   ...
   <xsl:template name="mp9-toedieningsafspraak-from-mp612-907">
      ...
      <xsl:for-each select="$current-dispense-event">
         <toedieningsafspraak>
            ...
            <!-- gebruiksperiode-start bij eenmalig gebruik-->
            <xsl:variable name="effectiveTimes-eenmalig"
                          select="$mar-sorted/hl7:effectiveTime[not(@xsi:type) or resolve-QName(xs:string(@xsi:type), .) = (QName('', 'TS'), QName('urn:hl7-org:v3', 'TS'))]"/>
            <xsl:choose>
               <xsl:when test="count($effectiveTimes-eenmalig[not(@nullFlavor)]) = 1">
                  <xsl:if test="$logLevel = $logDEBUG">
                     <xsl:comment>gebruiksperiode-start bij eenmalig gebruik</xsl:comment>
   ...
   <xsl:template name="mp9-toedieningssnelheid">
      ...
      <xsl:for-each select="$hl7-ratequantity">
         <toedieningssnelheid>
            ...
            <xsl:variable name="ucum-eenheid"
                          select="substring-before((./*/@unit)[1], '/')"/>
            <eenheid>
               <xsl:call-template name="UCUM2GstdBasiseenheid">
                  <xsl:with-param name="UCUM"
                                  select="$ucum-eenheid"/>
      ...
      <xsl:for-each select="$current-hl7-pivl">
         <xsl:for-each select="hl7:period">
            <xsl:variable name="vaste_frequentie_one_decimal"
                          select="nf:one_decimal(./@value)"/>
            <xsl:variable name="vaste_frequentie_decimal"
                          select="$vaste_frequentie_one_decimal - floor($vaste_frequentie_one_decimal)"/>
            <!-- only output the structured frequentie if the one decimal rounded to 0 -->
            <xsl:choose>
               <xsl:when test="$vaste_frequentie_decimal = 0">
                  <frequentie>
                     ...
                     <tijdseenheid value="{nf:tijdseenheid-aantal(./@value)}"
                                   unit="{nf:convertTime_UCUM2ADA_unit(./@unit)}"/>
                  </frequentie>
               </xsl:when>
               <xsl:otherwise>
                  <xsl:variable name="message">
                     <xsl:text>The period cannot be properly converted to a frequency integer. Period = </xsl:text>
                     <xsl:value-of select="./@value"/>
                     <xsl:value-of select="./@unit"/>
                     <xsl:text> resulting in frequency/aantal rounded to one decimal of: </xsl:text>
                     <xsl:value-of select="$vaste_frequentie_one_decimal"/>
                  </xsl:variable>
                  <xsl:if test="$logLevel = $logDEBUG">
                     <xsl:comment>
                        <xsl:value-of select="$message"/>
   ...
   <xsl:template name="mp9-weekdag">
      ...
      <xsl:variable name="hl7-weekdag"
                    select="substring($hl7-phase-low/@value, 1, 8)"/>
      <xsl:variable name="weekdag-xml-date"
                    select="nf:formatHL72XMLDate($hl7-weekdag, 'DAY')"/>
      <weekdag>
         <xsl:call-template name="mp9-weekdag-attribs">
            <xsl:with-param name="day-of-week"
                            select="nf:day-of-week($weekdag-xml-date)"/>
         </xsl:call-template>
      </weekdag>
   </xsl:template>
   <xd:doc>
   ...
   <xsl:template name="mp9-zonodig"
                 match="hl7:precondition/hl7:observationEventCriterion/hl7:code | hl7:maxDoseQuantity"
                 mode="#all">
      <xsl:param name="max-dose"
                 as="element()?"/>
                              ...
                              <xsl:for-each select="$zonodig-code">
                                 <xsl:choose>
                                    <xsl:when test="./@nullFlavor">
                                       <xsl:variable name="currentNullFlavor"
                                                     select="./@nullFlavor"/>
                                       <xsl:variable name="nullFlavorString"
                                                     select="$hl7NullFlavorMap[@hl7NullFlavor = $currentNullFlavor]/@displayName"/>
                                       ...
                                       <xsl:choose>
                                          ...
                                          <xsl:otherwise>unsupported nullFlavor: 
<xsl:value-of select="$currentNullFlavor"/>
                                          </xsl:otherwise>
                                       </xsl:choose>
                                    </xsl:when>
                                    <xsl:otherwise>
                           ...
                           <xsl:attribute name="originalText"
                                          select="normalize-space($concat_originalText)"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </code>
                  <!-- no use case for omschrijving, omschrijving is in code/@originalText -->
   ...
   <xsl:template name="mp9-zonodig-MP92"
                 match="hl7:medicationAdministrationRequest[hl7:precondition/hl7:observationEventCriterion/hl7:code | hl7:maxDoseQuantity]"
                 mode="MP92">
      <xsl:param name="max-dose"
                 as="element()?"/>
      <xsl:param name="zonodig-code"
   ...
   <xsl:template name="mp9-zorgaanbieder">
      ...
      <xsl:for-each select="$hl7-current-organization">
         <zorgaanbieder>
            <xsl:for-each select="hl7:id">
               <zorgaanbieder_identificatie_nummer value="{@extension}"
                                                   root="{@root}"/>
            </xsl:for-each>
            <!-- organisatienaam has 1..1 R in MP 9 ADA transactions, but is not always present in HL7 input messages.  -->
            <!-- fill with nullFlavor if necessary -->
   ...
   <xsl:template name="mp92-zorgaanbieder">
      ...
      <xsl:for-each select="$hl7CurrentOrganization">
         <zorgaanbieder id="uuid-{uuid:get-uuid(.)}">
            <xsl:for-each select="hl7:id">
               <zorgaanbieder_identificatienummer value="{@extension}"
                                                  root="{@root}"/>
            </xsl:for-each>
            <!-- organisatienaam has 1..1 R in MP 9 ADA transactions, but is not always present in HL7 input messages.  -->
            <!-- fill with nullFlavor if necessary -->
   ...
   <xsl:template name="mp910-zorgaanbieder">
      <xsl:param name="in"/>
      <xsl:param name="nestedZorgaanbieder"
                 as="xs:boolean?"
                 select="false()"/>
      <xsl:for-each select="$in">
         <xsl:variable name="elemName"
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.106_20130521000000-MP920">
      <xsl:param name="product-hl7"
                 select="."/>
      <farmaceutisch_product id="uuid-{uuid:get-uuid(.)}">
         <xsl:for-each select="./(hl7:code[@code or @nullFlavor] | hl7:code/hl7:translation[@code or @nullFlavor])">
            <product_code>
               <xsl:call-template name="mp9-code-attribs">
                  <xsl:with-param name="current-hl7-code"
      ...
      <medicamenteuze_behandeling>
         ...
         <xsl:if test="$transaction = 'beschikbaarstellen_medicatiegegevens'">
            <xsl:for-each select="$current-dispense-event/hl7:id[@extension]">
               ...
               <identificatie value="{concat('MedBehConverted_', ./@extension)}"
                              root="{@root}"/>
            </xsl:for-each>
         </xsl:if>
      ...
      <patient>
         ...
         <xsl:for-each select="$current-patient/hl7:Person/hl7:name[*]">
            <xsl:call-template name="mp9-naamgegevens">
               <xsl:with-param name="current-hl7-name"
                               select="."/>
            </xsl:call-template>
         </xsl:for-each>
         <!-- ongestructureerde_naam -->
         ...
         <xsl:for-each select="$current-patient/hl7:Person/hl7:administrativeGenderCode">
            <xsl:call-template name="mp9-geslacht">
               <xsl:with-param name="current-administrativeGenderCode"
                               select="."/>
            </xsl:call-template>
         </xsl:for-each>
         <!-- meerlingindicator -->
            ...
            <xsl:choose>
               <xsl:when test="$vaste_frequentie_decimal = 0">
                  <frequentie>
                     ...
                     <tijdseenheid value="{$tijdseenheid}"
                                   unit="{nf:convertTime_UCUM2ADA_unit(./@unit)}"/>
                  </frequentie>
               </xsl:when>
               <xsl:otherwise>
                  <xsl:call-template name="util:logMessage">
                     ...
                     <xsl:with-param name="terminate"
                                     select="false()"/>
                     <xsl:with-param name="msg">The period cannot be properly converted to a frequency integer. Period = 
<xsl:value-of select="./@value"/>
                        <xsl:value-of select="./@unit"/> resulting in frequency/aantal rounded to one decimal of: 
<xsl:value-of select="$vaste_frequentie_one_decimal"/>
                     </xsl:with-param>
                  </xsl:call-template>
               </xsl:otherwise>
      ...
      <xsl:for-each select="$PIVL_TS[hl7:phase/hl7:center]">
         ...
         <!-- not does a specific with an interval of a partial day (i.e. take at noon every 1,5 day does not make sense) -->
         <xsl:choose>
            <xsl:when test="hl7:period[@value = '1'][@unit = 'd']">
               <!-- Do nothing, no need to output frequency of once a day -->
            </xsl:when>
            <xsl:when test="hl7:period[not(@unit = 'd')]">
               <xsl:variable name="message">
                  <xsl:text>Found a schedule with a specific time and an interval unequal to 'd' (</xsl:text>
                  <xsl:value-of select="string-join(hl7:period[not(@unit = 'd')]/@unit, ' ')"/>
            ...
            <xsl:when test="hl7:period[@value castable as xs:integer and @value &gt; 1]">
               ...
               <frequentie>
                  ...
                  <tijdseenheid value="{hl7:period/@value}"
                                unit="{nf:convertTime_UCUM2ADA_unit(hl7:period/@unit)}"/>
               </frequentie>
            </xsl:when>
            <xsl:otherwise>
               <xsl:call-template name="util:logMessage">
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9066_20160615212337">
      ...
      <xsl:for-each select="$author-hl7/hl7:assignedAuthor">
         <zorgverlener>
            <xsl:for-each select="hl7:id">
               <zorgverlener_identificatie_nummer value="{@extension}"
                                                  root="{@root}"/>
            </xsl:for-each>
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9066_20181205174210">
      ...
      <xsl:for-each select="$in/hl7:assignedAuthor">
         ...
         <zorgverlener>
            <xsl:for-each select="hl7:id">
               <xsl:variable name="elemName"
                             select="'zorgverlener_identificatienummer'"/>
               <xsl:call-template name="handleII">
                  <xsl:with-param name="elemName"
                                  select="$elemName"/>
               </xsl:call-template>
            ...
            <xsl:for-each select="hl7:representedOrganization">
               <xsl:call-template name="mp910-zorgaanbieder">
                  <xsl:with-param name="in"
                                  select="."/>
                  <xsl:with-param name="nestedZorgaanbieder"
                                  select="$nestedZorgaanbieder"/>
               </xsl:call-template>
            </xsl:for-each>
         </zorgverlener>
      </xsl:for-each>
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9155_20160727135123_only_phase_low">
      ...
      <xsl:for-each select="$current_PIVL/hl7nl:phase/hl7nl:low">
         ...
         <xsl:call-template name="mp9-weekdag">
            <xsl:with-param name="hl7-phase-low"
                            select="."/>
         </xsl:call-template>
      </xsl:for-each>
   </xsl:template>
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9276_20191121115616"
                 ...
                 mode="HandleMAContents910">
      <xsl:param name="in"
                 select="."/>
      <xsl:for-each select="$in">
         <xsl:variable name="elemName"
                       select="'medicatieafspraak'"/>
         <xsl:element name="{$elemName}">
            <xsl:variable name="IVL_TS"
                          select="hl7:effectiveTime[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-org:v3', 'IVL_TS')]"/>
            ...
            <xsl:for-each select="hl7:entryRelationship/*[hl7:templateId/@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9086']/hl7:id[@extension | @root | @nullFlavor]">
               <xsl:variable name="elemName"
                             select="'relatie_naar_afspraak_of_gebruik'"/>
               <xsl:element name="{$elemName}">
                  <xsl:variable name="elemName"
                                select="'identificatie'"/>
                  <xsl:call-template name="handleII">
            ...
            <xsl:for-each select="hl7:consumable/hl7:manufacturedProduct/hl7:manufacturedMaterial">
               <xsl:variable name="elemName"
                             select="'afgesproken_geneesmiddel'"/>
               <xsl:element name="{$elemName}">
                  <xsl:call-template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9070_20160618193427">
                     <xsl:with-param name="product-hl7"
                                     select="."/>
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9153_20160726162345"
                 match="hl7:substanceAdministration"
                 mode="HandleProposedMAContents910">
      <xsl:param name="in"
                 select="."/>
      <xsl:for-each select="$in">
         <xsl:variable name="elemName"
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9279_20191121141551"
                 match="hl7:substanceAdministration"
                 mode="HandleMGBContents910">
      <xsl:param name="in"
                 select="."/>
      <!-- medicatie_gebruik -->
      <xsl:for-each select="$in">
         <xsl:variable name="elemName"
                       select="'medicatie_gebruik'"/>
         <xsl:element name="{$elemName}">
            <xsl:variable name="IVL_TS"
                          select="hl7:effectiveTime[resolve-QName(xs:string(@xsi:type), .) = QName('urn:hl7-org:v3', 'IVL_TS')]"/>
            <!-- gebruiksperiode_start -->
            ...
            <xsl:for-each select="hl7:entryRelationship/hl7:observation[hl7:code[@code = '8'][@codeSystem = '2.16.840.1.113883.2.4.3.11.60.20.77.5.2'] or hl7:code[@code = '112221000146107'][@codeSystem = $oidSNOMEDCT]]/hl7:value">
               <xsl:variable name="elemName"
                             select="'volgens_afspraak_indicator'"/>
               <xsl:call-template name="handleBL">
                  <xsl:with-param name="elemName"
                                  select="$elemName"/>
               </xsl:call-template>
            ...
            <xsl:for-each select="hl7:entryRelationship/*[hl7:templateId/@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9086']/hl7:id[@extension | @root | @nullFlavor]">
               <xsl:variable name="elemName"
                             select="'gerelateerde_afspraak'"/>
               <xsl:element name="{$elemName}">
                  <xsl:variable name="elemName"
                                select="'identificatie_medicatieafspraak'"/>
                  <xsl:call-template name="handleII">
                     <xsl:with-param name="elemName"
                                     select="$elemName"/>
                  </xsl:call-template>
            ...
            <xsl:for-each select="hl7:entryRelationship/*[hl7:templateId/@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9101']/hl7:id[@extension | @root | @nullFlavor]">
               ...
               <xsl:element name="{$elemName}">
                  <xsl:variable name="elemName"
                                select="'identificatie_toedieningsafspraak'"/>
                  <xsl:call-template name="handleII">
                     <xsl:with-param name="elemName"
                                     select="$elemName"/>
                  </xsl:call-template>
            ...
            <xsl:for-each select="hl7:entryRelationship/*[hl7:code[@code = '373784005'][@codeSystem = $oidSNOMEDCT]]/hl7:id[@extension | @root | @nullFlavor]">
               <xsl:variable name="elemName"
                             select="'gerelateerde_verstrekking'"/>
               <xsl:element name="{$elemName}">
                  <xsl:variable name="elemName"
                                select="'identificatie'"/>
                  <xsl:call-template name="handleII">
            ...
            <xsl:for-each select="hl7:informant">
               ...
               <xsl:element name="{$elemName}">
                  ...
                  <xsl:for-each select="hl7:assignedEntity[hl7:assignedPerson]">
                     <xsl:variable name="elemName"
                                   select="'informant_is_zorgverlener'"/>
                     <xsl:element name="{$elemName}">
            ...
            <xsl:for-each select="hl7:author">
               ...
               <xsl:element name="{$elemName}">
                  ...
                  <xsl:for-each select="hl7:assignedAuthor[not(hl7:assignedPerson)][not(hl7:code/@code = 'ONESELF')]/hl7:representedOrganization">
                     <xsl:variable name="elemName"
                                   select="'auteur_is_zorgaanbieder'"/>
                     <xsl:element name="{$elemName}">
                        <xsl:call-template name="mp910-zorgaanbieder">
                           <xsl:with-param name="in"
                                           select="."/>
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9300_20191125140358"
                 match="hl7:supply"
      ...
      <xsl:for-each select="$in">
         ...
         <xsl:element name="{$elemName}">
            ...
            <xsl:for-each select="hl7:consumable/hl7:manufacturedProduct/hl7:manufacturedMaterial">
               <xsl:variable name="elemName"
                             select="'geneesmiddel_bij_toedieningsafspraak'"/>
               <xsl:element name="{$elemName}">
                  <xsl:call-template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9070_20160618193427">
                     <xsl:with-param name="product-hl7"
                                     select="."/>
            ...
            <xsl:for-each select="hl7:entryRelationship/*[hl7:templateId/@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9086']/hl7:id">
               <xsl:variable name="elemName"
                             select="'relatie_naar_medicatieafspraak'"/>
               <xsl:element name="{$elemName}">
                  <xsl:call-template name="handleII">
         ...
         <xsl:element name="{$elemName}">
            ...
            <xsl:if test="./hl7:entryRelationship/*[hl7:templateId/@root = $template-id-rel-afspr-gebr]/hl7:id">
               <xsl:element name="{$ada-elemName}">
                  ...
                  <xsl:call-template name="handleII">
                     <xsl:with-param name="in"
                                     select="hl7:entryRelationship/*[hl7:templateId/@root = $template-id-rel-ma]/hl7:id"/>
                     <xsl:with-param name="elemName"
                                     select="$ada-elemName"/>
                  </xsl:call-template>
                  <xsl:variable name="ada-elemName"
                  ...
                  <xsl:call-template name="handleII">
                     <xsl:with-param name="in"
                                     select="hl7:entryRelationship/*[hl7:templateId/@root = $template-id-rel-ta]/hl7:id"/>
                     <xsl:with-param name="elemName"
                                     select="$ada-elemName"/>
                  </xsl:call-template>
                  <xsl:variable name="ada-elemName"
                  ...
                  <xsl:call-template name="handleII">
                     <xsl:with-param name="in"
                                     select="hl7:entryRelationship/*[hl7:templateId/@root = $template-id-rel-gb]/hl7:id"/>
                     <xsl:with-param name="elemName"
                                     select="$ada-elemName"/>
                  </xsl:call-template>
               </xsl:element>
            ...
            <!-- relaties ketenzorg -->
            <xsl:variable name="rel-encounter"
                          select="hl7:entryRelationship[@typeCode = 'REFR']/hl7:encounter"/>
            <xsl:variable name="rel-concern"
                          select="hl7:entryRelationship[@typeCode = 'REFR']/hl7:act[hl7:code[@code = 'CONC'][@codeSystem = '2.16.840.1.113883.5.6']]"/>
            <xsl:if test="$rel-encounter or $rel-concern">
               <xsl:variable name="ada-elemName"
                             select="'relaties_ketenzorg'"/>
               <xsl:element name="{$ada-elemName}">
                  <xsl:variable name="ada-elemName"
                                select="'identificatie_contactmoment'"/>
                  <xsl:call-template name="handleII">
                     <xsl:with-param name="in"
                                     select="$rel-encounter/hl7:id"/>
                     <xsl:with-param name="elemName"
                                     select="$ada-elemName"/>
                  </xsl:call-template>
                  <xsl:variable name="ada-elemName"
                                select="'identificatie_episode'"/>
                  <xsl:call-template name="handleII">
                     <xsl:with-param name="in"
                                     select="$rel-concern/hl7:id"/>
                     <xsl:with-param name="elemName"
                                     select="$ada-elemName"/>
                  </xsl:call-template>
               </xsl:element>
            ...
            <xsl:for-each select="hl7:entryRelationship/*[hl7:templateId/@root = $templateId-redenVanVoorschrijven]/hl7:value">
               <xsl:variable name="ada-elemName"
                             select="'reden_van_voorschrijven'"/>
               <xsl:element name="{$ada-elemName}">
                  <xsl:variable name="ada-elemName"
                                select="'probleem'"/>
                  <xsl:element name="{$ada-elemName}">
            ...
            <xsl:for-each select="hl7:entryRelationship/*[hl7:templateId/@root = '2.16.840.1.113883.2.4.3.11.60.7.10.30'][hl7:value]">
               <xsl:variable name="ada-elemName"
                             select="'lichaamslengte'"/>
               <xsl:element name="{$ada-elemName}">
                  <!-- lengte_waarde -->
                  <xsl:variable name="ada-elemName"
                                select="'lengte_waarde'"/>
                  <xsl:call-template name="handlePQ">
                     <xsl:with-param name="elemName"
                                     select="$ada-elemName"/>
                     <xsl:with-param name="in"
            ...
            <xsl:for-each select="hl7:entryRelationship/*[hl7:templateId/@root = '2.16.840.1.113883.2.4.3.11.60.7.10.28'][hl7:value]">
               <xsl:variable name="ada-elemName"
                             select="'lichaamsgewicht'"/>
               <xsl:element name="{$ada-elemName}">
                  <xsl:variable name="ada-elemName"
                                select="'gewicht_waarde'"/>
                  <xsl:call-template name="handlePQ">
                     <xsl:with-param name="in"
                                     select="hl7:value"/>
                     <xsl:with-param name="elemName"
            ...
            <xsl:call-template name="handleCV">
               <xsl:with-param name="in"
                               select="hl7:entryRelationship/*[hl7:templateId/@root = '2.16.840.1.113883.2.4.3.11.60.20.77.10.9177']/hl7:value"/>
               <xsl:with-param name="elemName"
                               select="$ada-elemName"/>
            </xsl:call-template>
            <!-- kopie_indicator -->
      ...
      <xsl:for-each select="$in">
         ...
         <xsl:element name="{$elemName}">
            ...
            <xsl:for-each select="hl7:entryRelationship/*[hl7:code[(@code = '3' and @codeSystem = '2.16.840.1.113883.2.4.3.11.60.20.77.5.3') or (@code = '52711000146108' and @codeSystem = $oidSNOMEDCT)]]/hl7:id[@root | @extension | @nullFlavor]">
               <xsl:variable name="elemName"
                             select="'relatie_naar_verstrekkingsverzoek'"/>
               <xsl:element name="{$elemName}">
                  <xsl:variable name="elemName"
                                select="'identificatie'"/>
                  <xsl:call-template name="handleII">
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9257_20181204143321"
                 match="hl7:supply"
                 mode="HandleVV910">
      <xsl:param name="in"
                 as="element(hl7:supply)*"
                 select="."/>
      <xsl:for-each select="$in">
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9281_20191121142645"
                 match="hl7:substanceAdministration"
                 mode="HandleMGB910">
      <xsl:param name="in"
                 select="."/>
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9131_20160714201445"
                 match="hl7:supply"
                 mode="HandleProposedVV910">
      <xsl:param name="in"
                 as="element(hl7:supply)*"
                 select="."/>
      <xsl:for-each select="$in">
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9299_20191125140232"
                 match="hl7:supply"
                 mode="HandleTA910">
      <xsl:param name="in"
                 select="."/>
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.3.10.3_20170602000000">
      <xsl:param name="current-patient"
                 select="."/>
      <patient>
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.3.10.3_20170602000000_2">
      ...
      <patient>
         ...
         <xsl:call-template name="handleTS">
            ...
            <xsl:with-param name="in"
                            select="$current-patient/hl7:patient/hl7:birthTime[@value]"/>
            <xsl:with-param name="vagueDate"
                            select="true()"/>
         </xsl:call-template>
         <xsl:for-each select="$current-patient/hl7:patient/hl7:administrativeGenderCode">
   ...
   <xsl:function name="nf:format2HL7Date"
                 as="xs:string?">
   ...
   <xsl:function name="nf:getIsFlexible"
                 as="attribute()?">
      <xsl:param name="in"
                 as="element()*"/>
      <xsl:choose>
   ...
   <xsl:template match="medicamenteuze_behandeling[not(following-sibling::medicamenteuze_behandeling)]"
   ...
   <xsl:template match="toediener/mantelzorger/contactpersoon | voorschrijver/zorgverlener | auteur/zorgverlener | auteur_is_zorgverlener/zorgverlener | toediener/zorgverlener/zorgverlener | farmaceutisch_product | beoogd_verstrekker/zorgaanbieder | verstrekker/zorgaanbieder | auteur_is_zorgaanbieder/zorgaanbieder"
                 mode="handleBouwstenen">
      <xsl:copy>
         <xsl:attribute name="datatype">reference</xsl:attribute>
         <xsl:attribute name="value"
   ...
   <xsl:template match="medicamenteuze_behandeling[not(following-sibling::medicamenteuze_behandeling)]"
      ...
      <bouwstenen>
         ...
         <xsl:variable name="zorgverleners"
                       select="../medicamenteuze_behandeling//zorgverlener[not(zorgverlener)]"/>
         ...
         <xsl:variable name="zorgaanbieders"
                       select="../medicamenteuze_behandeling//zorgaanbieder"/>
   ...
   <xsl:template match="medicamenteuze_behandeling//farmaceutisch_product | medicamenteuze_behandeling//product | medicamenteuze_behandeling//contactpersoon | medicamenteuze_behandeling//zorgaanbieder | medicamenteuze_behandeling//zorgverlener[not(zorgverlener)]"
   ...
   <xsl:template match="criterium/code"
                 mode="handleMP92AdaNameChanges handleMP93AdaNameChanges">
      <criterium>
         <xsl:apply-templates select="node() | @*"
                              mode="#current"/>
      </criterium>
   ...
   <xd:doc>
      <xd:desc>Update ada element name for MP9 3.0</xd:desc>
   </xd:doc>
   <xsl:template match="criterium[code]"
                 mode="handleMP93AdaNameChanges">
      <xsl:apply-templates select="node() | @*"
                           mode="#current"/>
   </xsl:template>
   <xd:doc>
   ...
   <xsl:template match="gebruiksperiode_start"
                 mode="handleMP92AdaNameChanges handleMP93AdaNameChanges">
      <start_datum_tijd>
         <xsl:apply-templates select="node() | @*"
                              mode="#current"/>
   ...
   <xsl:template match="gebruiksperiode_eind"
                 mode="handleMP92AdaNameChanges handleMP93AdaNameChanges">
      <eind_datum_tijd>
         <xsl:apply-templates select="node() | @*"
                              mode="#current"/>
   ...
   <xsl:template match="herhaalperiode_cyclisch_schema/@unit"
                 mode="handleMP92AdaNameChanges handleMP93AdaNameChanges">
      <xsl:attribute name="unit">
         <xsl:choose>
   ...
   <xsl:template match="toedientijd/@value"
                 mode="handleMP92AdaNameChanges handleMP93AdaNameChanges">
      <xsl:attribute name="value">
         <xsl:choose>
   ...
   <xsl:template match="vaste_waarde"
                 mode="handleMP92AdaNameChanges handleMP93AdaNameChanges">
      <nominale_waarde>
         <xsl:apply-templates select="node() | @*"
                              mode="#current"/>
   ...
   <xsl:template match="zorgaanbieder/adresgegevens"
                 mode="handleMP92AdaNameChanges handleMP93AdaNameChanges">
      <xsl:copy>
         <xsl:apply-templates select="@*"
                              mode="#current"/>
         ...
         <xsl:apply-templates select="straat"
                              mode="#current"/>
         <xsl:if test="not(huisnummer)">
            <huisnummer nullFlavor="NI"/>
         </xsl:if>
         <xsl:apply-templates select="huisnummer | huisnummerletter | huisnummertoevoeging | aanduiding_bij_nummer"
                              mode="#current"/>
         ...
         <xsl:apply-templates select="woonplaats | adres_soort"
                              mode="#current"/>
   ...
   <xsl:template match="node() | @*"
                 mode="addBouwstenen deduplicateBouwstenenStep1 deduplicateBouwstenenStep2 handleBouwstenen handleMP92AdaNameChanges handleMP93AdaNameChanges">
      <xsl:copy>
         <xsl:apply-templates select="node() | @*"
                              mode="#current"/>
      </xsl:copy>
   ...
   <xsl:function name="nf:one_decimal"
                 as="xs:float?">
      <xsl:param name="in"
                 as="xs:string?"/>
      <xsl:for-each select="$in">
         <xsl:variable name="in-float"
                       select="xs:float($in)"/>
         <xsl:choose>
   ...
   <xsl:function name="nf:tijdseenheid-aantal"
                 as="xs:float?">
      <xsl:param name="in"
                 as="xs:string?"/>
      <xsl:for-each select="$in">
      ...
      <xsl:choose>
         <xsl:when test="$GstdBasiseenheid_code castable as xs:integer">
            <xsl:choose>
               ...
               <xsl:otherwise>Not supported G-standaard basiseenheid: 
<xsl:value-of select="$GstdBasiseenheid_code"/>
               </xsl:otherwise>
            </xsl:choose>
         </xsl:when>
         <xsl:otherwise>
            <!-- geen integer meegekregen --> G-standaard code is not an integer. Not supported G-standaard basiseenheid: "
<xsl:value-of select="$GstdBasiseenheid_code"/>". </xsl:otherwise>
   ...
   <xsl:function name="nf:convertUnit_UCUM2ADA"
                 as="xs:string">
      <xsl:param name="UCUMunit"
                 as="xs:string"/>
      <xsl:choose>
   ...
   <xsl:function name="nf:day-of-week"
                 as="xs:integer?">
