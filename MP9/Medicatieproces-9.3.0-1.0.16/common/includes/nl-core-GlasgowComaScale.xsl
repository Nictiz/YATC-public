...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/zibs/2020/payload/0.11.0-beta.1/nl-core-GlasgowComaScale.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024111408212943372920100">
   <!-- ================================================================== -->
   <!--
        Converts ADA glasgowcomascale to FHIR Observation conforming to profile nl-core-GlasgowComaScale
    -->
   <!-- ================================================================== -->
   <!--
        Copyright © Nictiz
   ...
   <!-- ================================================================== -->
   <xsl:template match="glasgow_coma_scale"
                 name="nl-core-GlasgowComaScale"
                 mode="nl-core-GlasgowComaScale"
                 as="element(f:Observation)">
      <!-- Create an nl-core-GlasgowComaScale instance as an Observation FHIR instance from ADA glasgow_coma_scale. -->
      <xsl:param name="in"
                 as="element()?"
                 select=".">
