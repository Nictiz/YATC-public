...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/mp/9.3.0/payload/2.0.0-rc.7/mp-DispenseRequest.xsl == -->
   ...
   <xsl:template name="mp-DispenseRequest"
      ...
      <xsl:for-each select="$in">
         <MedicationRequest>
            ...
            <!-- financielIndicationCode -->
            <!-- MP-584 set param treatNullFlavorAsCoding to true() to ensure that nullFlavors won't be transformed into an extension -->
