...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/mp/9.3.0/sturen_afhandeling_medicatievoorschrift/payload/sturen_afhandeling_medicatievoorschrift_2_fhir.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024102208231516883790200"
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="medicatievoorschriftAfhandeling920">
         <xsl:with-param name="mbh"
                         select=".//sturen_afhandeling_medicatievoorschrift[medicamenteuze_behandeling | //medicamenteuze_behandeling_id]"/>
      </xsl:call-template>
   </xsl:template>
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
