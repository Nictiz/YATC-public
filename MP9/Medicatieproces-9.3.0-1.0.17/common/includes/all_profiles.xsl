...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="all_zibs-d655e197.xsl"/>
   ...
   <xsl:import href="../../ada_2_fhir-r4/mp/9.3.0/payload/2.0.0-rc.7/mp-MedicationAdministration2.xsl"/>
   <xsl:import href="../../ada_2_fhir-r4/mp/9.3.0/payload/2.0.0-rc.7/mp-MedicationAgreement.xsl"/>
   <xsl:import href="../../ada_2_fhir-r4/mp/9.3.0/payload/2.0.0-rc.7/mp-MedicationDispense.xsl"/>
   <xsl:import href="../../ada_2_fhir-r4/mp/9.3.0/payload/2.0.0-rc.7/mp-MedicationUse2.xsl"/>
   <xsl:import href="../../ada_2_fhir-r4/mp/9.3.0/payload/2.0.0-rc.7/mp-VariableDosingRegimen.xsl"/>
