...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="fhir_2_ada_fhir_include-d655e298.xsl"/>
   <xsl:import href="mp-functions.xsl"/>
   <xsl:import href="contextContactEpisodeOfCare.xsl"/>
   <xsl:import href="ext-CopyIndicator-d655e304.xsl"/>
   <xsl:import href="ext-StopType.xsl"/>
   <xsl:import href="ext-TimeInterval-Duration.xsl"/>
   <xsl:import href="ext-TimeInterval-Period.xsl"/>
   <xsl:import href="nl-core-AddressInformation-d655e308.xsl"/>
   <xsl:import href="nl-core-BodyHeight-d655e309.xsl"/>
   <xsl:import href="nl-core-BodyWeight-d655e310.xsl"/>
   <xsl:import href="nl-core-ContactInformation-d655e311.xsl"/>
   <xsl:import href="nl-core-ContactPerson-d655e312.xsl"/>
   ...
   <xsl:import href="nl-core-LaboratoryTestResult-d655e317.xsl"/>
   <xsl:import href="nl-core-NameInformation-d655e318.xsl"/>
   <xsl:import href="nl-core-Note.xsl"/>
   <xsl:import href="nl-core-Patient-d655e320.xsl"/>
   <xsl:import href="nl-core-PharmaceuticalProduct-d655e321.xsl"/>
   <xsl:import href="nl-core-Problem-d655e322.xsl"/>
