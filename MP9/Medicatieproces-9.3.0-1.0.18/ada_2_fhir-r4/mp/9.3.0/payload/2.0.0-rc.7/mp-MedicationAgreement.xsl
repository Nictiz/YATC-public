...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/mp/9.3.0/payload/2.0.0-rc.7/mp-MedicationAgreement.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:template name="mp-MedicationAgreement"
      ...
      <xsl:param name="nextPractitioner"
                 select="$in/ancestor::*[@app]//(zorgverlener[@id = $in/volgende_behandelaar/zorgverlener/@value] | zorgaanbieder[@id = $in/volgende_behandelaar/zorgaanbieder/@value]) | $in/volgende_behandelaar/(zorgverlener | zorgaanbieder)[*]"
                 as="element()?">
      ...
      <xsl:for-each select="$in">
         <MedicationRequest>
            ...
            <!-- MP-1935: Add support for volgendeBehandelaar/zorgaanbieder in nextPractitioner -->
                  ...
                  <valueReference>
                     <xsl:call-template name="makeReference">
                        <xsl:with-param name="profile">
                           <xsl:choose>
                              <!-- organization because it is the same concept as the organization in PractitionerRole, the practitioner is simply unknown -->
