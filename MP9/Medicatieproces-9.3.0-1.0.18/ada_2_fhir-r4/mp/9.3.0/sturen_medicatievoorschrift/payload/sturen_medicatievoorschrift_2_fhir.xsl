...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/mp/9.3.0/sturen_medicatievoorschrift/payload/sturen_medicatievoorschrift_2_fhir.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024102208231520119920200"
   ...
   <xsl:template match="/">
      ...
      <xsl:call-template name="medicatievoorschrift930">
         <xsl:with-param name="mbh"
                         select="//sturen_medicatievoorschrift[medicamenteuze_behandeling | //medicamenteuze_behandeling_id]"/>
      </xsl:call-template>
   </xsl:template>
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
