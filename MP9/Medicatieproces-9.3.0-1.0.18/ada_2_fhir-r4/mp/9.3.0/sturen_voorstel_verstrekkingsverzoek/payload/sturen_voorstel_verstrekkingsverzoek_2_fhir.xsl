...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/mp/9.3.0/sturen_voorstel_verstrekkingsverzoek/payload/sturen_voorstel_verstrekkingsverzoek_2_fhir.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024102208231521557030200"
   ...
   <xsl:template name="voorstelVerstrekkingsverzoek920">
      ...
      <Bundle xsl:exclude-result-prefixes="#all">
         ...
         <xsl:for-each select=".//sturen_voorstel_verstrekkingsverzoek/voorstel_gegevens/voorstel/identificatie[@value|@root|@nullFlavor]">
            <identifier>
