...
<!-- == Provenance: YATC-internal/ada-2-fhir-r4/env/mp/9.3.0/touchstone/fhir_fixtures4Touchstone/payload/sturen_voorstel_medicatieafspraak_2_fhir.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024102408112316385830200"
   ...
   <xsl:template name="voorstelMedicatieafspraak920">
      ...
      <xsl:variable name="resultBundle">
         ...
         <Bundle xsl:exclude-result-prefixes="#all">
            ...
            <xsl:for-each select=".//sturen_voorstel_medicatieafspraak/voorstel_gegevens/voorstel/identificatie[@value|@root|@nullFlavor]">
               <identifier>
