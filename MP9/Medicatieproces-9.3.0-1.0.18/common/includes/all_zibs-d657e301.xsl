...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="fhir_2_ada_fhir_include-d657e298.xsl"/>
   <xsl:import href="mp-functions.xsl"/>
   <xsl:import href="contextContactEpisodeOfCare.xsl"/>
   <xsl:import href="ext-CopyIndicator-d657e304.xsl"/>
   <xsl:import href="ext-StopType.xsl"/>
   <xsl:import href="ext-TimeInterval-Duration.xsl"/>
   <xsl:import href="ext-TimeInterval-Period.xsl"/>
   <xsl:import href="nl-core-AddressInformation-d657e308.xsl"/>
   <xsl:import href="nl-core-BodyHeight-d657e309.xsl"/>
   <xsl:import href="nl-core-BodyWeight-d657e310.xsl"/>
   <xsl:import href="nl-core-ContactInformation-d657e311.xsl"/>
   <xsl:import href="nl-core-ContactPerson-d657e312.xsl"/>
   ...
   <xsl:import href="nl-core-LaboratoryTestResult-d657e317.xsl"/>
   <xsl:import href="nl-core-NameInformation-d657e318.xsl"/>
   <xsl:import href="nl-core-Note.xsl"/>
   <xsl:import href="nl-core-Patient-d657e320.xsl"/>
   <xsl:import href="nl-core-PharmaceuticalProduct-d657e321.xsl"/>
   <xsl:import href="nl-core-Problem-d657e322.xsl"/>
