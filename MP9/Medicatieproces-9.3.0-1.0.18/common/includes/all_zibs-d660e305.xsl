...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="fhir_2_ada_fhir_include-d660e301.xsl"/>
   <xsl:import href="mp-functions.xsl"/>
   <xsl:import href="contextContactEpisodeOfCare.xsl"/>
   <xsl:import href="ext-CopyIndicator-d660e307.xsl"/>
   <xsl:import href="ext-StopType.xsl"/>
   <xsl:import href="ext-TimeInterval-Duration.xsl"/>
   <xsl:import href="ext-TimeInterval-Period.xsl"/>
   <xsl:import href="nl-core-AddressInformation-d660e311.xsl"/>
   <xsl:import href="nl-core-BodyHeight-d660e312.xsl"/>
   <xsl:import href="nl-core-BodyWeight-d660e313.xsl"/>
   <xsl:import href="nl-core-ContactInformation-d660e314.xsl"/>
   <xsl:import href="nl-core-ContactPerson-d660e315.xsl"/>
   ...
   <xsl:import href="nl-core-LaboratoryTestResult-d660e320.xsl"/>
   <xsl:import href="nl-core-NameInformation-d660e321.xsl"/>
   <xsl:import href="nl-core-Note.xsl"/>
   <xsl:import href="nl-core-Patient-d660e323.xsl"/>
   <xsl:import href="nl-core-PharmaceuticalProduct-d660e324.xsl"/>
   <xsl:import href="nl-core-Problem-d660e325.xsl"/>
