...
<!-- == Provenance: YATC-internal/fhir-2-ada-r4/env/mp/9.3.0/payload/2.0.0-rc.4/all_profiles.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <!--
    ...
    -->
   <!-- ================================================================== -->
   <xsl:import href="../../../../../common/includes/all_zibs-d660e305.xsl"/>
   ...
   <xsl:import href="../2.0.0-rc.2/ext-PeriodOfUseCondition.xsl"/>
   <xsl:import href="../2.0.0-rc.2/mp-AdministrationAgreement.xsl"/>
   <xsl:import href="../2.0.0-beta.6/mp-DispenseRequest.xsl"/>
   <xsl:import href="mp-InstructionsForUse.xsl"/>
   <xsl:import href="mp-GstdQuantity.xsl"/>
   <xsl:import href="../2.0.0-beta.6/mp-MedicationAdministration.xsl"/>
   ...
   <xsl:import href="../2.0.0-rc.2/mp-antwoord.xsl"/>
