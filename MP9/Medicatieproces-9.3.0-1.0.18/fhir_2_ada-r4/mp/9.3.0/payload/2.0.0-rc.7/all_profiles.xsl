...
<!-- == Provenance: YATC-internal/fhir-2-ada-r4/env/mp/9.3.0/payload/2.0.0-rc.7/all_profiles.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="../2.0.0-rc.4/mp-InstructionsForUse.xsl"/>
   <xsl:import href="../2.0.0-rc.4/mp-GstdQuantity.xsl"/>
