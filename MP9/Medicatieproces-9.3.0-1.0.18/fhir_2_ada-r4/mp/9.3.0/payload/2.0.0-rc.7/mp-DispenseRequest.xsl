...
<!-- == Provenance: YATC-internal/fhir-2-ada-r4/env/mp/9.3.0/payload/2.0.0-rc.7/mp-DispenseRequest.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:template match="f:MedicationRequest"
      ...
      <verstrekkingsverzoek>
         <!-- MP-2104 .id toevoegen aan verstrekkingsverzoek wanneer het om voorstelgegevens gaat -->
