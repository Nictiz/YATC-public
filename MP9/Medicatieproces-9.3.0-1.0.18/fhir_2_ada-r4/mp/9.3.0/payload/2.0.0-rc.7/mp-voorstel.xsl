...
<!-- == Provenance: YATC-internal/fhir-2-ada-r4/env/mp/9.3.0/payload/2.0.0-rc.7/mp-voorstel.xsl == -->
   ...
   <xsl:template match="f:MedicationRequest[f:intent/@value = 'plan']"
      ...
      <voorstel>
         ...
         <!-- <xsl:choose>
            ...
            -->
         <!-- from MP9 3.0.0 rc.2 onwards -->
         <!-- the reference in the proposal is nolonger a medicamenteuze behandeling but a MA or VV -->
         <!-- when it doesn't have a MBH id then it will be empty -->
         <xsl:choose>
            <xsl:when test="./f:category/f:coding/f:code/@value = '33633005'">
            ...
            <xsl:when test="./f:category/f:coding/f:code/@value = '52711000146108'">
