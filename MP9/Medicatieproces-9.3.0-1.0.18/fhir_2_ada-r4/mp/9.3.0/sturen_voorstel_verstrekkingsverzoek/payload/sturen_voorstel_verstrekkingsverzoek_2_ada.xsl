...
<!-- == Provenance: YATC-internal/fhir-2-ada-r4/env/mp/9.3.0/sturen_voorstel_verstrekkingsverzoek/payload/sturen_voorstel_verstrekkingsverzoek_2_ada.xsl == -->
      ...
      <adaxml xsi:noNamespaceSchemaLocation="../ada_schemas/ada_sturen_voorstel_verstrekkingsverzoek.xsd"
         ...
         <data>
            <sturen_voorstel_verstrekkingsverzoek app="mp-mp93"
               ...
               <xsl:for-each select="f:Bundle/f:entry/f:resource/f:MedicationRequest">
               ...
               <!-- MP-2104 -->
               <!-- als er geen MBH id aanwezig is dan wordt dit niet aangemaakt -->
