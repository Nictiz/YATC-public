...
<!-- == Provenance: YATC-internal/hl7-2-ada/env/mp/9.3.0/sturen_afhandeling_medicatievoorschrift/payload/sturen_afhandeling_medicatievoorschrift_hl7_2_ada.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.2024120415184400253440100"
   ...
   <xsl:template match="toedieningsafspraak | medicatieverstrekking | verstrekking"
                 mode="flattenMbhModel">
      <xsl:param name="mbhId"
                 as="element(identificatie)?"/>
      <xsl:copy>
