...
<!-- == Provenance: YATC-internal/hl7-2-ada/env/mp/9.3.0/sturen_medicatiegegevens/payload/sturen_medicatiegegevens_hl7_2_ada.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.202412041518440925350100"
   ...
   <xsl:param name="schemaFileString"
              as="xs:string?">../../hl7_2_ada/mp/9.3.0/sturen_medicatiegegevens/ada_schemas/sturen_medicatiegegevens.xsd</xsl:param>
   ...
   <xsl:template match="medicatieafspraak | wisselend_doseerschema | verstrekkingsverzoek | toedieningsafspraak | medicatieverstrekking | verstrekking | medicatiegebruik | medicatie_gebruik | medicatietoediening"
                 mode="flattenMbhModel">
      <xsl:param name="mbhId"
                 as="element(identificatie)?"/>
      <xsl:copy>
