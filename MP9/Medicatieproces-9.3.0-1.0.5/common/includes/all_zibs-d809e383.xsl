...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="fhir_2_ada_fhir_include-d809e382.xsl"/>
   <xsl:import href="mp-functions.xsl"/>
   <xsl:import href="contextContactEpisodeOfCare.xsl"/>
   <xsl:import href="ext-CopyIndicator-d809e385.xsl"/>
   <xsl:import href="ext-StopType.xsl"/>
   <xsl:import href="ext-TimeInterval-Duration.xsl"/>
   <xsl:import href="ext-TimeInterval-Period.xsl"/>
   <xsl:import href="nl-core-AddressInformation-d809e389.xsl"/>
   <xsl:import href="nl-core-BodyHeight-d809e390.xsl"/>
   <xsl:import href="nl-core-BodyWeight-d809e391.xsl"/>
   <xsl:import href="nl-core-ContactInformation-d809e392.xsl"/>
   <xsl:import href="nl-core-ContactPerson-d809e394.xsl"/>
   ...
   <xsl:import href="nl-core-LaboratoryTestResult-d809e398.xsl"/>
   <xsl:import href="nl-core-NameInformation-d809e399.xsl"/>
   <xsl:import href="nl-core-Note.xsl"/>
   <xsl:import href="nl-core-Patient-d809e401.xsl"/>
   <xsl:import href="nl-core-PharmaceuticalProduct-d809e402.xsl"/>
   <xsl:import href="nl-core-Problem-d809e403.xsl"/>
