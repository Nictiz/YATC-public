...
<!-- == Provenance: YATC-internal/ada-2-hl7/env/mp/9.3.0/test_instances/payload/bouwstenen_transacties_org.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <!--
    ...
    -->
   <!-- ================================================================== -->
   <xsl:import href="../../xml-voorbeelden/bouwstenen_transacties/bouwstenen_transacties_org.xsl"/>
