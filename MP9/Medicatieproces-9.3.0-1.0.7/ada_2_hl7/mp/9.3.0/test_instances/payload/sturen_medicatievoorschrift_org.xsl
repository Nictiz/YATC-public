...
<!-- == Provenance: YATC-internal/ada-2-hl7/env/mp/9.3.0/test_instances/payload/sturen_medicatievoorschrift_org.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <!--
    ...
    -->
   <!-- ================================================================== -->
   <xsl:import href="../../sturen_medicatievoorschrift/payload/sturen_medicatievoorschrift_org.xsl"/>
