...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="fhir_2_ada_fhir_include-d539e225.xsl"/>
   <xsl:import href="mp-functions.xsl"/>
   <xsl:import href="contextContactEpisodeOfCare.xsl"/>
   <xsl:import href="ext-CopyIndicator-d539e230.xsl"/>
   <xsl:import href="ext-StopType.xsl"/>
   <xsl:import href="ext-TimeInterval-Duration.xsl"/>
   <xsl:import href="ext-TimeInterval-Period.xsl"/>
   <xsl:import href="nl-core-AddressInformation-d539e234.xsl"/>
   <xsl:import href="nl-core-BodyHeight-d539e235.xsl"/>
   <xsl:import href="nl-core-BodyWeight-d539e236.xsl"/>
   <xsl:import href="nl-core-ContactInformation-d539e237.xsl"/>
   <xsl:import href="nl-core-ContactPerson-d539e239.xsl"/>
   ...
   <xsl:import href="nl-core-LaboratoryTestResult-d539e243.xsl"/>
   <xsl:import href="nl-core-NameInformation-d539e244.xsl"/>
   <xsl:import href="nl-core-Note.xsl"/>
   <xsl:import href="nl-core-Patient-d539e246.xsl"/>
   <xsl:import href="nl-core-PharmaceuticalProduct-d539e247.xsl"/>
   <xsl:import href="nl-core-Problem-d539e248.xsl"/>
