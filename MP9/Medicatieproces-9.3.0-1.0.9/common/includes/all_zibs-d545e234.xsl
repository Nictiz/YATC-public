...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="fhir_2_ada_fhir_include-d545e232.xsl"/>
   <xsl:import href="mp-functions.xsl"/>
   <xsl:import href="contextContactEpisodeOfCare.xsl"/>
   <xsl:import href="ext-CopyIndicator-d545e236.xsl"/>
   <xsl:import href="ext-StopType.xsl"/>
   <xsl:import href="ext-TimeInterval-Duration.xsl"/>
   <xsl:import href="ext-TimeInterval-Period.xsl"/>
   <xsl:import href="nl-core-AddressInformation-d545e240.xsl"/>
   <xsl:import href="nl-core-BodyHeight-d545e241.xsl"/>
   <xsl:import href="nl-core-BodyWeight-d545e242.xsl"/>
   <xsl:import href="nl-core-ContactInformation-d545e243.xsl"/>
   <xsl:import href="nl-core-ContactPerson-d545e244.xsl"/>
   ...
   <xsl:import href="nl-core-LaboratoryTestResult-d545e249.xsl"/>
   <xsl:import href="nl-core-NameInformation-d545e250.xsl"/>
   <xsl:import href="nl-core-Note.xsl"/>
   <xsl:import href="nl-core-Patient-d545e252.xsl"/>
   <xsl:import href="nl-core-PharmaceuticalProduct-d545e253.xsl"/>
   <xsl:import href="nl-core-Problem-d545e254.xsl"/>
