...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/hl7_2_ada/hl7/hl7_2_ada_hl7_include.xsl"?>
<?yatc-distribution-info name="VZVZ-MedMij" timestamp="2024-01-29T11:45:25.52+01:00" version="0.1"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/hl7_2_ada/hl7/hl7_2_ada_hl7_include.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="constants-d4e25.xsl"/>
   <xsl:import href="datetime-d4e26.xsl"/>
   <xsl:import href="units-d4e27.xsl"/>
   <xsl:import href="utilities-d4e28.xsl"/>
   <xsl:import href="uuid-d4e29.xsl"/>
   <!-- ada output language -->
