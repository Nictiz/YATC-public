...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_hl7/zib2017bbr/2_hl7_zib2017bbr_include.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_hl7/zib2017bbr/2_hl7_zib2017bbr_include.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.3.10.1.100_20170602000000"
      ...
      <xsl:param name="unstructuredNameElement"
                 as="xs:string?">ongestructureerde_naam</xsl:param>
