...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/util/NarrativeGenerator.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/util/NarrativeGenerator.xsl == -->
...
<xsl:stylesheet version="2.0"
                     ...
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              ...
                              <xsl:with-param name="in"
                                              select="f:*[starts-with(local-name(), 'onset')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
                     ...
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              ...
                              <xsl:with-param name="in"
                                              select="f:*[starts-with(local-name(), 'abatement')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
            ...
            <table>
               ...
               <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT_Boolean">
                              <xsl:with-param name="in"
                                              select="f:extension[@url = 'indication']/f:valueBoolean"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                           </xsl:call-template>
                           <xsl:if test="f:extension[@url = 'OnlineEditableUntil']">
                              ...
                              <xsl:call-template name="doDT_DateTime">
                                 <xsl:with-param name="in"
                                                 select="f:extension[@url = 'OnlineEditableUntil']/f:valueDateTime"/>
                                 <xsl:with-param name="textLang"
                                                 select="$textLang"/>
                              </xsl:call-template>
                           </xsl:if>
                  ...
                  <xsl:call-template name="doResourceContext">
                     <xsl:with-param name="in"
                                     select="f:context | f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/extension-context-nl-core-episodeofcare']/f:valueReference"/>
                     <xsl:with-param name="textLang"
                                     select="$textLang"/>
                  </xsl:call-template>
                        ...
                        <td>
                           <ul>
                              <xsl:for-each select="f:participant">
                                 ...
                                 <xsl:sort select="f:required/@value"
                                           order="descending"/>
                                 <li>
                                             ...
                                             <caption>
                                                ...
                                                <xsl:if test="f:category | f:status">
                                                   <span style="display: block;">
                                                      <xsl:copy-of select="$categoryStatus"
                                                                   copy-namespaces="no"/>
                                                   </span>
                                                </xsl:if>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <xsl:call-template name="doDT">
                                                            ...
                                                            <xsl:with-param name="in"
                                                                            select="f:*[starts-with(local-name(), 'scheduled')]"/>
                                                            <xsl:with-param name="textLang"
                                                                            select="$textLang"/>
                                                            <xsl:with-param name="sep">div</xsl:with-param>
                                                            <xsl:with-param name="allowDiv"
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <xsl:call-template name="doDT">
                                                            ...
                                                            <xsl:with-param name="in"
                                                                            select="f:*[starts-with(local-name(), 'reason')]"/>
                                                            <xsl:with-param name="textLang"
                                                                            select="$textLang"/>
                                                            <xsl:with-param name="sep">div</xsl:with-param>
                                                            <xsl:with-param name="allowDiv"
                                                ...
                                                <xsl:if test="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/extension-medicaldevice']">
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <xsl:call-template name="doDT_Reference">
                                                            <xsl:with-param name="in"
                                                                            select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/extension-medicaldevice']/f:valueReference"/>
                                                            <xsl:with-param name="textLang"
                                                                            select="$textLang"/>
                                                            <xsl:with-param name="sep">div</xsl:with-param>
                                                            <xsl:with-param name="allowDiv"
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <xsl:call-template name="doDT">
                                                            ...
                                                            <xsl:with-param name="in"
                                                                            select="f:*[starts-with(local-name(), 'product')]"/>
                                                            <xsl:with-param name="textLang"
                                                                            select="$textLang"/>
                                                            <xsl:with-param name="sep">div</xsl:with-param>
                                                            <xsl:with-param name="allowDiv"
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <xsl:call-template name="doDT">
                              ...
                              <xsl:with-param name="in"
                                              select="f:*[starts-with(local-name(), 'target')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
               ...
               <tbody>
                  ...
                  <xsl:for-each select="f:evidence">
                     <tr>
                        ...
                        <td>
                           <xsl:variable name="codeContents"
                                         as="element()*">
                           ...
                           <xsl:variable name="detailContents"
                                         as="element()*">
                              <xsl:for-each select="f:detail">
                                 <li>
                                    <xsl:call-template name="doDT_Reference">
         ...
         <div xmlns="http://www.w3.org/1999/xhtml">
            ...
            <table>
                     ...
                     <tr>
                        <td colspan="2">
                           <xsl:call-template name="doDT">
                              ...
                              <xsl:with-param name="in"
                                              select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/Comment']/f:*[starts-with(local-name(), 'value')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="sep">div</xsl:with-param>
                              <xsl:with-param name="allowDiv"
               ...
               <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              <xsl:with-param name="baseName">value</xsl:with-param>
                              <xsl:with-param name="in"
                                              select="f:*[starts-with(local-name(), 'value')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
                  ...
                  <xsl:for-each select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-TreatmentDirective-Verification']">
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT_Boolean">
                              <xsl:with-param name="in"
                                              select="f:extension[@url = 'Verified']/f:valueBoolean"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                           </xsl:call-template>
                           <xsl:if test="f:extension[@url = 'VerificationDate']">
                              <xsl:if test="f:extension[@url = 'Verified']">
                                 ...
                                 <xsl:call-template name="doDT">
                                    <xsl:with-param name="baseName">value</xsl:with-param>
                                    <xsl:with-param name="in"
                                                    select="f:extension[@url = 'VerificationDate']/f:*[starts-with(local-name(), 'value')]"/>
                                    <xsl:with-param name="textLang"
                                                    select="$textLang"/>
                                    <xsl:with-param name="allowDiv"
                                                    select="true()"/>
                           ...
                           <xsl:if test="f:extension[@url = 'VerifiedWith']">
                              <xsl:if test="f:extension[@url = 'Verified'] | f:extension[@url = 'VerificationDate']">
                                 ...
                                 <xsl:call-template name="doDT">
                                    <xsl:with-param name="baseName">value</xsl:with-param>
                                    <xsl:with-param name="in"
                                                    select="f:extension[@url = 'VerifiedWith']/f:*[starts-with(local-name(), 'value')]"/>
                                    <xsl:with-param name="textLang"
                                                    select="$textLang"/>
                                    <xsl:with-param name="allowDiv"
                                                    select="true()"/>
                     ...
                     <tr>
                        <th>
                           <xsl:call-template name="doDT">
                              <xsl:with-param name="baseName">value</xsl:with-param>
                              <xsl:with-param name="in"
                                              select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-TreatmentDirective-Treatment']/f:*[starts-with(local-name(), 'value')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              <xsl:with-param name="baseName">value</xsl:with-param>
                              <xsl:with-param name="in"
                                              select="f:modifierExtension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-TreatmentDirective-TreatmentPermitted']/f:*[starts-with(local-name(), 'value')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
                  ...
                  <xsl:variable name="additionalSources"
                                select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/consent-additionalSources']"
                                as="element()*"/>
                     ...
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              ...
                              <xsl:with-param name="in"
                                              select="f:*[starts-with(local-name(), 'source')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="sep">div</xsl:with-param>
                              <xsl:with-param name="allowDiv"
                           ...
                           <xsl:if test="$additionalSources">
                              <div>
                                 <xsl:call-template name="doDT">
                                    <xsl:with-param name="baseName">value</xsl:with-param>
                                    <xsl:with-param name="in"
                                                    select="$additionalSources/f:*[starts-with(local-name(), 'value')]"/>
                                    <xsl:with-param name="textLang"
                                                    select="$textLang"/>
                                    <xsl:with-param name="sep">div</xsl:with-param>
                                    <xsl:with-param name="allowDiv"
                              ...
                              <div>
                                 <xsl:if test="f:extension[@url = 'BankName']">
                                    <div>
                                       ...
                                       <xsl:call-template name="doDT_String">
                                          <xsl:with-param name="in"
                                                          select="f:extension[@url = 'BankName']/f:valueString"/>
                                          <xsl:with-param name="textLang"
                                                          select="$textLang"/>
                                       </xsl:call-template>
                                    </div>
                                 ...
                                 <xsl:if test="f:extension[@url = 'AccountNumber']">
                                    <div>
                                       ...
                                       <xsl:call-template name="doDT_String">
                                          <xsl:with-param name="in"
                                                          select="f:extension[@url = 'AccountNumber']/f:valueString"/>
                                          <xsl:with-param name="textLang"
                                                          select="$textLang"/>
                                       </xsl:call-template>
                                    </div>
                                 ...
                                 <xsl:if test="f:extension[@url = 'Bankcode']">
                                    ...
                                    <xsl:call-template name="doDT_String">
                                       <xsl:with-param name="in"
                                                       select="f:extension[@url = 'Bankcode']/f:valueString"/>
                                       <xsl:with-param name="textLang"
                                                       select="$textLang"/>
                                    </xsl:call-template>
                                 </xsl:if>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        <xsl:call-template name="doDT">
                           <xsl:with-param name="in"
                                           select="f:*[starts-with(local-name(), 'code')]"/>
                           <xsl:with-param name="textLang"
                                           select="$textLang"/>
                  ...
                  <xsl:if test="f:*[starts-with(local-name(), 'occurrence')]">
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              <xsl:with-param name="in"
                                              select="f:*[starts-with(local-name(), 'occurrence')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                  ...
                  <xsl:if test="f:reasonCode | f:reasonReference">
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              <xsl:with-param name="in"
                                              select="f:reasonCode | f:reasonReference"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="sep">div</xsl:with-param>
                              <xsl:with-param name="baseName">reason</xsl:with-param>
                     ...
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              ...
                              <xsl:with-param name="in"
                                              select="f:*[starts-with(local-name(), 'effective')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
                  ...
                  <xsl:if test="f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/flag-detail']">
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT_Reference">
                              <xsl:with-param name="in"
                                              select="f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/flag-detail']/f:*[starts-with(local-name(), 'value')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
                     ...
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              <xsl:with-param name="baseName">outcome</xsl:with-param>
                              <xsl:with-param name="in"
                                              select="f:*[starts-with(local-name(), 'outcome')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
                     ...
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              ...
                              <xsl:with-param name="in"
                                              select="f:*[starts-with(local-name(), 'start')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
                              ...
                              <xsl:if test="f:*[starts-with(local-name(), 'detail')]">
                                 <div>
                                    ...
                                    <xsl:call-template name="doDT">
                                       ...
                                       <xsl:with-param name="in"
                                                       select="f:*[starts-with(local-name(), 'detail')]"/>
                                       <xsl:with-param name="textLang"
                                                       select="$textLang"/>
                                       <xsl:with-param name="allowDiv"
                                                       select="true()"/>
                              ...
                              <xsl:if test="f:*[starts-with(local-name(), 'due')]">
                                 <div>
                                    ...
                                    <xsl:call-template name="doDT">
                                       ...
                                       <xsl:with-param name="in"
                                                       select="f:*[starts-with(local-name(), 'due')]"/>
                                       <xsl:with-param name="textLang"
                                                       select="$textLang"/>
                                       <xsl:with-param name="allowDiv"
                                                       select="true()"/>
                        ...
                        <td>
                           ...
                           <xsl:if test="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/EpisodeOfCare-Title']">
                              <div>
                                 <xsl:call-template name="doDT_String">
                                    <xsl:with-param name="in"
                                                    select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/EpisodeOfCare-Title']/f:valueString"/>
                                    <xsl:with-param name="textLang"
                                                    select="$textLang"/>
                                 </xsl:call-template>
                              </div>
                  ...
                  <xsl:if test="f:careManager | f:managingOrganization">
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT_Reference">
                              <xsl:with-param name="in"
                                              select="f:careManager, f:managingOrganization"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
               ...
               <tbody>
                  <xsl:for-each select="f:recommendation">
                     <tr>
                        ...
                        <td>
                           <xsl:variable name="dateContents"
                                         as="element()*">
   ...
   <xsl:template match="f:List"
      ...
      <xsl:variable name="textLang"
                    select="(f:language/@value, $util:textlangDefault)[1]"/>
      <xsl:variable name="doExtraItemInfo"
                    select="exists(f:entry[f:flag | f:deleted | f:date])"/>
      <text xmlns="http://hl7.org/fhir">
         <status value="extensions"/>
         <div xmlns="http://www.w3.org/1999/xhtml">
            <xsl:call-template name="doDivLanguage"/>
                              ...
                              <xsl:for-each select="f:ingredient">
                                 <li>
                                    ...
                                    <xsl:call-template name="doDT">
                                       ...
                                       <xsl:with-param name="in"
                                                       select="f:*[starts-with(local-name(), 'item')]"/>
                                       <xsl:with-param name="textLang"
                                                       select="$textLang"/>
                                       <xsl:with-param name="allowDiv"
                                                       select="true()"/>
            ...
            <table>
               <xsl:call-template name="doTableCaption">
                  ...
                  <xsl:with-param name="textLang"
                                  select="$textLang"/>
                  <xsl:with-param name="captionAuthorPerformer"
                                  select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationUse-Author']/f:*[starts-with(local-name(), 'value')]"/>
                  <xsl:with-param name="captionAuthorPerformerLabel">
                     <xsl:call-template name="util:getLocalizedString">
                        <xsl:with-param name="key">typeCode-AUT</xsl:with-param>
                        <xsl:with-param name="textLang"
                     ...
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              ...
                              <xsl:with-param name="in"
                                              select="f:*[starts-with(local-name(), 'medication')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
                        ...
                        <td>
                           <xsl:choose>
                              <xsl:when test="f:notGiven/@value">
                                 <xsl:call-template name="util:getLocalizedString">
                                    <xsl:with-param name="key"
                                                    select="concat('boolean-', not(f:notGiven/@value))"/>
                                 </xsl:call-template>
                              </xsl:when>
                  ...
                  <xsl:if test="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-Dispense-DistributionForm']">
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              <xsl:with-param name="in"
                                              select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-Dispense-DistributionForm']/f:*[starts-with(local-name(), 'value')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
                                 ...
                                 <xsl:for-each select="f:*[starts-with(local-name(), 'notDoneReason')]">
                                    <li>
                                       <xsl:call-template name="doDT">
                                          ...
                                          <xsl:with-param name="in"
                                                          select="f:*[starts-with(local-name(), 'notDoneReason')]"/>
                                          <xsl:with-param name="textLang"
                                                          select="$textLang"/>
                                          <xsl:with-param name="allowDiv"
                                                          select="true()"/>
                           ...
                           <xsl:for-each select="f:dispenseRequest">
                              ...
                              <xsl:if test="f:numberOfRepeatsAllowed">
                                 <div>
                                    ...
                                    <xsl:call-template name="doDT_Integer">
                                       <xsl:with-param name="in"
                                                       select="f:numberOfRepeatsAllowed"/>
                                       <xsl:with-param name="textLang"
                                                       select="$textLang"/>
                                    </xsl:call-template>
                                 </div>
                              ...
                              <xsl:if test="f:expectedSupplyDuration">
                                 <div>
                                    ...
                                    <xsl:call-template name="doDT_Quantity">
                                       <xsl:with-param name="in"
                                                       select="f:expectedSupplyDuration"/>
                                       <xsl:with-param name="textLang"
                                                       select="$textLang"/>
                                    </xsl:call-template>
                                 </div>
   ...
   <xsl:template match="f:Observation"
      ...
      <xsl:variable name="textLang"
                    select="(f:language/@value, $util:textlangDefault)[1]"/>
      <xsl:variable name="doInterpretation"
                    select="exists(.//f:interpretation)"/>
      <xsl:variable name="doReferenceRange"
                    select="exists(.//f:referenceRange)"/>
                        ...
                        <td>
                           ...
                           <xsl:for-each select="f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/observation-eventTiming']">
                              <div>
                                 <xsl:call-template name="doDT_Quantity">
                                    <xsl:with-param name="in"
                                                    select="f:extension[@url = 'offset']/f:valueQuantity"/>
                                    <xsl:with-param name="textLang"
                                                    select="$textLang"/>
                                 </xsl:call-template>
                                 <xsl:text> - </xsl:text>
                                 <xsl:call-template name="getLocalizedTimingEvent">
                                    <xsl:with-param name="in"
                                                    select="f:extension[@url = 'code']/f:valueCodeableConcept"/>
                                    <xsl:with-param name="textLang"
                                                    select="$textLang"/>
                                 </xsl:call-template>
                              </div>
   ...
   <xsl:template match="f:Location | f:Organization"
                 mode="createNarrative">
      <xsl:variable name="textLang"
                    select="(f:language/@value, $util:textlangDefault)[1]"/>
      <text xmlns="http://hl7.org/fhir">
   ...
   <xsl:template match="f:Patient | f:Person | f:Practitioner | f:RelatedPerson"
                 mode="createNarrative">
      <xsl:variable name="textLang"
                    select="(f:language/@value, $util:textlangDefault)[1]"/>
      <text xmlns="http://hl7.org/fhir">
         ...
         <div xmlns="http://www.w3.org/1999/xhtml">
            ...
            <xsl:for-each select="f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/patient-nationality']">
               <div>
                  ...
                  <xsl:if test="f:extension[@url = 'period']">
                     ...
                     <xsl:call-template name="doDT_Period">
                        <xsl:with-param name="in"
                                        select="f:extension[@url = 'period']/f:valuePeriod"/>
                        <xsl:with-param name="textLang"
                                        select="$textLang"/>
                        <xsl:with-param name="allowDiv"
                                        select="true()"/>
            ...
            <xsl:if test="f:relationship | f:extension[@url = 'http://fhir.nl/fhir/StructureDefinition/nl-core-relatedperson-role']">
               <div>
                  <xsl:call-template name="doDT_CodeableConcept">
                     <xsl:with-param name="in"
                                     select="f:relationship | f:extension[@url = 'http://fhir.nl/fhir/StructureDefinition/nl-core-relatedperson-role']/f:valueCodeableConcept"/>
                     <xsl:with-param name="textLang"
                                     select="$textLang"/>
                  </xsl:call-template>
                  <xsl:call-template name="util:getLocalizedString">
            ...
            <xsl:if test="f:communication">
               <ul>
                  <xsl:for-each select="f:communication">
                     <xsl:sort select="f:preferred/@value"
                               order="descending"/>
                     <li>
                        <xsl:call-template name="doDT_CodeableConcept">
                           <xsl:with-param name="in"
                  ...
                  <xsl:if test="f:availabilityExceptions">
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT_String">
                              <xsl:with-param name="in"
                                              select="f:availabilityExceptions"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                           </xsl:call-template>
                        </td>
         ...
         <div xmlns="http://www.w3.org/1999/xhtml">
            ...
            <table>
               ...
               <xsl:variable name="requester"
                             select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-NursingIntervention-Requester']"
                             as="element()*"/>
               ...
               <tbody>
                        ...
                        <xsl:if test="f:*[starts-with(local-name(), 'performed')]">
                           <div>
                              ...
                              <xsl:call-template name="doDT">
                                 ...
                                 <xsl:with-param name="in"
                                                 select="f:*[starts-with(local-name(), 'performed')]"/>
                                 <xsl:with-param name="textLang"
                                                 select="$textLang"/>
                                 <xsl:with-param name="allowDiv"
                                                 select="true()"/>
                  ...
                  <xsl:variable name="used"
                                select="f:*[starts-with(local-name(), 'used')]"
                                as="element()*"/>
                  <xsl:variable name="usedExtension"
                                select="$used/f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/extension-medicaldevice']"
                                as="element()*"/>
                  <xsl:if test="$used">
                     <tr>
                        <th>
                        ...
                        <td>
                           <xsl:variable name="contentUsed">
                              <xsl:call-template name="doDT">
                                 ...
                                 <xsl:with-param name="in"
                                                 select="$used[f:reference | f:identifier]"/>
                                 <xsl:with-param name="textLang"
                                                 select="$textLang"/>
                                 <xsl:with-param name="sep">div</xsl:with-param>
                                 <xsl:with-param name="allowDiv"
                           ...
                           <xsl:variable name="contentUsedExtension">
                              <xsl:call-template name="doDT">
                                 <xsl:with-param name="baseName">value</xsl:with-param>
                                 <xsl:with-param name="in"
                                                 select="$usedExtension/f:*[starts-with(local-name(), 'value')]"/>
                                 <xsl:with-param name="textLang"
                                                 select="$textLang"/>
                                 <xsl:with-param name="sep">div</xsl:with-param>
                                 <xsl:with-param name="allowDiv"
                        ...
                        <xsl:if test="f:*[starts-with(local-name(), 'asNeeded')]">
                           <div>
                              ...
                              <xsl:call-template name="doDT">
                                 ...
                                 <xsl:with-param name="in"
                                                 select="f:*[starts-with(local-name(), 'asNeeded')]"/>
                                 <xsl:with-param name="textLang"
                                                 select="$textLang"/>
                                 <xsl:with-param name="allowDiv"
                                                 select="true()"/>
   ...
   <xsl:template match="f:item"
      ...
      <xsl:variable name="textLang"
                    select="(f:language/@value, $util:textlangDefault)[1]"/>
      <li id="_{string-join((../f:identifier[1]/f:value/@value, f:linkId/@value), '--')}"
                        ...
                        <td>
                           ...
                           <xsl:if test="f:*[starts-with(local-name(), 'collected')]">
                              ...
                              <xsl:call-template name="doDT">
                                 ...
                                 <xsl:with-param name="in"
                                                 select="f:*[starts-with(local-name(), 'collected')]"/>
                                 <xsl:with-param name="textLang"
                                                 select="$textLang"/>
                                 <xsl:with-param name="allowDiv"
                                                 select="true()"/>
                           ...
                           <xsl:if test="f:*[starts-with(local-name(), 'time')]">
                              <div>
                                 <xsl:call-template name="doDT">
                                    ...
                                    <xsl:with-param name="in"
                                                    select="f:*[starts-with(local-name(), 'time')]"/>
                                    <xsl:with-param name="textLang"
                                                    select="$textLang"/>
                                    <xsl:with-param name="allowDiv"
                                                    select="true()"/>
                           ...
                           <xsl:if test="f:*[starts-with(local-name(), 'additive')]">
                              <div>
                                 ...
                                 <xsl:call-template name="doDT">
                                    ...
                                    <xsl:with-param name="in"
                                                    select="f:*[starts-with(local-name(), 'additive')]"/>
                                    <xsl:with-param name="textLang"
                                                    select="$textLang"/>
                                    <xsl:with-param name="allowDiv"
                                                    select="true()"/>
                     ...
                     <tr>
                        ...
                        <td>
                           <xsl:call-template name="doDT">
                              ...
                              <xsl:with-param name="in"
                                              select="f:*[starts-with(local-name(), 'definition')]"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                              <xsl:with-param name="allowDiv"
                                              select="true()"/>
   ...
   <xsl:template name="doTableCaption">
      ...
      <xsl:param name="textLang"
                 required="yes"/>
      <xsl:param name="captionAuthorPerformer"
                 as="element()*">
         <xsl:choose>
      ...
      <xsl:for-each select="$in">
         <xsl:variable name="str">
            <xsl:choose>
               ...
               <xsl:when test="                         local-name() = (                         concat($baseName, 'Quantity'),                         concat($baseName, 'Age'),                         concat($baseName, 'Distance'),                         concat($baseName, 'Duration'),                         concat($baseName, 'Money'),                         concat($baseName, 'SimpleQuantity')                         )">
                  <xsl:call-template name="doDT_Quantity">
                     <xsl:with-param name="in"
                                     select="."/>
                     <xsl:with-param name="textLang"
         ...
         <xsl:variable name="str">
            <xsl:if test="f:*[starts-with(local-name(), 'author')]">
               ...
               <xsl:call-template name="doDT">
                  ...
                  <xsl:with-param name="in"
                                  select="f:*[starts-with(local-name(), 'author')]"/>
                  <xsl:with-param name="textLang"
                                  select="$textLang"/>
                  <xsl:with-param name="allowDiv"
                                  select="$allowDiv"/>
               ...
               <xsl:choose>
                  <xsl:when test="f:url[starts-with(@value, 'urn:uuid:') or starts-with(@value, 'urn:oid:')]">
                     ...
                     <xsl:variable name="base64"
                                   select="$in/ancestor-or-self::f:Bundle/f:entry[f:fullUrl/@value = $theUrl]/f:resource/f:Binary/f:content/@value"/>
                     <!-- is this smart? It could duplicate many megabytes... -->
                     <xsl:attribute name="src"
                                    select="concat('data:', f:contentType/@value, ';base64,', $base64)"/>
                  </xsl:when>
                  <xsl:when test="f:url">
                     <xsl:attribute name="src"
                                    select="f:url/@value"/>
                  ...
                  <xsl:when test="f:data">
                     <!-- is this smart? It could duplicate many megabytes... -->
                     <xsl:attribute name="src"
                                    select="concat('data:', f:contentType/@value, ';base64,', f:data/@value)"/>
                  </xsl:when>
               </xsl:choose>
               <xsl:attribute name="alt"/>
               <xsl:if test="f:title">
                  <xsl:attribute name="title"
                                 select="f:title/@value"/>
               </xsl:if>
               <xsl:if test="../f:height">
                  <xsl:attribute name="height"
                                 select="../f:height/@value"/>
               </xsl:if>
               <xsl:if test="../f:width">
                  <xsl:attribute name="width"
                                 select="../f:width/@value"/>
               </xsl:if>
            </img>
         ...
         <xsl:variable name="str">
            <xsl:choose>
               <xsl:when test="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/code-specification']">
                  <xsl:call-template name="doDT_CodeableConcept">
                     <xsl:with-param name="in"
                                     select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/code-specification']/f:valueCodeableConcept"/>
                     <xsl:with-param name="textLang"
                                     select="$textLang"/>
                  </xsl:call-template>
               </xsl:when>
               ...
               <xsl:when test="f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/data-absent-reason']">
                  <xsl:call-template name="getLocalizedDataAbsentReason">
                     <xsl:with-param name="in"
                                     select="f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/data-absent-reason']/f:valueCode"/>
                     <xsl:with-param name="textLang"
                                     select="$textLang"/>
                  </xsl:call-template>
               </xsl:when>
               <xsl:when test="f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/iso21090-nullFlavor']">
                  <xsl:call-template name="getLocalizedNullFlavor">
                     <xsl:with-param name="in"
                                     select="f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/iso21090-nullFlavor']/f:valueCode"/>
                     <xsl:with-param name="textLang"
                                     select="$textLang"/>
                  </xsl:call-template>
               </xsl:when>
         ...
         <xsl:variable name="str">
            <xsl:choose>
               ...
               <xsl:when test="f:coding[f:userSelected/string(@value) = 'true'][f:display]">
                  <xsl:call-template name="doDT_Coding">
                     <xsl:with-param name="in"
                                     select="f:coding[f:userSelected/string(@value) = 'true'][f:display][1]"/>
                     <xsl:with-param name="textLang"
                                     select="$textLang"/>
                  </xsl:call-template>
               </xsl:when>
               ...
               <xsl:when test="f:coding[f:code/@value = ('8308-9', '8306-3')][f:display]">
                  <xsl:call-template name="doDT_Coding">
                     <xsl:with-param name="in"
                                     select="f:coding[f:code/@value = ('8308-9', '8306-3')][f:display][1]"/>
                     <xsl:with-param name="textLang"
                                     select="$textLang"/>
                  </xsl:call-template>
               </xsl:when>
               ...
               <xsl:when test="f:coding[f:code/@value = ('8308-9', '8306-3')]">
                  <xsl:call-template name="doDT_Coding">
                     <xsl:with-param name="in"
                                     select="f:coding[f:code/@value = ('8308-9', '8306-3')][1]"/>
                     <xsl:with-param name="textLang"
                                     select="$textLang"/>
                  </xsl:call-template>
               </xsl:when>
         ...
         <xsl:variable name="i18n_system">
            <xsl:choose>
               ...
               <xsl:when test="starts-with(f:system/@value, 'urn:oid:')">
                  <xsl:call-template name="util:getLocalizedString">
                     <xsl:with-param name="key"
                                     select="replace(f:system/@value, 'urn:oid:', '')"/>
                  </xsl:call-template>
               </xsl:when>
         ...
         <xsl:variable name="str">
            <xsl:choose>
               <xsl:when test="f:display">
                  <span title="{concat(f:display/@value, ' (', string-join((f:code/@value, $i18n_system), ' - '), ')')}"
                        xmlns="http://www.w3.org/1999/xhtml">
   ...
   <xsl:template name="doDT_ContactDetail">
      ...
      <xsl:for-each select="$in">
         ...
         <xsl:variable name="str"
                       select="string-join(($name, $telecom), ', ')"/>
         <xsl:call-template name="doSeparator">
            <xsl:with-param name="str"
                            select="$str"/>
            <xsl:with-param name="sep"
         ...
         <xsl:variable name="use"
            ...
            <xsl:if test="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-ContactInformation-TelecomType'] | f:use/@value">
               <xsl:call-template name="getLocalizedContactPointUse">
                  <xsl:with-param name="in"
                                  select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-ContactInformation-TelecomType'] | f:use"/>
                  <xsl:with-param name="textLang"
                                  select="$textLang"/>
               </xsl:call-template>
            </xsl:if>
         ...
         <xsl:variable name="str">
            <xsl:choose>
               <xsl:when test="@value castable as xs:dateTime">
                  <xsl:variable name="date"
                                select="xs:dateTime(@value)"/>
                  <xsl:variable name="monthName"
                                as="xs:string?">
                     <xsl:call-template name="getLocalizedMonthOfTheYear">
                        <xsl:with-param name="in"
                                        select="month-from-dateTime($date)"/>
                        <xsl:with-param name="textLang"
                                        select="$util:textlangDefault"/>
                     </xsl:call-template>
                  </xsl:variable>
            ...
            <xsl:if test="f:asNeededCodeableConcept">
               <xsl:variable name="tmpText"
                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <xsl:call-template name="doDT_CodeableConcept">
                        <xsl:with-param name="in"
                                        select="f:asNeededCodeableConcept"/>
                        <xsl:with-param name="textLang"
                                        select="$textLang"/>
                     </xsl:call-template>
                  </div>
                  ...
                  <xsl:variable name="tmpText"
                     ...
                     <div xmlns="http://www.w3.org/1999/xhtml">
                        ...
                        <xsl:call-template name="doDT">
                           ...
                           <xsl:with-param name="in"
                                           select="f:*[starts-with(local-name(), 'dose')]"/>
                           <xsl:with-param name="textLang"
                                           select="$textLang"/>
                           <xsl:with-param name="allowDiv"
                                           select="$allowDiv"/>
               ...
               <xsl:variable name="tmpText"
                  ...
                  <div xmlns="http://www.w3.org/1999/xhtml">
                     ...
                     <xsl:call-template name="doDT">
                        ...
                        <xsl:with-param name="in"
                                        select="f:*[starts-with(local-name(), 'rate')]"/>
                        <xsl:with-param name="textLang"
                                        select="$textLang"/>
                        <xsl:with-param name="allowDiv"
                                        select="$allowDiv"/>
                  ...
                  <span xmlns="http://www.w3.org/1999/xhtml">
                     <xsl:attribute name="title">
                        <xsl:for-each select="f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/humanname-assembly-order']">
                           ...
                           <xsl:call-template name="util:getLocalizedString">
                              <xsl:with-param name="key"
                                              select="concat('HumanNameAssemblyOrder-', f:valueCode/@value)"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                           </xsl:call-template>
                        </xsl:for-each>
         ...
         <xsl:variable name="str">
            <xsl:choose>
               ...
               <xsl:when test="f:value/f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/data-absent-reason']">
                  <xsl:call-template name="getLocalizedDataAbsentReason">
                     <xsl:with-param name="in"
                                     select="f:value/f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/data-absent-reason']/f:valueCode"/>
                     <xsl:with-param name="textLang"
                                     select="$textLang"/>
                  </xsl:call-template>
               </xsl:when>
               <xsl:when test="f:value/f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/iso21090-nullFlavor']">
                  <xsl:call-template name="getLocalizedNullFlavor">
                     <xsl:with-param name="in"
                                     select="f:value/f:extension[@url = 'http://hl7.org/fhir/StructureDefinition/iso21090-nullFlavor']/f:valueCode"/>
                     <xsl:with-param name="textLang"
                                     select="$textLang"/>
                  </xsl:call-template>
               </xsl:when>
      ...
      <xsl:for-each select="$in">
         <xsl:variable name="str">
            <xsl:choose>
               <xsl:when test="f:start/@value castable as xs:dateTime and f:end/@value castable as xs:dateTime">
                  <xsl:variable name="start"
                                select="xs:dateTime(f:start/@value)"/>
                  <xsl:variable name="end"
                                select="xs:dateTime(f:end/@value)"/>
                  <xsl:variable name="Y-Match"
                                select="year-from-dateTime($start) = year-from-dateTime($end)"/>
                  <xsl:variable name="M-Match"
                                select="month-from-dateTime($start) = month-from-dateTime($end)"/>
                  <xsl:variable name="D-Match"
                                select="day-from-dateTime($start) = day-from-dateTime($end)"/>
                  <xsl:variable name="h-Match"
                                select="hours-from-dateTime($start) = hours-from-dateTime($end)"/>
                  <xsl:variable name="m-Match"
                                select="minutes-from-dateTime($start) = minutes-from-dateTime($end)"/>
                  <xsl:variable name="s-Match"
                                select="seconds-from-dateTime($start) = seconds-from-dateTime($end)"/>
                  <xsl:variable name="monthNameStart"
                                as="xs:string?">
                     <xsl:call-template name="getLocalizedMonthOfTheYear">
                        <xsl:with-param name="in"
                                        select="month-from-dateTime($start)"/>
                        <xsl:with-param name="textLang"
                                        select="$util:textlangDefault"/>
                     </xsl:call-template>
                  </xsl:variable>
                  <xsl:variable name="monthNameEnd"
                                as="xs:string?">
                     <xsl:call-template name="getLocalizedMonthOfTheYear">
                        <xsl:with-param name="in"
                                        select="month-from-dateTime($end)"/>
                        <xsl:with-param name="textLang"
                                        select="$util:textlangDefault"/>
                     </xsl:call-template>
                  </xsl:variable>
               ...
               <xsl:when test="f:start/@value castable as xs:date and f:end/@value castable as xs:date">
                  <xsl:variable name="start"
                                select="xs:date(f:start/@value)"/>
                  <xsl:variable name="end"
                                select="xs:date(f:end/@value)"/>
                  <xsl:variable name="Y-Match"
                                select="year-from-date($start) = year-from-date($end)"/>
                  <xsl:variable name="M-Match"
                                select="month-from-date($start) = month-from-date($end)"/>
                  <xsl:variable name="D-Match"
                                select="day-from-date($start) = day-from-date($end)"/>
                  <xsl:variable name="monthNameStart"
                                as="xs:string?">
                     <xsl:call-template name="getLocalizedMonthOfTheYear">
                        <xsl:with-param name="in"
                                        select="month-from-date($start)"/>
                        <xsl:with-param name="textLang"
                                        select="$util:textlangDefault"/>
                     </xsl:call-template>
                  </xsl:variable>
            ...
            <xsl:if test="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationUse-Duration']">
               ...
               <xsl:call-template name="doDT">
                  <xsl:with-param name="in"
                                  select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/zib-MedicationUse-Duration']/f:*"/>
                  <xsl:with-param name="textLang"
                                  select="$textLang"/>
                  <xsl:with-param name="allowDiv"
                                  select="$allowDiv"/>
   ...
   <xsl:template name="doDT_Quantity">
      ...
      <xsl:for-each select="$in">
         <xsl:variable name="str"
                       select="string-join((f:value/@value, (f:unit/@value, f:code/@value)[1]), ' ')"/>
         <xsl:call-template name="doSeparator">
            <xsl:with-param name="str"
                            select="$str"/>
            <xsl:with-param name="sep"
         ...
         <xsl:variable name="str">
            <xsl:choose>
               <xsl:when test="$displayForPractitionerRole[contains(., $display)]">
                  <xsl:call-template name="doDT_Reference">
                     <xsl:with-param name="in"
                                     select="f:extension[@url = 'http://nictiz.nl/fhir/StructureDefinition/practitionerrole-reference']/f:valueReference"/>
                     <xsl:with-param name="textLang"
                                     select="$textLang"/>
                     <xsl:with-param name="allowDiv"
                                     select="$allowDiv"/>
                  ...
                  <xsl:for-each select="f:repeat">
                     <xsl:if test="f:*[starts-with(local-name(), 'bounds')]">
                        <xsl:call-template name="doDT">
                           ...
                           <xsl:with-param name="in"
                                           select="f:*[starts-with(local-name(), 'bounds')]"/>
                           <xsl:with-param name="textLang"
                                           select="$textLang"/>
                           <xsl:with-param name="allowDiv"
                                           select="$allowDiv"/>
                        ...
                        <xsl:if test="f:durationUnit">
                           ...
                           <xsl:call-template name="getLocalizedUnitsOfTime">
                              <xsl:with-param name="plural"
                                              select="not(f:duration[@value = '1'])"/>
                              <xsl:with-param name="in"
                                              select="f:durationUnit"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
                           </xsl:call-template>
                        </xsl:if>
                     ...
                     <xsl:if test="f:durationMax">
                        ...
                        <xsl:if test="f:durationUnit">
                           ...
                           <xsl:call-template name="getLocalizedUnitsOfTime">
                              <xsl:with-param name="plural"
                                              select="not(f:durationMax[@value = '1'])"/>
                              <xsl:with-param name="in"
                                              select="f:durationUnit"/>
                              <xsl:with-param name="textLang"
                                              select="$textLang"/>
   ...
   <xsl:template name="getLocalizedUnitsOfTime">
      ...
      <xsl:choose>
         <xsl:when test="$plural and $in/@value = ('s', 'min', 'h', 'd', 'wk', 'mo', 'a')">
            <xsl:call-template name="util:getLocalizedString">
               <xsl:with-param name="key"
                               select="concat('ucums-', $in/@value)"/>
            </xsl:call-template>
         </xsl:when>
         <xsl:when test="$in/@value = ('s', 'min', 'h', 'd', 'wk', 'mo', 'a')">
            <xsl:call-template name="util:getLocalizedString">
               <xsl:with-param name="key"
                               select="concat('ucum-', $in/@value)"/>
            </xsl:call-template>
         </xsl:when>
         <xsl:otherwise>
            <xsl:call-template name="doDT_Code">
   ...
   <xsl:template name="getLocalizedEventTiming">
      ...
      <xsl:choose>
         <xsl:when test="$in/@value = ('HS', 'WAKE', 'C', 'CM', 'CD', 'CV', 'AC', 'ACM', 'ACD', 'ACV', 'PC', 'PCM', 'PCD', 'PCV')">
            <xsl:call-template name="util:getLocalizedString">
               <xsl:with-param name="key"
                               select="concat('eventtiming-', $in/@value)"/>
            </xsl:call-template>
         </xsl:when>
         <xsl:otherwise>
            <xsl:call-template name="doDT_Code">
   ...
   <xsl:template name="getLocalizedIntent">
      ...
      <xsl:choose>
         <xsl:when test="$in/@value = ('proposal', 'plan', 'order', 'option', 'original-order', 'reflex-order', 'filler-order', 'instance-order')">
            <xsl:call-template name="util:getLocalizedString">
               <xsl:with-param name="key"
                               select="concat('intent-', $in/@value)"/>
            </xsl:call-template>
         </xsl:when>
         <xsl:when test="$in/f:coding[f:system/@value = 'http://hl7.org/fhir/request-intent']">
            <xsl:call-template name="getLocalizedIntent">
               <xsl:with-param name="in"
                               select="$in/f:coding[f:system/@value = 'http://hl7.org/fhir/request-intent']/f:code"/>
               <xsl:with-param name="textLang"
                               select="$textLang"/>
            </xsl:call-template>
         </xsl:when>
   ...
   <xsl:template name="getLocalizedListMode">
      ...
      <xsl:choose>
         <xsl:when test="$in/@value = ('working', 'snapshot', 'changes')">
            <xsl:call-template name="util:getLocalizedString">
               <xsl:with-param name="key"
                               select="concat('listmode-', $in/@value)"/>
            </xsl:call-template>
         </xsl:when>
         <xsl:otherwise>
            <xsl:call-template name="doDT_Code">
   ...
   <xsl:template name="getLocalizedDataAbsentReason">
      ...
      <i xmlns="http://www.w3.org/1999/xhtml">
         <xsl:call-template name="util:getLocalizedString">
            <xsl:with-param name="key"
                            select="concat('dataAbsentReason_', $in/@value)"/>
         </xsl:call-template>
         <xsl:text> (</xsl:text>
         <xsl:call-template name="util:getLocalizedString">
   ...
   <xsl:template name="getLocalizedNullFlavor">
      ...
      <i xmlns="http://www.w3.org/1999/xhtml">
         <xsl:call-template name="util:getLocalizedString">
            <xsl:with-param name="key"
                            select="concat('nullFlavor_', $in/@value)"/>
         </xsl:call-template>
         <xsl:text> (</xsl:text>
         <xsl:call-template name="util:getLocalizedString">
            <xsl:with-param name="key">data absent</xsl:with-param>
   ...
   <xsl:template name="getLocalizedPostalAddressUse">
      ...
      <xsl:choose>
         ...
         <xsl:when test="$in/f:coding[f:system/@value = 'http://hl7.org/fhir/v3/AddressUse']">
            <xsl:call-template name="getLocalizedPostalAddressUse">
               <xsl:with-param name="in"
                               select="$in/f:coding[f:system/@value = 'http://hl7.org/fhir/v3/AddressUse']/f:code"/>
               <xsl:with-param name="textLang"
                               select="$textLang"/>
            </xsl:call-template>
         </xsl:when>
   ...
   <xsl:template name="getLocalizedRequestPriority">
      ...
      <xsl:choose>
         <xsl:when test="$in/@value = ('routine', 'urgent', 'asap', 'stat')">
            <xsl:call-template name="util:getLocalizedString">
               <xsl:with-param name="key"
                               select="concat('requestpriority-', $in/@value)"/>
            </xsl:call-template>
         </xsl:when>
         <xsl:otherwise>
            <xsl:call-template name="doDT_Code">
   ...
   <xsl:template name="getLocalizedTimingEvent">
      ...
      <xsl:variable name="codeSystem"
                    select="$in/f:coding/f:system/@value"/>
      <xsl:variable name="code"
                    select="$in/f:coding/f:code/@value"/>
      <xsl:variable name="displayName"
                    as="xs:string?">
         <xsl:if test="count($codeSystem) = 1 and count($code) = 1">
            <xsl:call-template name="util:getLocalizedString">
               <xsl:with-param name="key"
                               select="concat('eventtiming-', $code)"/>
               <xsl:with-param name="textLang"
                               select="$textLang"/>
            </xsl:call-template>
         </xsl:if>
