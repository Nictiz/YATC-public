...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/zibs2020/payload/0.8.0-beta.1/all_zibs.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/zibs2020/payload/0.8.0-beta.1/all_zibs.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="2_fhir_fhir_include-d4e121.xsl"/>
   ...
   <xsl:import href="nl-core-AddressInformation-d4e128.xsl"/>
   ...
   <xsl:import href="nl-core-BodyHeight-d4e137.xsl"/>
   <xsl:import href="nl-core-BodyWeight-d4e138.xsl"/>
   <xsl:import href="nl-core-BodyTemperature.xsl"/>
   <xsl:import href="nl-core-CareTeam.xsl"/>
   <xsl:import href="nl-core-ComfortScale.xsl"/>
   <xsl:import href="nl-core-ContactInformation-d4e142.xsl"/>
   <xsl:import href="nl-core-ContactPerson-d4e143.xsl"/>
   ...
   <xsl:import href="nl-core-LaboratoryTestResult-d4e161.xsl"/>
   ...
   <xsl:import href="nl-core-NameInformation-d4e169.xsl"/>
   ...
   <xsl:import href="nl-core-Patient-d4e173.xsl"/>
   <xsl:import href="nl-core-Payer.xsl"/>
   <xsl:import href="nl-core-PharmaceuticalProduct-d4e175.xsl"/>
   <xsl:import href="nl-core-Problem-d4e176.xsl"/>
   ...
   <xsl:import href="ext-CopyIndicator-d4e190.xsl"/>
