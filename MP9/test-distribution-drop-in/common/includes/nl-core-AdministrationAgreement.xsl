...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/fhir_2_ada-r4/zibs2020/payload/0.8.0-beta.1/nl-core-AdministrationAgreement.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/fhir_2_ada-r4/zibs2020/payload/0.8.0-beta.1/nl-core-AdministrationAgreement.xsl == -->
   ...
   <xsl:template match="f:performer"
      ...
      <verstrekker>
         <zorgaanbieder datatype="reference"
                        value="{nf:convert2NCName(f:actor[f:type/@value='Organization']/f:reference/@value)}"/>
      </verstrekker>
   </xsl:template>
   <xd:doc>
