...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/fhir_2_ada-r4/zibs2020/payload/0.8.0-beta.1/nl-core-InstructionsForUse.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/fhir_2_ada-r4/zibs2020/payload/0.8.0-beta.1/nl-core-InstructionsForUse.xsl == -->
                     ...
                     <dosering>
                        ...
                        <xsl:if test="f:doseAndRate/(f:rateRatio | f:rateRange | f:rateQuantity)">
                           <toedieningssnelheid>
                              ...
                              <!-- eenheid -->
                              <!-- tijdseenheid -->
                              <xsl:apply-templates select="f:doseAndRate/f:rateRatio"
                                                   mode="#current"/>
