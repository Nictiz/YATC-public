...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/zibs2020/payload/0.5-beta1/nl-core-MedicalDevice.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/zibs2020/payload/0.5-beta1/nl-core-MedicalDevice.xsl == -->
               ...
               <xsl:choose>
                  <xsl:when test="@codeSystem = ($oidGTIN, $oidHIBC)">
                     <xsl:variable name="system"
                                   select="local:getUri(@codeSystem)"/>
                     <identifier>
                        <system value="{$system}"/>
                        <value value="{@code}"/>
                     </identifier>
