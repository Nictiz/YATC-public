...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/zibs2020/payload/0.5-beta1/nl-core-NameInformation.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/zibs2020/payload/0.5-beta1/nl-core-NameInformation.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:template match="naamgegevens"
      ...
      <xsl:for-each select="$in">
         ...
         <xsl:variable name="generatedInitials"
                       as="xs:string*">
   ...
   <xd:doc>
      ...
      <xd:param name="normalizedFirstNames">The list of normalized first names (as returned by 
<xd:ref name="nf:_normalizeFirstNames()"/>
      </xd:param>
      <xd:param name="normalizedInitials">The list of normalized initials (as returned by 
<xd:ref name="nf:_normalizeInitials()"/>
      </xd:param>
