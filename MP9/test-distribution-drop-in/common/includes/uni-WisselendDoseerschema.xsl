...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/hl7_2_ada/zibs2020/payload/uni-WisselendDoseerschema.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/hl7_2_ada/zibs2020/payload/uni-WisselendDoseerschema.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:variable name="templateId-wisselend_doseerschema"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9412', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9380'"/>
   <xsl:variable name="templateId-redenWijzigenOfStakenWDS"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9439', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9404'"/>
   <xd:doc>
      <xd:desc> Wisselend doseerschema MP 9.2 Inhoud </xd:desc>
      <xd:param name="in_hl7">HL7 wds, defaults to context.</xd:param>
   </xd:doc>
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9380_20210617175854"
                 match="hl7:substanceAdministration"
                 mode="HandleWDS92">
      <xsl:param name="in_hl7"
                 select="."/>
