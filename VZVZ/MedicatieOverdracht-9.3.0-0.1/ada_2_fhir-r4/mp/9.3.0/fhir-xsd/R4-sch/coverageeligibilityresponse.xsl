...
<!-- == Provenance: HL7-mappings/ada_2_fhir-r4/mp/9.3.0/fhir-xsd/R4-sch/coverageeligibilityresponse.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse"
                  priority="1024"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:text/h:div"
                  priority="1023"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:identifier/f:period"
                  priority="1022"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:identifier/f:assigner"
                  priority="1021"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:patient"
                  priority="1020"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:patient"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:patient/f:identifier/f:period"
                  priority="1019"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:patient/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:patient/f:identifier/f:assigner"
                  priority="1018"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:patient/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:servicedPeriod"
                  priority="1017"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:servicedPeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:requestor"
                  priority="1016"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:requestor"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:requestor/f:identifier/f:period"
                  priority="1015"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:requestor/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:requestor/f:identifier/f:assigner"
                  priority="1014"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:requestor/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:request"
                  priority="1013"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:request"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:request/f:identifier/f:period"
                  priority="1012"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:request/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:request/f:identifier/f:assigner"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:request/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:insurer"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:insurer"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:insurer/f:identifier/f:period"
                  priority="1009"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:insurer/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:insurer/f:identifier//f:assigner"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:insurer/f:identifier//f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:insurance/f:coverage"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:insurance/f:coverage"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:insurance/f:coverage/f:identifier/f:period"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:insurance/f:coverage/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:insurance/f:coverage/f:identifier/f:assigner"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:insurance/f:coverage/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:insurance/f:benefitPeriod"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:insurance/f:benefitPeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:insurance/f:item"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:insurance/f:item"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="exists(f:category) or exists(f:productOrService)"/>
         <axsl:otherwise>
            <svrl:failed-assert test="exists(f:category) or exists(f:productOrService)"
                                xmlns:svrl="http://purl.oclc.org/dsdl/svrl">
               <axsl:attribute name="location">
                  <axsl:apply-templates select="."
                                        mode="schematron-select-full-path"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:insurance/f:item/f:provider"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:insurance/f:item/f:provider"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:insurance/f:item/f:provider/f:identifier/f:period"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:insurance/f:item/f:provider/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:CoverageEligibilityResponse/f:insurance/f:item/f:provider/f:identifier/f:assigner"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:CoverageEligibilityResponse/f:insurance/f:item/f:provider/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
