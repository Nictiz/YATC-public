...
<!-- == Provenance: HL7-mappings/ada_2_fhir-r4/mp/9.3.0/fhir-xsd/R4-sch/eventdefinition.xsl == -->
...
<axsl:value-of select="$fileDirParameter"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition"
                  priority="1043"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:text/h:div"
                  priority="1042"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:text/h:div"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:identifier/f:period"
                  priority="1041"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:identifier/f:assigner"
                  priority="1040"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:subjectReference"
                  priority="1039"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:subjectReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:subjectReference/f:identifier/f:period"
                  priority="1038"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:subjectReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:subjectReference/f:identifier/f:assigner"
                  priority="1037"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:subjectReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:contact/f:telecom"
                  priority="1036"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:contact/f:telecom"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:contact/f:telecom/f:period"
                  priority="1035"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:contact/f:telecom/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:useContext/f:valueQuantity"
                  priority="1034"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:useContext/f:valueQuantity"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:useContext/f:valueRange"
                  priority="1033"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:useContext/f:valueRange"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:useContext/f:valueRange/f:low"
                  priority="1032"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:useContext/f:valueRange/f:low"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:useContext/f:valueRange/f:high"
                  priority="1031"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:useContext/f:valueRange/f:high"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:useContext/f:valueReference"
                  priority="1030"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:useContext/f:valueReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:useContext/f:valueReference/f:identifier/f:period"
                  priority="1029"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:useContext/f:valueReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:useContext/f:valueReference/f:identifier/f:assigner"
                  priority="1028"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:useContext/f:valueReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:effectivePeriod"
                  priority="1027"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:effectivePeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:author/f:telecom"
                  priority="1026"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:author/f:telecom"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:value)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:author/f:telecom/f:period"
                  priority="1025"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:author/f:telecom/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:editor/f:telecom"
                  priority="1024"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:editor/f:telecom"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:value)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:editor/f:telecom/f:period"
                  priority="1023"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:editor/f:telecom/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:reviewer/f:telecom"
                  priority="1022"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:reviewer/f:telecom"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:value)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:reviewer/f:telecom/f:period"
                  priority="1021"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:reviewer/f:telecom/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:endorser/f:telecom"
                  priority="1020"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:endorser/f:telecom"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:value)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:endorser/f:telecom/f:period"
                  priority="1019"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:endorser/f:telecom/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:relatedArtifact/f:document"
                  priority="1018"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:relatedArtifact/f:document"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger"
                  priority="1017"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:timingTiming/f:repeat"
                  priority="1016"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:timingTiming/f:repeat"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:timingTiming/f:repeat/f:boundsDuration"
                  priority="1015"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:timingTiming/f:repeat/f:boundsDuration"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:timingTiming/f:repeat/f:boundsRange"
                  priority="1014"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:timingTiming/f:repeat/f:boundsRange"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:low/f:value/@value)) or not(exists(f:high/f:value/@value)) or (number(f:low/f:value/@value) &lt;= number(f:high/f:value/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:timingTiming/f:repeat/f:boundsRange/f:low"
                  priority="1013"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:timingTiming/f:repeat/f:boundsRange/f:low"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:timingTiming/f:repeat/f:boundsRange/f:high"
                  priority="1012"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:timingTiming/f:repeat/f:boundsRange/f:high"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:code)) or exists(f:system)"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:timingTiming/f:repeat/f:boundsPeriod"
                  priority="1011"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:timingTiming/f:repeat/f:boundsPeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:timingReference"
                  priority="1010"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:timingReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:timingReference/f:identifier/f:period"
                  priority="1009"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:timingReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:timingReference/f:identifier/f:assigner"
                  priority="1008"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:timingReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:data/f:subjectReference"
                  priority="1007"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:data/f:subjectReference"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:data/f:subjectReference/f:identifier/f:period"
                  priority="1006"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:data/f:subjectReference/f:identifier/f:period"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:data/f:subjectReference/f:identifier/f:assigner"
                  priority="1005"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:data/f:subjectReference/f:identifier/f:assigner"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(starts-with(f:reference/@value, '#')) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, '#')])"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:data/f:codeFilter"
                  priority="1004"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:data/f:codeFilter"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:data/f:dateFilter"
                  priority="1003"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:data/f:dateFilter"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(exists(f:path) and not(exists(f:searchParam))) or (not(exists(f:path)) and exists(f:searchParam))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:data/f:dateFilter/f:valuePeriod"
                  priority="1002"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:data/f:dateFilter/f:valuePeriod"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="not(exists(f:start/@value)) or not(exists(f:end/@value)) or (xs:dateTime(f:start/@value) &lt;= xs:dateTime(f:end/@value))"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:data/f:dateFilter/f:valueDuration"
                  priority="1001"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:data/f:dateFilter/f:valueDuration"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
         <axsl:when test="(f:code or not(f:value)) and (not(exists(f:system)) or f:system/@value='http://unitsofmeasure.org')"/>
   ...
   <!--RULE -->
   <axsl:template match="f:EventDefinition/f:trigger/f:condition"
                  priority="1000"
                  mode="M4">
      <svrl:fired-rule context="f:EventDefinition/f:trigger/f:condition"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"/>
      <!--ASSERT -->
      <axsl:choose>
