...
<!-- == Provenance: HL7-mappings/ada_2_fhir-r4/fhir/2_fhir_fhir_include.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="2_fhir_fhir_include-d788e314.xsl"/>
   <xd:doc>
      <xd:desc>
...
<xd:ul>
   ...
   <xsl:variable name="ada2resourceType">
      ...
      <nm:map ada="registratie_gegevens"
              resource="Provenance"
              profile="cio-RegistrationData"/>
