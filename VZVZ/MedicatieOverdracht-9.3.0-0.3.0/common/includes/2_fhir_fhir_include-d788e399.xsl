...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="uuid-d788e400.xsl"/>
   <xsl:import href="datetime-d788e401.xsl"/>
   <xsl:import href="units-d788e402.xsl"/>
   <xsl:import href="constants-d788e403.xsl"/>
   <!--    <xsl:import href="../../util/utilities.xsl"/>-->
   <xsl:import href="NarrativeGenerator-d788e404.xsl"/>
