...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="uuid-d816e416.xsl"/>
   <xsl:import href="datetime-d816e417.xsl"/>
   <xsl:import href="units-d816e418.xsl"/>
   <xsl:import href="constants-d816e419.xsl"/>
   <!--    <xsl:import href="../../util/utilities.xsl"/>-->
   <xsl:import href="NarrativeGenerator-d816e420.xsl"/>
