...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/YATC-shared/xsl/util/mp-functions-fhir.xsl"?>
<?yatc-distribution-info name="VZVZ-MedMij" timestamp="2024-01-29T11:45:25.52+01:00" version="0.1"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/YATC-shared/xsl/util/mp-functions-fhir.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <!--
    ...
    -->
   <!-- ================================================================== -->
   <xsl:import href="mp-functions-d4e33.xsl"/>
