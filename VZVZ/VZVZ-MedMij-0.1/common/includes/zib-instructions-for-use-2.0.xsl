...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/YATC-internal/ada-2-fhir/env/zibs2017/payload/zib-instructions-for-use-2.0.xsl"?>
<?yatc-distribution-info name="VZVZ-MedMij" timestamp="2024-01-29T11:45:25.52+01:00" version="0.1"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/YATC-internal/ada-2-fhir/env/zibs2017/payload/zib-instructions-for-use-2.0.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
   <xsl:template name="_handle-toedieningsweg"
                 match="toedieningsweg"
                 mode="_handleToedieningsweg">
   ...
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
   <xsl:template name="handle-gebruiksinstructie"
                 match="gebruiksinstructie"
   ...
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
   <xsl:template name="zib-InstructionsForUse-2.0-di"
      ...
      <xsl:variable name="gebruiksinstructieItemsRelevant"
                    select="dosering/keerdosis[.//(@value | @unit)] or dosering/toedieningsschema[.//(@value | @code | @nullFlavor)]"/>
      <!-- gebruiksinstructie/aanvullende_instructie  -->
   ...
   <!-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -->
   <xsl:template name="zib-InstructionsForUse-2.0-gi"
                 match="gebruiksinstructie"
                 mode="doDosageContents">
      <!-- Template for 'gebruiksinstructie' in case there is no doseerinstructie/dosering. 
            Without the FHIR element dosage / dosageInstruction, 
