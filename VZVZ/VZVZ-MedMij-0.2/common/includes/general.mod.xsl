...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/YATC-shared/xslmod/general.mod.xsl"?>
<?yatc-distribution-info name="VZVZ-MedMij" timestamp="2024-02-06T09:13:30.86+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/YATC-shared/xslmod/general.mod.xsl == -->
...
<xsl:stylesheet version="2.0"
   ...
   <xsl:function name="yatcs:get-document-collection"
      ...
      <xsl:variable name="documents"
                    as="document-node()*"
                    select="collection($hrefDir || '?select=' || $filenamePattern)"/>
      <xsl:choose>
