...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/YATC-shared/xsl/util/units.xsl"?>
<?yatc-distribution-info name="VZVZ-MedMij" timestamp="2024-02-06T09:13:30.86+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/YATC-shared/xsl/util/units.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
                ...
                xmlns:local="#local.202311150847544262810100">
   <!-- ================================================================== -->
   <!--
        TBD
    -->
   ...
   <xsl:variable name="UCUM2GstdMap"
                 as="element()+">
      <map UCUMCode="cm"
           GstdCode="205"
           GstdDisplayName="centimeter"/>
      <map UCUMCode="g"
           GstdCode="215"
           GstdDisplayName="gram"/>
      <map UCUMCode="[iU]"
           GstdCode="217"
           GstdDisplayName="internationale eenheid"/>
      <map UCUMCode="kg"
           GstdCode="219"
           GstdDisplayName="kilogram"/>
      <map UCUMCode="l"
           GstdCode="222"
           GstdDisplayName="liter"/>
      <map UCUMCode="mg"
           GstdCode="229"
           GstdDisplayName="milligram"/>
      <map UCUMCode="ml"
           GstdCode="233"
           GstdDisplayName="milliliter"/>
      <map UCUMCode="mm"
           GstdCode="234"
           GstdDisplayName="millimeter"/>
      <map UCUMCode="1"
           GstdCode="245"
           GstdDisplayName="stuk"/>
      <map UCUMCode="ug"
           GstdCode="252"
           GstdDisplayName="microgram"/>
      <map UCUMCode="ul"
           GstdCode="254"
           GstdDisplayName="microliter"/>
      <map UCUMCode="[drp]"
           GstdCode="303"
           GstdDisplayName="druppel"/>
   </xsl:variable>
   <!--
    ...
    -->
   <xsl:key name="unitcode"
            match="ucum:base-unit | ucum:unit"
            use="@Code"/>
   <!--
