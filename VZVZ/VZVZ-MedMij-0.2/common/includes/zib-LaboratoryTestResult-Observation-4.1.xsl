...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/hl7_2_ada/zibs2017/payload/zib-LaboratoryTestResult-Observation-4.1.xsl"?>
<?yatc-distribution-info name="VZVZ-MedMij" timestamp="2024-02-06T09:13:30.86+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/hl7_2_ada/zibs2017/payload/zib-LaboratoryTestResult-Observation-4.1.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:template name="zib-LaboratoryTestResult-Observation-4.1"
                 match="hl7:observation"
                 as="element()*"
                 mode="doZibLaboratoryResultObservation-4.1">
      <xsl:param name="in"
                 select="."
                 as="element()?"/>
