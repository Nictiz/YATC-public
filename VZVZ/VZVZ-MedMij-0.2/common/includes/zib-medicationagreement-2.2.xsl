...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/YATC-internal/ada-2-fhir/env/zibs2017/payload/zib-medicationagreement-2.2.xsl"?>
<?yatc-distribution-info name="VZVZ-MedMij" timestamp="2024-02-06T09:13:30.86+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/YATC-internal/ada-2-fhir/env/zibs2017/payload/zib-medicationagreement-2.2.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:param name="dateT"
              as="xs:date?"/>
   <!-- ================================================================== -->
   <xsl:template name="MedicationAgreementEntry-2.2"
                 match="medicatieafspraak | medication_agreement"
                 as="element()"
                 mode="doMedicationAgreementEntry-2.2">
   ...
   <xsl:template name="zib-MedicationAgreement-2.2"
                 ...
                 mode="doZibMedicationAgreement-2.2"
                 as="element()">
