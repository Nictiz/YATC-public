...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/mp/9.3.0/payload/2.0.0-beta.2/mp-MedicationAdministration2.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/mp/9.3.0/payload/2.0.0-beta.2/mp-MedicationAdministration2.xsl == -->
               ...
               <xsl:when test="relatie_toedieningsafspraak/identificatie[@value]">
                  <supportingInformation>
                     ...
                     <identifier>
                        <xsl:call-template name="id-to-Identifier">
                           <xsl:with-param name="in"
                                           select="relatie_toedieningsafspraak/identificatie[@value]"/>
                        </xsl:call-template>
                     </identifier>
