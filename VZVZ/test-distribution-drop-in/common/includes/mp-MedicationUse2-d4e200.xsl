...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/mp/9.3.0/payload/2.0.0-beta.2/mp-MedicationUse2.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/mp/9.3.0/payload/2.0.0-beta.2/mp-MedicationUse2.xsl == -->
               ...
               <xsl:choose>
                  <xsl:when test="self::persoon/contactpersoon[@value]">
                     <informationSource>
                        <xsl:call-template name="makeReference">
                           <xsl:with-param name="in"
                                           select="ancestor::data/*//contactpersoon[@id = current()/persoon/contactpersoon/@value]"/>
                        </xsl:call-template>
                     </informationSource>
                  </xsl:when>
