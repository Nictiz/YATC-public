...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/fhir_2_ada-r4/zibs2020/payload/0.8.0-beta.1/nl-core-MedicationAdministration.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/fhir_2_ada-r4/zibs2020/payload/0.8.0-beta.1/nl-core-MedicationAdministration.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:template match="f:MedicationAdministration"
                 mode="nl-core-MedicationAdministration">
      <medicatietoediening>
         <!-- identificatie -->
         ...
         <xsl:apply-templates select="f:extension[@url = $extMedicationAdministration2AgreedDateTime]"
                              mode="#current"/>
         ...
         <xsl:apply-templates select="f:dosage/f:extension[@url = $extMedicationAdministrationAgreedAmount]/f:valueQuantity"
                              mode="#current"/>
         ...
         <xsl:apply-templates select="f:dosage/f:route"
                              mode="nl-core-InstructionsForUse"/>
         <!-- toedieningssnelheid -->
         ...
         <xsl:apply-templates select="f:extension[@url = $extMedicationAdministrationReasonForDeviation]"
                              mode="#current"/>
   ...
   <xsl:template match="f:extension[@url = $extMedicationAdministrationReasonForDeviation]"
                 mode="nl-core-MedicationAdministration">
...
<xd:ref name="extMedicationAdministrationAgreedAmount"
   ...
   <xsl:template match="f:dosage/f:extension[@url = $extMedicationAdministrationAgreedAmount]/f:valueQuantity"
                 mode="nl-core-MedicationAdministration">
      <afgesproken_hoeveelheid>
   ...
   <xsl:template match="f:extension[@url = $extMedicationAdministration2AgreedDateTime]"
                 mode="nl-core-MedicationAdministration">
