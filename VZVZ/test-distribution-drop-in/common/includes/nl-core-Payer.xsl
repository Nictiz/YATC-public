...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/zibs2020/payload/0.7-beta1/nl-core-Payer.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/zibs2020/payload/0.7-beta1/nl-core-Payer.xsl == -->
         ...
         <Coverage>
            ...
            <xsl:call-template name="insertLogicalId">
               <xsl:with-param name="profile"
                               select="'nl-core-Payer.InsuranceCompany'"/>
            </xsl:call-template>
            <meta>
   ...
   <xsl:template name="nl-core-Payer.PayerPerson"
      ...
      <xsl:for-each select="$in">
         <Coverage>
            <xsl:call-template name="insertLogicalId">
               <xsl:with-param name="profile"
                               select="'nl-core-Payer.PayerPerson'"/>
            </xsl:call-template>
            <meta>
