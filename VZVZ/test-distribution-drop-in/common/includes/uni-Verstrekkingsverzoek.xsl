...
<?yatc-distribution-provenance href="C:/Data/Erik/work/Nictiz/new/HL7-mappings/hl7_2_ada/zibs2020/payload/uni-Verstrekkingsverzoek.xsl"?>
<?yatc-distribution-info name="VZVZ-test-distribution-drop-in" timestamp="2024-01-25T12:13:11.57+01:00" version="0.2"?>
<!-- == Provenance: C:/Data/Erik/work/Nictiz/new/HL7-mappings/hl7_2_ada/zibs2020/payload/uni-Verstrekkingsverzoek.xsl == -->
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:variable name="templateId-verstrekkingsverzoek"
                 as="xs:string*"
                 select="'2.16.840.1.113883.2.4.3.11.60.20.77.10.9449','2.16.840.1.113883.2.4.3.11.60.20.77.10.9356', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9301', '2.16.840.1.113883.2.4.3.11.60.20.77.10.9257'"/>
   <xd:doc>
      <xd:desc>Verstrekkingsverzoek MP 9 2.0</xd:desc>
      <xd:param name="in">input hl7 verstrekkingsverzoek</xd:param>
   </xd:doc>
   <xsl:template name="template_2.16.840.1.113883.2.4.3.11.60.20.77.10.9356_20210402132627"
                 match="hl7:supply"
                 mode="HandleVV92">
      <xsl:param name="in"
      ...
      <xsl:for-each select="$in">
         <verstrekkingsverzoek>
            ...
            <!-- auteur -->
            <xsl:apply-templates select="hl7:author[.//(@value | @code | @nullFlavor)]"
                                 mode="uni-Verstrekkingsverzoek"/>
            ...
            <xsl:call-template name="mp92-gebruiksperiode">
               <xsl:with-param name="IVL_TS"
                               select="hl7:expectedUseTime[.//(@value | @unit | @nullFlavor | @code)]"/>
            ...
            <xsl:call-template name="handleCV">
               <xsl:with-param name="in"
                               select="hl7:entryRelationship/hl7:observation[hl7:code[@code = '153931000146103'][@codeSystem = $oidSNOMEDCT]]/hl7:value[@code | @nullFlavor]"/>
