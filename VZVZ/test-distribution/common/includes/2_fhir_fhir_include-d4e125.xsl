...
<!-- == Flattened from: C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/fhir/2_fhir_fhir_include.xsl == -->
<!--
Copyright © Nictiz
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="2_fhir_fhir_include-d4e68.xsl"/>
   <xd:doc>
      <xd:desc>
