...
<!-- == Flattened from: C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/zibs2020/payload/0.8.0-beta.1/all_zibs.xsl == -->
<!--
Copyright (c) Nictiz
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="2_fhir_fhir_include-d4e125.xsl"/>
   ...
   <xsl:import href="nl-core-AddressInformation-d4e132.xsl"/>
   ...
   <xsl:import href="nl-core-BodyHeight-d4e141.xsl"/>
   <xsl:import href="nl-core-BodyWeight-d4e142.xsl"/>
   <xsl:import href="nl-core-BodyTemperature.xsl"/>
   <xsl:import href="nl-core-CareTeam.xsl"/>
   <xsl:import href="nl-core-ComfortScale.xsl"/>
   <xsl:import href="nl-core-ContactInformation-d4e146.xsl"/>
   <xsl:import href="nl-core-ContactPerson-d4e147.xsl"/>
   ...
   <xsl:import href="nl-core-LaboratoryTestResult-d4e165.xsl"/>
   ...
   <xsl:import href="nl-core-NameInformation-d4e173.xsl"/>
   ...
   <xsl:import href="nl-core-Patient-d4e177.xsl"/>
   <xsl:import href="nl-core-Payer.xsl"/>
   <xsl:import href="nl-core-PharmaceuticalProduct-d4e179.xsl"/>
   <xsl:import href="nl-core-Problem-d4e180.xsl"/>
   ...
   <xsl:import href="ext-CopyIndicator-d4e194.xsl"/>
