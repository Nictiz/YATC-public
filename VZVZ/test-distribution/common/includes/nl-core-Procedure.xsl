...
<!-- == Flattened from: C:/Data/Erik/work/Nictiz/new/HL7-mappings/ada_2_fhir-r4/zibs2020/payload/0.5-beta1/nl-core-Procedure.xsl == -->
<!--
Copyright © Nictiz
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:template match="verrichting"
                 name="nl-core-Procedure"
                 mode="nl-core-Procedure"
