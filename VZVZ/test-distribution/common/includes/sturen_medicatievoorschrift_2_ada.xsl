...
<!-- == Flattened from: C:/Data/Erik/work/Nictiz/new/HL7-mappings/fhir_2_ada-r4/mp/9.3.0/sturen_medicatievoorschrift/payload/sturen_medicatievoorschrift_2_ada.xsl == -->
<!--
Copyright © Nictiz
...
<xsl:stylesheet exclude-result-prefixes="#all"
   ...
   <xsl:import href="mp9_latest_package-d4e17.xsl"/>
