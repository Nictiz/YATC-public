...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:uuid="http://www.uuid.org" xmlns:local="#local.2023041908255642454070200">
    <!-- ================================================================== -->
    <!--
    ...
    <xsl:template name="nl-core-AllergyIntolerance" mode="nl-core-AllergyIntolerance" match="allergie_intolerantie" as="element(f:AllergyIntolerance)">
        <!-- Create a nl-core-AllergyIntolerance instance as a AllergyIntolerance FHIR instance from ADA allergie_intolerantie. -->
