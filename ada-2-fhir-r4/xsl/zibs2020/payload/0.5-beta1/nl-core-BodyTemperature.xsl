...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:uuid="http://www.uuid.org" xmlns:local="#local.2023041908255646739690200">
    <!-- ================================================================== -->
    <!--
        Converts ada lichaamstemperatuur to FHIR Observation conforming to profile nl-core-BodyTemperature
    -->
    <!-- ================================================================== -->
    <!--
        Copyright © Nictiz
    ...
    <xsl:template match="lichaamstemperatuur" name="nl-core-BodyTemperature" mode="nl-core-BodyTemperature" as="element(f:Observation)?">
        <!-- Create an nl-core-BodyTemperature as a Observation FHIR instance from ada lichaamstemperatuur element. -->
