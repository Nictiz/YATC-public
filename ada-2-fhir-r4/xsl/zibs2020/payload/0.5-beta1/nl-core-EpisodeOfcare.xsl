...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:uuid="http://www.uuid.org" xmlns:local="#local.2023041908255653018690200" xmlns:nm="http://www.nictiz.nl/mappings">
    <!-- ================================================================== -->
    <!--
        Converts ada zorg_episode to FHIR EpisodeOfCare conforming to profile nl-core-EpisodeOfCare
    -->
    <!-- ================================================================== -->
    <!--
        Copyright © Nictiz
    ...
    <xsl:template match="zorg_episode" name="nl-core-EpisodeOfCare" mode="nl-core-EpisodeOfCare" as="element(f:EpisodeOfCare)">
        <!-- Create a nl-core-EpisodeOfCare instance as a EpisodeOfCare FHIR instance from ADA zorg_episode. -->
    ...
    <xsl:template name="ext-Context-EpisodeOfCare" match="*" as="element()?" mode="ext-Context-EpisodeOfCare">
        ...
        <xsl:for-each select="$in">
            <extension url="http://nictiz.nl/fhir/StructureDefinition/ext-Context-EpisodeOfCare" xmlns="http://hl7.org/fhir">
                <valueReference>
    ...
    <xsl:template name="nl-core-EpisodeOfCare-RefIdentifier" match="identificatie | identificatienummer" mode="nl-core-EpisodeOfCare-RefIdentifier">
        ...
        <type value="EpisodeOfCare" xmlns="http://hl7.org/fhir"/>
        <identifier xmlns="http://hl7.org/fhir">
            <xsl:call-template name="id-to-Identifier"/>
        </identifier>
        <display value="relatie naar zorgepisode met identificatie: {string-join((@value, @root), ' || ')}" xmlns="http://hl7.org/fhir"/>
    </xsl:template>
</xsl:stylesheet>
