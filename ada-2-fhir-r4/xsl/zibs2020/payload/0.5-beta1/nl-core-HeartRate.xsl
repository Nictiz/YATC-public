...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:uuid="http://www.uuid.org" xmlns:local="#local.202304190825565869970200">
    <!-- ================================================================== -->
    <!--
        Converts ada hartfrequentie to FHIR Observation conforming to profile nl-core-HeartRate
    -->
    <!-- ================================================================== -->
    <!--
        Copyright © Nictiz
    ...
    <xsl:template match="hartfrequentie" name="nl-core-HeartRate" mode="nl-core-HeartRate" as="element(f:Observation)?">
        <!-- Create an nl-core-nl-core-HeartRate as a Observation FHIR instance from ada hartfrequentie element. -->
