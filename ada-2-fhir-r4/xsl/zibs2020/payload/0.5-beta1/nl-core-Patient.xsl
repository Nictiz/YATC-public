...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:uuid="http://www.uuid.org" xmlns:local="#local.2023041908255663583340200" xmlns:nm="http://www.nictiz.nl/mappings">
    <!-- ================================================================== -->
    <!--
        Converts ada patient to FHIR resource conforming to profile nl-core-Patient
    -->
    <!-- ================================================================== -->
    <!--
        Copyright © Nictiz
    ...
    <xsl:template match="patient" mode="nl-core-Patient" name="nl-core-Patient" as="element(f:Patient)">
        <!-- Create an nl-core-Patient FHIR instance from the following ada parts:
    ...
    <xsl:template name="_patientProficiency">
        ...
        <xsl:param name="typeCode" as="xs:string">
            <!-- The code used for the 'type' part of the complex extension. -->
        </xsl:param>
        <xsl:if test="$in">
            <extension url="http://hl7.org/fhir/StructureDefinition/patient-proficiency" xmlns="http://hl7.org/fhir">
                <extension url="level">
                    <valueCoding>
    ...
    <xsl:template match="patient" mode="_generateDisplay">
        <!-- Template to generate a display that can be shown when referencing a patient -->
