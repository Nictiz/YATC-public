...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:uuid="http://www.uuid.org" xmlns:local="#local.2023041908255668238620200">
    <!-- ================================================================== -->
    <!--
        Converts ADA tabak_gebruik to FHIR resource conforming to profile nl-core-TobaccoUse
    -->
    <!-- ================================================================== -->
    <!--
        Copyright © Nictiz
    ...
    <xsl:template match="tabak_gebruik" name="nl-core-TobaccoUse" mode="nl-core-TobaccoUse" as="element(f:Observation)">
        <!-- Create a nl-core-TobaccoUse instance as a Observation FHIR instance from ADA tabak_gebruik. -->
