...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:uuid="http://www.uuid.org" xmlns:local="#local.2023041908255669107080200">
    <!-- ================================================================== -->
    <!--
        Converts ada vaccination to FHIR Immunization or ImmunizationRequest conforming to profile nl-core-Vaccination-event or nl-core-Vaccination-request respectively
    -->
    <!-- ================================================================== -->
    <!--
        Copyright © Nictiz
    ...
    <xsl:template match="vaccinatie" name="nl-core-Vaccination-event" mode="nl-core-Vaccination-event" as="element(f:Immunization)?">
        <!-- Create an nl-core-Vaccination-event instance as an Immunization FHIR instance from ada vaccinatie element. -->
    ...
    <xsl:template match="vaccinatie" name="nl-core-Vaccination-request" mode="nl-core-Vaccination-request" as="element(f:ImmunizationRecommendation)?">
        <!-- Create an nl-core-Vaccination-request instance as an ImmunizationRecommendation FHIR instance from ada vaccinatie element. -->
        <xsl:param name="in" select="." as="element()?">
            <!-- ADA element as input. Defaults to self. -->
        </xsl:param>
        <xsl:param name="patient" select="patient/*" as="element()?">
