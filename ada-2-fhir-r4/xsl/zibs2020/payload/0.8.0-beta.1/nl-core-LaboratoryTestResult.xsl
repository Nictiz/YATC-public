...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:uuid="http://www.uuid.org" xmlns:local="#local.2023041908255692702270200">
    <!-- ================================================================== -->
    <!--
    ...
    <xsl:template name="nl-core-LaboratoryTestResult.SpecimenSource" match="bron_monster" as="element(f:Device)?">
        <!-- Helper template to create a nl-core-LaboratoryTestResult.SpecimenSource instance as Device FHIR instance from ADA laboratorium_uitslag/monster/bron_monster. -->
        <xsl:param name="in" as="element()?" select=".">
            <!-- ADA element as input. Defaults to self. -->
        </xsl:param>
        <xsl:param name="subject" select="$in/../../../../patientgegevens/patient" as="element()?">
