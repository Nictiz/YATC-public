...
<xsl:stylesheet version="2.0" exclude-result-prefixes="#all" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:util="urn:hl7:utilities" xmlns:f="http://hl7.org/fhir" xmlns:nf="http://www.nictiz.nl/functions" xmlns:yatcs="https://nictiz.nl/ns/YATC-shared" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:uuid="http://www.uuid.org" xmlns:local="#local.2023041908255696489630200" xmlns:nm="http://www.nictiz.nl/mappings">
    <!-- ================================================================== -->
    <!--
        Converts ada patient to FHIR resource conforming to profile
            nl-core-Patient
    -->
    <!-- ================================================================== -->
    <!--
    ...
    <xsl:template match="patient" mode="nl-core-Patient" name="nl-core-Patient" as="element(f:Patient)">
        ...
        <xsl:param name="languageProficiency" as="element(taalvaardigheid)*" select="$in/taalvaardigheid">
            <!-- Optional ada instances of zib
            LanguageProficiency -->
        </xsl:param>
        <xsl:param name="contactPersons" as="element(contactpersoon)*" select="$in/contactpersoon">
            <!-- Optional ada instances of zib ContactPerson that need to be
            mapped to Patient.contact in FHIR (this is not always the case). -->
        </xsl:param>
