...
<!-- == Provenance: YATC-internal/ada-2-fhir/env/cio/1.0.0/beschikbaarstellen_allergie_intolerantie/payload/beschikbaarstellen_allergie_intolerantie_2_fhir_resources.xsl == -->
