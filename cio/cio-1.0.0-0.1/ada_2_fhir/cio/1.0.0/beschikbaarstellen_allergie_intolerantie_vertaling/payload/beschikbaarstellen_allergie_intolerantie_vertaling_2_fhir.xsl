...
<!-- == Provenance: YATC-internal/ada-2-fhir/env/cio/1.0.0/beschikbaarstellen_allergie_intolerantie_vertaling/payload/beschikbaarstellen_allergie_intolerantie_vertaling_2_fhir.xsl == -->
