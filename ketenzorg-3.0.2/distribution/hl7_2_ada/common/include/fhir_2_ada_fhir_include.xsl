...
<?yatc-distribution-provenance href="HL7-mappings/fhir_2_ada/fhir/fhir_2_ada_fhir_include.xsl"?>
<?yatc-distribution-info name="ketenzorg-3.0.2" timestamp="2024-11-15T00:15:11.67+01:00" version="1.4.29"?>
<!-- == Provenance: HL7-mappings/fhir_2_ada/fhir/fhir_2_ada_fhir_include.xsl == -->
...
<xd:a href="http://hl7.org/fhir/datatypes.html#dateTime">dateTime contents</xd:a> to ada date(time) element.</xd:desc>
   ...
   <xsl:template name="datetime-to-datetime">
      <xsl:param name="in"
                 ...
                 select="."/>
      <xsl:param name="adaElementName"
                 as="xs:string">datum_tijd</xsl:param>
...
<xd:a href="http://hl7.org/fhir/STU3/datatypes.html#Quantity">Quantity</xd:a> to ada element of type hoeveelheid</xd:desc>
   ...
   <xsl:template name="Quantity-to-hoeveelheid"
                 as="element()*">
      <xsl:param name="adaElementName"
                 as="xs:string">hoeveelheid</xsl:param>
      <xsl:param name="adaDatatype"
                 as="xs:string?"/>
      <xsl:element name="{$adaElementName}">
         <xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            ...
            <xsl:variable name="picture"
                          as="xs:string?">[Y0001]-[M01]-[D01]T[H01][m01][s01].[f001][Z0001]</xsl:variable>
            <xsl:choose>
